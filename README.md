...
- [`DripSharp.PdfCarton`](src/DripSharp.PdfCarton/DripSharp.PdfCarton.csproj) — PdfCarton (`netstandard2.0`, version `3.0.8-alpha.5`)
- [`DripSharp.PdfCarton.Fonts`](src/DripSharp.PdfCarton.Fonts/DripSharp.PdfCarton.Fonts.csproj) — PdfCarton Fonts (`netstandard2.0`, version `3.0.8-alpha.5`)
- [`DripSharp.PdfCarton.IO`](src/DripSharp.PdfCarton.IO/DripSharp.PdfCarton.IO.csproj) — PdfCarton I/O (`netstandard2.0`, version `3.0.8-alpha.5`)
- [`DripSharp.PdfCarton.Preflight`](src/DripSharp.PdfCarton.Preflight/DripSharp.PdfCarton.Preflight.csproj) — PdfCarton Preflight (`netstandard2.0`, version `3.0.8-alpha.5`)
- [`DripSharp.PdfCarton.Xmp`](src/DripSharp.PdfCarton.Xmp/DripSharp.PdfCarton.Xmp.csproj) — PdfCarton XMP (`netstandard2.0`, version `3.0.8-alpha.5`)
...
```sh
dotnet add package DripSharp.PdfCarton --version 3.0.8-alpha.5
```
