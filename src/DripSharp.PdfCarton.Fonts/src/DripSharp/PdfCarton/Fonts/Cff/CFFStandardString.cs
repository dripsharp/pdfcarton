// <auto-generated />
// Mechanically translated from: org/apache/fontbox/cff/CFFStandardString.java
...
public sealed class CFFStandardString {
  ...
  public static string GetName(int sid) {
    return global::DripSharp.PdfCarton.Fonts.Cff.CFFStandardString.SID2STR[sid];
  }

  private static readonly string[] SID2STR = new string[] { ".notdef", "space", "exclam",
    ...
    "ae", "dotlessi", "lslash", "oslash", "oe", "germandbls", "onesuperior", "logicalnot", "mu",
    ...
    "tsuperior", "ff", "ffi", "ffl", "parenleftinferior", "parenrightinferior", "Circumflexsmall",
    ...
    "Caronsmall", "Dotaccentsmall", "Macronsmall", "figuredash", "hypheninferior", "Ogoneksmall",
    "Ringsmall", "Cedillasmall", "questiondownsmall", "oneeighth", "threeeighths", "fiveeighths",
