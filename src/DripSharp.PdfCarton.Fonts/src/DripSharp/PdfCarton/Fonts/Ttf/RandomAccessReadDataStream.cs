...
internal class RandomAccessReadDataStream : global::DripSharp.PdfCarton.Fonts.Ttf.TTFDataStream {
  ...
  public override void Seek(long pos) {
    if ((pos < 0)) {
      throw new global::System.IO.IOException(global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.Concat("Invalid position ",
        pos));
    }
  ...
  public override global::DripSharp.PdfCarton.IO.RandomAccessRead CreateSubView(long length) {
    try {
      global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
        = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(this.data);
      return buffer.CreateView((long)(this.currentPosition), length);
    } catch (global::System.IO.IOException e) {
      global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Fonts.Ttf.RandomAccessReadDataStream.LOG,
        (global::System.Exception)e,
        global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.StringValueOf("Could not create a SubView"));
      return default!;
    }
  }
