...
public sealed class WGL4Names {
  ...
  private static readonly string[] MAC_GLYPH_NAMES;

  private static readonly global::System.Collections.Generic.IDictionary<string,
    int> MAC_GLYPH_NAMES_INDICES = null!;

  static WGL4Names() {
    MAC_GLYPH_NAMES = new string[] { ".notdef", ".null", "nonmarkingreturn", "space", "exclam",
      ...
      "equal", "greater", "question", "at", "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K",
