  ...
  private global::DripSharp.PdfCarton.Fonts.Util.Autodetect.FontDirFinder determineDirFinder() {
    ...
    if (global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.StringStartsWith(osName, "Windows")) {
      ...
      if (global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.StringStartsWith(osName, "Mac")) {
        ...
        if (global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.StringStartsWith(osName,
          "OS/400")) {
      ...
      if (global::DripSharp.PdfCarton.Runtime.Fonts.PdfCartonFontDiscovery.FileIsDirectory(file)) {
        if (global::DripSharp.PdfCarton.Runtime.Fonts.PdfCartonFontDiscovery.FileIsHidden(file)) {
          if (global::DripSharp.PdfCarton.Fonts.Util.Autodetect.FontFileFinder.LOG.IsEnabled(global::Microsoft.Extensions.Logging.LogLevel.Debug)) {
            global::Microsoft.Extensions.Logging.LoggerExtensions.LogDebug(global::DripSharp.PdfCarton.Fonts.Util.Autodetect.FontFileFinder.LOG,
              global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.StringValueOf(global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.Concat("skip hidden directory ",
              file)));
          }
          continue;
        }
        ...
        if (global::DripSharp.PdfCarton.Fonts.Util.Autodetect.FontFileFinder.LOG.IsEnabled(global::Microsoft.Extensions.Logging.LogLevel.Debug)) {
          global::Microsoft.Extensions.Logging.LoggerExtensions.LogDebug(global::DripSharp.PdfCarton.Fonts.Util.Autodetect.FontFileFinder.LOG,
            global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.StringValueOf(global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.Concat("checkFontfile check ",
            file)));
        }
        if (this.checkFontfile(file)) {
          if (global::DripSharp.PdfCarton.Fonts.Util.Autodetect.FontFileFinder.LOG.IsEnabled(global::Microsoft.Extensions.Logging.LogLevel.Debug)) {
            global::Microsoft.Extensions.Logging.LoggerExtensions.LogDebug(global::DripSharp.PdfCarton.Fonts.Util.Autodetect.FontFileFinder.LOG,
              global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.StringValueOf(global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.Concat("checkFontfile found ",
              file)));
          }
          global::DripSharp.PdfCarton.Runtime.Fonts.JavaCompat.Add(results,
            global::DripSharp.PdfCarton.Runtime.Fonts.PdfCartonFontDiscovery.FileToUri(file));
        }
      }
    }
  }
