...
: global::DripSharp.PdfCarton.Contentstream.@Operator.Graphics.GraphicsOperatorProcessor {
  ...
  public CurveToReplicateInitialPoint(global::DripSharp.PdfCarton.Contentstream.PDFGraphicsStreamEngine context)
  : base(context) {
  ...
  public override void Process(global::DripSharp.PdfCarton.Contentstream.@Operator.Operator @operator,
    ...
    if ((currentPoint == default!)) {
      global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Contentstream.@Operator.Graphics.CurveToReplicateInitialPoint.LOG,
      ...
      context.CurveTo((float)((float)(currentPoint.X)), (float)((float)(currentPoint.Y)),
        (float)(point2.X), (float)(point2.Y), (float)(point3.X), (float)(point3.Y));
    }
  }
  ...
  static CurveToReplicateInitialPoint() {
