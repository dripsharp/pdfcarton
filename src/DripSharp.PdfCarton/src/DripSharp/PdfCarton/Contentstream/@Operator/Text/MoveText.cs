...
public class MoveText : global::DripSharp.PdfCarton.Contentstream.@Operator.OperatorProcessor {
  ...
  public override void Process(global::DripSharp.PdfCarton.Contentstream.@Operator.Operator @operator,
    ...
    if ((textLineMatrix == default!)) {
      global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Contentstream.@Operator.Text.MoveText.LOG,
        global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("TextLineMatrix is null, ",
        this.GetName()), " operator will be ignored")));
      return;
    }
    ...
    global::DripSharp.PdfCarton.Util.Matrix matrix
      = new global::DripSharp.PdfCarton.Util.Matrix((float)(1), (float)(0), (float)(0), (float)(1),
