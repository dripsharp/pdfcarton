...
internal sealed class CCITTFaxEncoderStream : global::DripSharp.Runtime.JavaOutputStream {
  ...
  private void write(int code, int codeLength) {
    for (int i = 0; (i < codeLength); i++) {
      ...
      if (((int)(this.outputBufferBitLength) == 8)) {
        global::DripSharp.Runtime.JavaCompat.OutputStreamWrite(this.stream,
          (int)(this.outputBuffer));
  ...
  private static readonly global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.Code[] WHITE_TERMINATING_CODES
    = null!;

  private static readonly global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.Code[] WHITE_NONTERMINATING_CODES
    = null!;

  private static readonly global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.Code[] BLACK_TERMINATING_CODES
    = null!;

  private static readonly global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.Code[] BLACK_NONTERMINATING_CODES
    = null!;

  static CCITTFaxEncoderStream() { {
      global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.WHITE_TERMINATING_CODES
        = new global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.Code[64];
      global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.WHITE_NONTERMINATING_CODES
        = new global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.Code[40];
      for (int i__296_18 = 0;
        ...
        for (int j__298_22 = 0;
          ...
          j__298_22++) {
          int value__299_21
            = global::DripSharp.PdfCarton.Filter.CCITTFaxDecoderStream.WhiteRunLengths[i__296_18][j__298_22];
          int code__300_21
            = global::DripSharp.PdfCarton.Filter.CCITTFaxDecoderStream.WhiteCodes[i__296_18][j__298_22];
          if ((value__299_21 < 64)) {
            global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.WHITE_TERMINATING_CODES[value__299_21]
      ...
      global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.BLACK_TERMINATING_CODES
        = new global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.Code[64];
      global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.BLACK_NONTERMINATING_CODES
        = new global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.Code[40];
      for (int i__313_18 = 0;
        ...
        for (int j__315_22 = 0;
          ...
          j__315_22++) {
          int value__316_21
            = global::DripSharp.PdfCarton.Filter.CCITTFaxDecoderStream.BLACK_RUN_LENGTHS[i__313_18][j__315_22];
          int code__317_21
            = global::DripSharp.PdfCarton.Filter.CCITTFaxDecoderStream.BLACK_CODES[i__313_18][j__315_22];
          if ((value__316_21 < 64)) {
            global::DripSharp.PdfCarton.Filter.CCITTFaxEncoderStream.BLACK_TERMINATING_CODES[value__316_21]
