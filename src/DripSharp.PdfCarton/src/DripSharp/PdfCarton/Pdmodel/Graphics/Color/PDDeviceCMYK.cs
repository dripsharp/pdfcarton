...
static PDDeviceCMYK() {
{
global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDDeviceCMYK.Instance = new global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDDeviceCMYK();
}
}
...
this.initialColor = new global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDColor(new float[] { 0, 0, 0, 1 }, this);
}
...
this.usePureJavaCMYKConversion = (global::DripSharp.Runtime.JavaCompat.GetProperty("org.apache.pdfbox.rendering.UsePureJavaCMYKConversion") != default!);
this.initDone = true;
}
}
...
global::System.IO.Stream resourceAsStream = global::DripSharp.Runtime.JavaCompat.ClassGetResourceAsStream(typeof(global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDDeviceCMYK), resourceName);
...
protected internal override global::SkiaSharp.SKBitmap ToRGBImageAWT(global::DripSharp.Runtime.JavaRaster raster, global::DripSharp.Runtime.JavaColorSpace colorSpace) {
...
global::DripSharp.Runtime.JavaColorSpace destCS = global::DripSharp.Runtime.PdfCartonFontCompat.GetColorModel(dest).ColorSpace;
global::DripSharp.Runtime.JavaRaster destRaster = global::DripSharp.Runtime.PdfCartonFontCompat.GetRaster(dest);
