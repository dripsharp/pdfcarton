...
: global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDCIEBasedColorSpace {
  ...
  private PDICCBased(global::DripSharp.PdfCarton.Cos.COSArray iccArray) {
    ...
    base.Array = iccArray;
    this.stream
      = new global::DripSharp.PdfCarton.Pdmodel.Common.PDStream((global::DripSharp.PdfCarton.Cos.COSStream)(iccArray.GetObject(1)!));
    this.loadICCProfile();
  }

  public static global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDICCBased Create(global::DripSharp.PdfCarton.Cos.COSArray iccArray,
    ...
    if (((@base is global::DripSharp.PdfCarton.Cos.COSObject) && (resources != default!))) {
      ...
      if ((resourceCache != default!)) {
        ...
        global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDColorSpace space
          = resourceCache.GetColorSpace(indirect);
        if ((space is global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDICCBased)) {
          ...
          global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDICCBased newSpace
            = new global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDICCBased(iccArray);
  ...
  private void loadICCProfile() {
    if (this.useOnlyAlternateColorSpace) {
      try {
        ...
        global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDICCBased.LOG,
          global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat("Error initializing alternate color space: ",
          e.Message)));
      }
    }
    try {
  ...
  private void fallbackToAlternateColorSpace(global::System.Exception e) {
    ...
    if (global::DripSharp.Runtime.JavaCompat.Equals(this.alternateColorSpace,
      global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDDeviceRGB.Instance)) {
      this.isRGB = true;
    }
    if ((e != default!)) {
      global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDICCBased.LOG,
        global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("Can't read embedded ICC profile (",
        e.Message), "), using alternate color space: "), this.alternateColorSpace.GetName())));
    }
  ...
  private static global::DripSharp.Runtime.JavaIccProfile ensureDisplayProfile(global::DripSharp.Runtime.JavaIccProfile profile) {
    if ((profile.GetProfileClass() != global::DripSharp.Runtime.JavaIccProfile.CLASS_DISPLAY)) {
      ...
      if (((int)(profileData[global::DripSharp.Runtime.JavaIccProfile.icHdrRenderingIntent])
        == global::DripSharp.Runtime.JavaIccProfile.icPerceptual)) {
        global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDICCBased.LOG,
          global::DripSharp.Runtime.JavaCompat.StringValueOf("ICC profile is Perceptual, ignoring, treating as Display class"));
        global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDICCBased.intToBigEndian(global::DripSharp.Runtime.JavaIccProfile.icSigDisplayClass,
          profileData, global::DripSharp.Runtime.JavaIccProfile.icHdrDeviceClass);
  ...
  private float[] clampColors(global::DripSharp.Runtime.JavaIccColorSpace cs, float[] value) {
    ...
    for (int i = 0; (i < value.Length); ++i) {
      ...
      result[i] = ((value[i] < minValue) ? minValue : ((value[i] > maxValue) ? maxValue
        : value[i]));
    }
    return result;
  }
  ...
  public override int GetNumberOfComponents() {
    if ((this.numberOfComponents < 0)) {
      this.numberOfComponents
        = this.stream.GetCOSObject().GetInt(global::DripSharp.PdfCarton.Cos.COSName.N);
      if ((this.iccProfile != default!)) {
        ...
        if ((numIccComponents != this.numberOfComponents)) {
          global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDICCBased.LOG,
            ...
            numIccComponents), " components from ICC profile info instead of "),
            this.numberOfComponents), " components from /N entry")));
  ...
  public global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDColorSpace GetAlternateColorSpace() {
    global::DripSharp.PdfCarton.Cos.COSBase alternate
      = this.stream.GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.Alternate);
    ...
    if ((alternate == default!)) {
      ...
      switch (numComponents) {
        ...
        case var __case_405_22_0 when __case_405_22_0 == 4:
          ...
          break;
        default:
          throw new global::System.IO.IOException(global::DripSharp.Runtime.JavaCompat.Concat("Unknown color space number of components:",
            numComponents));
      }
      ...
      if ((alternate is global::DripSharp.PdfCarton.Cos.COSArray)) {
        ...
        if ((alternate is global::DripSharp.PdfCarton.Cos.COSName)) {
          ...
          throw new global::System.IO.IOException(global::DripSharp.Runtime.JavaCompat.Concat("Error: expected COSArray or COSName and not ",
            global::DripSharp.Runtime.JavaCompat.ClassName(((object)(alternate)).GetType(),
  ...
  public void SetAlternateColorSpaces(global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDColorSpace> list) {
    ...
    this.stream.GetCOSObject().SetItem(global::DripSharp.PdfCarton.Cos.COSName.Alternate,
      altArray!);
  }

  public void SetRangeForComponent(global::DripSharp.PdfCarton.Pdmodel.Common.PDRange range,
    int n) {
    global::DripSharp.PdfCarton.Cos.COSArray rangeArray
      = this.stream.GetCOSObject().GetCOSArray(global::DripSharp.PdfCarton.Cos.COSName.Range);
