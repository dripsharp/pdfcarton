...
public sealed class CCITTFactory {
  ...
  private static global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImageXObject prepareImageXObject(global::DripSharp.PdfCarton.Pdmodel.PDDocument document,
    sbyte[] byteArray, int width, int height,
    ...
    global::DripSharp.PdfCarton.Filter.Filter filter
      = global::DripSharp.PdfCarton.Filter.FilterFactory.Instance.GetFilter(global::DripSharp.PdfCarton.Cos.COSName.CcittfaxDecode);
  ...
  private static global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImageXObject createFromRandomAccessImpl(global::DripSharp.PdfCarton.Pdmodel.PDDocument document,
    global::DripSharp.PdfCarton.IO.RandomAccessRead reader, int number) {
    global::DripSharp.PdfCarton.Cos.COSDictionary decodeParms
      = new global::DripSharp.PdfCarton.Cos.COSDictionary();
    global::DripSharp.Runtime.JavaByteArrayOutputStream bos
      = new global::DripSharp.Runtime.JavaByteArrayOutputStream();
    global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.CCITTFactory.extractFromTiff(reader, bos,
      decodeParms, number);
    if ((checked((int)bos.Length) == 0)) {
      return default!;
    }
    global::System.IO.MemoryStream encodedByteStream
      = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(global::DripSharp.Runtime.JavaCompat.ToSignedBytes(bos));
    global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImageXObject pdImage
      = new global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImageXObject(document,
      encodedByteStream, global::DripSharp.PdfCarton.Cos.COSName.CcittfaxDecode,
      decodeParms.GetInt(global::DripSharp.PdfCarton.Cos.COSName.Columns),
      decodeParms.GetInt(global::DripSharp.PdfCarton.Cos.COSName.Rows), 1,
      global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDDeviceGray.Instance);
  ...
  private static void extractFromTiff(global::DripSharp.PdfCarton.IO.RandomAccessRead reader,
    global::System.IO.Stream os, global::DripSharp.PdfCarton.Cos.COSDictionary @params,
    int number) {
    try {
      reader.Seek((long)(0));
      ...
      int magicNumber
        = global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.CCITTFactory.readshort(endianess,
        reader);
      if ((magicNumber != 42)) {
        throw new global::System.IO.IOException("Not a valid tiff file");
      }
      ...
      for (int i__302_22 = 0; (i__302_22 < numtags__281_17); i__302_22++) {
        ...
        switch (tag) {
          ...
          case var __case_360_26_0 when __case_360_26_0 == 266: {
              if (((val != 1) && (val != 2))) {
                throw new global::System.IO.IOException(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("FillOrder ",
          ...
          case var __case_378_26_0 when __case_378_26_0 == 274: {
              if ((val != 1)) {
                throw new global::System.IO.IOException(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("Orientation ",
                  val), " is not supported"));
              }
              break;
            }
      ...
      while (((amountRead = reader.Read(buf, 0, global::System.Math.Min(8192, datalength))) > 0)) {
        ...
        if ((fillorder == 2)) {
          for (int x = 0; (x < amountRead); x++) {
            buf[x]
              = unchecked((sbyte)(global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.CCITTFactory.fliptable[(buf[x] & 255)]));
          }
        }
  ...
  private static int readshort(char endianess,
