...
internal sealed class SampledImageReader {
  ...
  public static global::SkiaSharp.SKBitmap GetStencilImage(global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImage pdImage,
    global::DripSharp.Runtime.JavaPaint paint) {
    int width = pdImage.GetWidth();
    int height = pdImage.GetHeight();
    global::SkiaSharp.SKBitmap masked
    ...
    global::DripSharp.Runtime.PdfCartonGraphics2D g
      = global::DripSharp.Runtime.PdfCartonFontCompat.CreateGraphics(masked);
    g.SetPaint(paint);
  ...
  public static global::SkiaSharp.SKBitmap GetRGBImage(global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImage pdImage,
    global::DripSharp.PdfCarton.Cos.COSArray colorKey) {
    return global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.SampledImageReader.GetRGBImage(pdImage,
      (global::SkiaSharp.SKRectI)default!, 1, colorKey);
  }

  private static global::SkiaSharp.SKRectI clipRegion(global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImage pdImage,
    global::SkiaSharp.SKRectI region) {
    if ((region == default!)) {
      return global::DripSharp.Runtime.PdfCartonFontCompat.RectangleI(0, 0, pdImage.GetWidth(),
        pdImage.GetHeight());
    } else {
  ...
  public static global::SkiaSharp.SKBitmap GetRGBImage(global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImage pdImage,
    global::SkiaSharp.SKRectI region, int subsampling,
    global::DripSharp.PdfCarton.Cos.COSArray colorKey) {
    if (pdImage.IsEmpty()) {
      throw new global::System.IO.IOException("Image stream is empty");
    }
    global::SkiaSharp.SKRectI clipped
      = global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.SampledImageReader.clipRegion(pdImage,
      region);
    ...
    try {
      if ((((bitsPerComponent == 1) && (colorKey == default!)) && (numComponents == 1))) {
        return global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.SampledImageReader.from1Bit(pdImage,
          clipped, subsampling, width, height);
      }
      global::DripSharp.Runtime.JavaRaster raster
        ...
        width, height, numComponents, new global::DripSharp.Runtime.JavaPoint(0, 0));
      float[] defaultDecode = pdImage.GetColorSpace().GetDefaultDecode(8);
      float[] decode
        = global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.SampledImageReader.getDecodeArray(pdImage);
      if ((((bitsPerComponent == 8) && (colorKey == default!))
        && global::DripSharp.Runtime.JavaCompat.ArrayEquals(decode, defaultDecode))) {
        return global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.SampledImageReader.from8bit(pdImage,
          raster, clipped, subsampling, width, height);
      }
      return global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.SampledImageReader.fromAny(pdImage,
  ...
  public static global::DripSharp.Runtime.JavaRaster GetRawRaster(global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImage pdImage) {
    ...
    try {
      ...
      global::DripSharp.Runtime.JavaRaster raster
        ...
        width, height, numComponents, new global::DripSharp.Runtime.JavaPoint(0, 0));
      global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.SampledImageReader.readRasterFromAny(pdImage,
        raster);
      return raster;
    } catch (global::System.Exception ex) when (ex is global::System.OverflowException or global::System.ArgumentException) {
      throw new global::System.IO.IOException(null, ex);
  ...
  private static void readRasterFromAny(global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImage pdImage,
    global::DripSharp.Runtime.JavaRaster raster) {
    global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDColorSpace colorSpace
      = pdImage.GetColorSpace();
    int numComponents = colorSpace.GetNumberOfComponents();
  ...
  private static global::SkiaSharp.SKBitmap from1Bit(global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImage pdImage,
  ...
  private static global::SkiaSharp.SKBitmap applyColorKeyMask(global::SkiaSharp.SKBitmap image,
    global::SkiaSharp.SKBitmap mask) {
    int width = image.Width;
    int height = image.Height;
    global::SkiaSharp.SKBitmap masked
      = global::DripSharp.Runtime.PdfCartonFontCompat.CreateBitmap(width, height,
      global::DripSharp.Runtime.PdfCartonFontCompat.TYPE_INT_ARGB);
    global::DripSharp.Runtime.JavaRaster src
      = global::DripSharp.Runtime.PdfCartonFontCompat.GetRaster(image);
    global::DripSharp.Runtime.JavaRaster dest
      = global::DripSharp.Runtime.PdfCartonFontCompat.GetRaster(masked);
  ...
  private static float[] getDecodeArray(global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImage pdImage) {
    ...
    if ((cosDecode != default!)) {
      ...
      if ((cosDecode.Size() >= (numberOfComponents * 2))) {
        ...
        if ((pdImage.IsStencil() && ((((decode[0] < 0) || (decode[0] > 1)) || (decode[1] < 0))
          || (decode[1] > 1)))) {
          error = true;
        }
        if (!error) {
      ...
      global::Microsoft.Extensions.Logging.LoggerExtensions.LogError(global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.SampledImageReader.LOG,
        global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("decode array ",
