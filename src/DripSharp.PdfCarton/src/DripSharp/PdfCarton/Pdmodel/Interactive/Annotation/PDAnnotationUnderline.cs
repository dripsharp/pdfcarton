// <auto-generated />
// Mechanically translated from: org/apache/pdfbox/pdmodel/interactive/annotation/PDAnnotationUnderline.java
...
public class PDAnnotationUnderline
: global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationTextMarkup {
  ...
  : base(global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationUnderline.SubType) {

  }

  public PDAnnotationUnderline(global::DripSharp.PdfCarton.Cos.COSDictionary dict) : base(dict) {
  ...
  public override void ConstructAppearances(global::DripSharp.PdfCarton.Pdmodel.PDDocument document) {
    if ((this.customAppearanceHandler == default!)) {
      global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.Handlers.PDUnderlineAppearanceHandler appearanceHandler
        = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.Handlers.PDUnderlineAppearanceHandler(this,
        document);
  ...
  static PDAnnotationUnderline() {
    global::System.Runtime.CompilerServices.RuntimeHelpers.RunClassConstructor(typeof(global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationTextMarkup).TypeHandle);
  }
}
