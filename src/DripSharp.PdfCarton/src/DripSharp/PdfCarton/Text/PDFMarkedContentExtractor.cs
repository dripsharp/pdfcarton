...
public class PDFMarkedContentExtractor : global::DripSharp.PdfCarton.Text.LegacyPDFStreamEngine {
  ...
  public override void BeginMarkedContentSequence(global::DripSharp.PdfCarton.Cos.COSName tag,
    ...
    if (global::DripSharp.Runtime.JavaCompat.CollectionIsEmpty(this.currentMarkedContents)) {
      ...
      global::DripSharp.PdfCarton.Pdmodel.Documentinterchange.Markedcontent.PDMarkedContent currentMarkedContent
  ...
  public override void MarkedContentPoint(global::DripSharp.PdfCarton.Cos.COSName tag,
    global::DripSharp.PdfCarton.Cos.COSDictionary properties) {
  ...
  protected internal override void ProcessTextPosition(global::DripSharp.PdfCarton.Text.TextPosition text) {
    ...
    if (this.suppressDuplicateOverlappingText) {
      ...
      global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Text.TextPosition> sameTextCharacters
      ...
      foreach (global::DripSharp.PdfCarton.Text.TextPosition sameTextCharacter in sameTextCharacters) {
        ...
        if ((((charCharacter != default!) && this.within(charX, textX, tolerance))
          && this.within(charY, textY, tolerance))) {
    ...
    if ((showCharacter
      && !global::DripSharp.Runtime.JavaCompat.CollectionIsEmpty(this.currentMarkedContents))) {
