...
public sealed class DateConverter {
  ...
  internal static string formatTZoffset(long millis, string sep) {
    global::DripSharp.Runtime.JavaSimpleDateFormat sdf
      = new global::DripSharp.Runtime.JavaSimpleDateFormat("Z",
      global::System.Globalization.CultureInfo.GetCultureInfo("en"));
    sdf.SetTimeZone(global::DripSharp.Runtime.JavaCompat.NewSimpleTimeZone(global::DripSharp.PdfCarton.Util.DateConverter.restrainTZoffset(millis),
      "unknown"));
    string tz = sdf.Format((global::System.DateTimeOffset?)global::System.DateTimeOffset.Now);
    return global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.StringSubstring(tz,
      0, 3), sep), tz.Substring(3));
  }

  private static int parseTimeField(string text, global::DripSharp.Runtime.JavaParsePosition where,
  ...
  private static char skipOptionals(string text, global::DripSharp.Runtime.JavaParsePosition where,
    string optionals) {
    char retval = ' ';
    char currch;
  ...
  internal static global::System.DateTimeOffset? newGreg() {
    global::System.DateTimeOffset? retCal
      = global::DripSharp.Runtime.JavaCompat.CalendarInstance(global::DripSharp.Runtime.JavaCompat.NewSimpleTimeZone(0,
      "UTC"));
  ...
  internal static bool parseTZoffset(string text, ref global::System.DateTimeOffset? cal,
    global::DripSharp.Runtime.JavaParsePosition initialWhere) {
    global::DripSharp.Runtime.JavaParsePosition where
      = new global::DripSharp.Runtime.JavaParsePosition(initialWhere.GetIndex());
    global::System.TimeZoneInfo tz = global::DripSharp.Runtime.JavaCompat.NewSimpleTimeZone(0,
      "GMT");
    int tzHours;
    int tzMin;
    char sign = global::DripSharp.PdfCarton.Util.DateConverter.skipOptionals(text, where, "Z+- ");
    bool hadGMT = ((((int)sign == (int)'Z')
      || global::DripSharp.PdfCarton.Util.DateConverter.skipString(text, "GMT", where))
    ...
    if ((tzHours != -999)) {
      ...
      if (!hadGMT) {
        string tzText
          = global::DripSharp.Runtime.JavaCompat.StringTrim(text.Substring(initialWhere.GetIndex()));
        tz = global::DripSharp.Runtime.JavaCompat.GetTimeZone(tzText);
        if (global::DripSharp.Runtime.JavaCompat.Equals("GMT",
          global::DripSharp.Runtime.JavaCompat.TimeZoneId(tz))) {
          return false;
        } else {
  ...
  private static void updateZoneId(global::System.TimeZoneInfo tz) {
    ...
    if ((offset == 0)) {
      ...
      if ((((int)pm == (int)'+') && (hh <= 12))) {
        global::DripSharp.Runtime.JavaCompat.TimeZoneSetId(tz,
  ...
  private static global::System.DateTimeOffset? parseBigEndianDate(string text,
    global::DripSharp.Runtime.JavaParsePosition initialWhere) {
    global::DripSharp.Runtime.JavaParsePosition where
      = new global::DripSharp.Runtime.JavaParsePosition(initialWhere.GetIndex());
    ...
    try {
      dest = global::DripSharp.Runtime.JavaCompat.CalendarSet(dest, year, month, day, hour, minute,
        second);
      global::DripSharp.Runtime.JavaCompat.CalendarGetTimeInMillis(dest);
    } catch (global::System.ArgumentException ill) {
      global::Microsoft.Extensions.Logging.LoggerExtensions.LogDebug(global::DripSharp.PdfCarton.Util.DateConverter.LOG,
        (global::System.Exception)ill,
        global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("Couldn't parse arguments text:",
        text), " initialWhere:"), initialWhere)));
      return default!;
    }
    initialWhere.SetIndex(where.GetIndex());
  ...
  private static global::System.DateTimeOffset? parseSimpleDate(string text, string[] fmts,
    global::DripSharp.Runtime.JavaParsePosition initialWhere) {
    foreach (string fmt in fmts) {
      global::DripSharp.Runtime.JavaParsePosition where
        = new global::DripSharp.Runtime.JavaParsePosition(initialWhere.GetIndex());
      global::DripSharp.Runtime.JavaSimpleDateFormat sdf
        = new global::DripSharp.Runtime.JavaSimpleDateFormat(fmt,
        global::System.Globalization.CultureInfo.GetCultureInfo("en"));
      global::System.DateTimeOffset? retCal
        = global::DripSharp.PdfCarton.Util.DateConverter.newGreg();
  ...
  private static global::System.DateTimeOffset? parseDate(string text,
    global::DripSharp.Runtime.JavaParsePosition initialWhere) {
    if ((((text == default!) || (text.Length == 0))
      || global::DripSharp.Runtime.JavaCompat.Equals("D:",
    ...
    global::System.DateTimeOffset? retCal
      = global::DripSharp.PdfCarton.Util.DateConverter.parseBigEndianDate(text, where);
    if (((retCal != default!) && ((where.GetIndex() == text.Length)
      || global::DripSharp.PdfCarton.Util.DateConverter.parseTZoffset(text, ref retCal, where)))) {
    ...
    string[] formats = (global::DripSharp.Runtime.JavaCompat.IsDigit(text[startPosition])
      ? global::DripSharp.PdfCarton.Util.DateConverter.DIGIT_START_FORMATS
      : global::DripSharp.PdfCarton.Util.DateConverter.ALPHA_START_FORMATS);
  ...
  public static global::System.DateTimeOffset? ToCalendar(string text) {
    if (((text == default!) || (global::DripSharp.Runtime.JavaCompat.StringTrim(text).Length
      == 0))) {
      return default!;
    }
    global::DripSharp.Runtime.JavaParsePosition where
      = new global::DripSharp.Runtime.JavaParsePosition(0);
    global::DripSharp.PdfCarton.Util.DateConverter.skipOptionals(text, where, " ");
    global::DripSharp.PdfCarton.Util.DateConverter.skipString(text, "D:", where);
    global::System.DateTimeOffset? calendar
      = global::DripSharp.PdfCarton.Util.DateConverter.parseDate(text, where);
