...
public sealed class Hex {
  ...
  public static string GetString(sbyte b) {
    char[] chars
      = new char[] { global::DripSharp.PdfCarton.Util.Hex.HEX_CHARS[global::DripSharp.PdfCarton.Util.Hex.getHighNibble(b)],
      global::DripSharp.PdfCarton.Util.Hex.HEX_CHARS[global::DripSharp.PdfCarton.Util.Hex.getLowNibble(b)] };
  ...
  public static sbyte[] GetBytes(sbyte b) {
    return new sbyte[] { global::DripSharp.PdfCarton.Util.Hex.HEX_BYTES[global::DripSharp.PdfCarton.Util.Hex.getHighNibble(b)],
      global::DripSharp.PdfCarton.Util.Hex.HEX_BYTES[global::DripSharp.PdfCarton.Util.Hex.getLowNibble(b)] };
  }
  ...
  public static char[] GetCharsUTF16BE(string text) {
    ...
    for (int stringIdx = 0, charIdx = 0; (stringIdx < text.Length); stringIdx++) {
      ...
      hex[charIdx++]
        = global::DripSharp.PdfCarton.Util.Hex.HEX_CHARS[((c >> unchecked((int)(12))) & 15)];
      hex[charIdx++]
        = global::DripSharp.PdfCarton.Util.Hex.HEX_CHARS[((c >> unchecked((int)(8))) & 15)];
      hex[charIdx++]
        = global::DripSharp.PdfCarton.Util.Hex.HEX_CHARS[((c >> unchecked((int)(4))) & 15)];
  ...
  public static void WriteHexByte(sbyte b, global::System.IO.Stream output) {
    global::DripSharp.Runtime.JavaCompat.OutputStreamWrite(output,
      (int)(global::DripSharp.PdfCarton.Util.Hex.HEX_BYTES[global::DripSharp.PdfCarton.Util.Hex.getHighNibble(b)]));
    global::DripSharp.Runtime.JavaCompat.OutputStreamWrite(output,
      (int)(global::DripSharp.PdfCarton.Util.Hex.HEX_BYTES[global::DripSharp.PdfCarton.Util.Hex.getLowNibble(b)]));
  }
  ...
  public static sbyte[] DecodeBase64(string base64Value) {
    return global::DripSharp.Runtime.JavaBase64.GetDecoder().Decode(global::DripSharp.Runtime.JavaCompat.RegexMatcher(global::DripSharp.PdfCarton.Util.StringUtil.PatternSpace,
      base64Value).ReplaceAll(""));
  }
