...
public class AFMParserTest {
  ...
  internal virtual void testStartFontMetrics() {
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(()
      => new global::DripSharp.PdfCarton.Fonts.Afm.AFMParser(global::DripSharp.Runtime.JavaCompat.NewMemoryStream(global::DripSharp.Runtime.JavaCompat.StringGetBytes("huhu",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII))).Parse(),
  ...
  private void checkHelveticaCharMetrics(global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Fonts.Afm.CharMetric> charMetrics) {
    global::DripSharp.Testing.JavaAssertions.Equal(315,
      global::DripSharp.Runtime.JavaCompat.CollectionCount(charMetrics), null);
    global::DripSharp.Runtime.JavaOptional<global::DripSharp.PdfCarton.Fonts.Afm.CharMetric> space
      = global::DripSharp.Runtime.JavaCompat.FindFirstOptional(global::DripSharp.Runtime.JavaCompat.StreamFilter(global::DripSharp.Runtime.JavaCompat.Stream(charMetrics),
      (c) => global::DripSharp.Runtime.JavaCompat.Equals("space", c.GetName())));
    ...
    this.checkBBox(spaceCharMetric.GetBoundingBox(), (float)(0), (float)(0), (float)(0),
      (float)(0));
    global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.ListIsEmpty(spaceCharMetric.GetLigatures()),
      null);
    ...
    global::DripSharp.Runtime.JavaOptional<global::DripSharp.PdfCarton.Fonts.Afm.CharMetric> ring
      = global::DripSharp.Runtime.JavaCompat.FindFirstOptional(global::DripSharp.Runtime.JavaCompat.StreamFilter(global::DripSharp.Runtime.JavaCompat.Stream(charMetrics),
      (c) => global::DripSharp.Runtime.JavaCompat.Equals("ring", c.GetName())));
    ...
    this.checkBBox(ringCharMetric.GetBoundingBox(), (float)(75), (float)(572), (float)(259),
      (float)(756));
    global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.ListIsEmpty(ringCharMetric.GetLigatures()),
      null);
  ...
  private void checkHelveticaFontMetrics(global::DripSharp.PdfCarton.Fonts.Afm.FontMetrics fontMetrics) {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal("Copyright (c) 1985, 1987, 1989, 1990, 1997 Adobe Systems Incorporated.  All Rights Reserved.Helvetica is a trademark of Linotype-Hell AG and/or its subsidiaries.",
      fontMetrics.GetNotice(), null);
    global::DripSharp.Testing.JavaAssertions.Equal("AdobeStandardEncoding",
    ...
    global::DripSharp.Testing.JavaAssertions.Equal("ExtendedRoman", fontMetrics.GetCharacterSet(),
      null);
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(76.0F, fontMetrics.GetStandardHorizontalWidth(),
      null, 0.0F);
    global::DripSharp.Testing.JavaAssertions.Equal(88.0F, fontMetrics.GetStandardVerticalWidth(),
      null, 0.0F);
    ...
    global::DripSharp.Testing.JavaAssertions.Equal("Copyright (c) 1985, 1987, 1989, 1990, 1997 Adobe Systems Incorporated.  All Rights Reserved.",
      global::DripSharp.Runtime.JavaCompat.ListGet(comments, 0), null);
    global::DripSharp.Testing.JavaAssertions.Equal("UniqueID 43054",
      global::DripSharp.Runtime.JavaCompat.ListGet(comments, 2), null);
    global::DripSharp.Testing.JavaAssertions.Equal(-100.0F, fontMetrics.GetUnderlinePosition(),
      null, 0.0F);
    global::DripSharp.Testing.JavaAssertions.Equal(50.0F, fontMetrics.GetUnderlineThickness(), null,
      0.0F);
  ...
  private void checkBBox(global::DripSharp.PdfCarton.Fonts.Util.BoundingBox bBox, float lowerX,
  ...
  private void checkKernPair(global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Fonts.Afm.KernPair> kernPairs,
    string firstKernChar, string secondKernChar, float x, float y) {
    global::DripSharp.Runtime.JavaOptional<global::DripSharp.PdfCarton.Fonts.Afm.KernPair> kernPair
      = global::DripSharp.Runtime.JavaCompat.FindFirstOptional(global::DripSharp.Runtime.JavaCompat.StreamFilter(global::DripSharp.Runtime.JavaCompat.StreamFilter(global::DripSharp.Runtime.JavaCompat.Stream(kernPairs),
      (k) => global::DripSharp.Runtime.JavaCompat.Equals(firstKernChar, k.GetFirstKernCharacter())),
      (k) => global::DripSharp.Runtime.JavaCompat.Equals(secondKernChar,
      k.GetSecondKernCharacter())));
