...
public class CharMetricTest {
  ...
  internal virtual void testCharMetricComplexValues() {
    global::DripSharp.PdfCarton.Fonts.Afm.CharMetric charMetric
      = new global::DripSharp.PdfCarton.Fonts.Afm.CharMetric();
    charMetric.SetBoundingBox(new global::DripSharp.PdfCarton.Fonts.Util.BoundingBox((float)(10),
      (float)(20), (float)(30), (float)(40)));
    global::DripSharp.Testing.JavaAssertions.Equal((float)(10),
      charMetric.GetBoundingBox().GetLowerLeftX(), null, (float)(0));
    global::DripSharp.Testing.JavaAssertions.Equal((float)(20),
      charMetric.GetBoundingBox().GetLowerLeftY(), null, (float)(0));
    global::DripSharp.Testing.JavaAssertions.Equal((float)(30),
      charMetric.GetBoundingBox().GetUpperRightX(), null, (float)(0));
    global::DripSharp.Testing.JavaAssertions.Equal((float)(40),
      charMetric.GetBoundingBox().GetUpperRightY(), null, (float)(0));
    global::DripSharp.Testing.JavaAssertions.Equal(0,
      global::DripSharp.Runtime.JavaCompat.CollectionCount(charMetric.GetLigatures()), null);
    global::DripSharp.PdfCarton.Fonts.Afm.Ligature ligature
      = new global::DripSharp.PdfCarton.Fonts.Afm.Ligature(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "successor"), global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", "ligature"));
    charMetric.AddLigature(ligature);
    global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Fonts.Afm.Ligature> ligatures
      = charMetric.GetLigatures();
    global::DripSharp.Testing.JavaAssertions.Equal(1,
      global::DripSharp.Runtime.JavaCompat.CollectionCount(ligatures), null);
    global::DripSharp.Testing.JavaAssertions.Equal("successor",
      global::DripSharp.Runtime.JavaCompat.ListGet(ligatures, 0).GetSuccessor(), null);
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.NotSupportedException>(()
      => global::DripSharp.Runtime.JavaCompat.Add(ligatures, ligature), null);
  }
