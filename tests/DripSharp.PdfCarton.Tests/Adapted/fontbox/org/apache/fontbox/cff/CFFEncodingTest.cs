...
public class CFFEncodingTest {
  internal virtual void testCFFExpertEncoding() {
    global::DripSharp.PdfCarton.Fonts.Cff.CFFExpertEncoding cffExpertEncoding
      = global::DripSharp.PdfCarton.Fonts.Cff.CFFExpertEncoding.GetInstance();
    ...
    global::DripSharp.Testing.JavaAssertions.Equal("Ucircumflexsmall",
      cffExpertEncoding.GetName(251), null);
    global::DripSharp.Testing.JavaAssertions.Equal(32,
      cffExpertEncoding.GetCode(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "space")), null);
    global::DripSharp.Testing.JavaAssertions.Equal(112,
      cffExpertEncoding.GetCode(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Psmall")), null);
    global::DripSharp.Testing.JavaAssertions.Equal(251,
      cffExpertEncoding.GetCode(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Ucircumflexsmall")), null);
  }

  internal virtual void testCFFStandardEncoding() {
    global::DripSharp.PdfCarton.Fonts.Cff.CFFStandardEncoding cffStandardEncoding
      = global::DripSharp.PdfCarton.Fonts.Cff.CFFStandardEncoding.GetInstance();
    ...
    global::DripSharp.Testing.JavaAssertions.Equal("germandbls", cffStandardEncoding.GetName(251),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal(32,
      cffStandardEncoding.GetCode(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "space")), null);
    global::DripSharp.Testing.JavaAssertions.Equal(112,
      cffStandardEncoding.GetCode(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "p")), null);
