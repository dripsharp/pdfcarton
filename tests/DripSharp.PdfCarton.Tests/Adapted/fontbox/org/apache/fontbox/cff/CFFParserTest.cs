...
public class CFFParserTest {
  ...
  internal static void loadCFFFont() {
    global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Fonts.Cff.CFFFont> fonts
      = global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.readFont(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "target/fonts/SourceSansProBold.otf"));
    global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.testCFFType1Font
      = (global::DripSharp.PdfCarton.Fonts.Cff.CFFType1Font)(global::DripSharp.Runtime.JavaCompat.ListGet(fonts,
      0)!);
  }

  internal virtual void testFontname() {
    global::DripSharp.Testing.JavaAssertions.Equal("SourceSansPro-Bold",
      global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.testCFFType1Font.GetName(), null);
  }

  internal virtual void testFontBBox() {
    global::DripSharp.PdfCarton.Fonts.Util.BoundingBox fontBBox
      = global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.testCFFType1Font.GetFontBBox();
    global::DripSharp.Testing.JavaAssertions.NotNull(fontBBox,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", "FontBBox must not be null"));
  ...
  internal virtual void testFontMatrix() {
    global::System.Collections.Generic.IList<global::System.IConvertible> fontMatrix
      = global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.testCFFType1Font.GetFontMatrix();
    global::DripSharp.Testing.JavaAssertions.NotNull(fontMatrix,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", "FontMatrix must not be null"));
    this.assertNumberList(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      global::DripSharp.Runtime.JavaCompat.Concat("FontMatrix values are different than expected",
      global::DripSharp.Runtime.JavaCompat.StringValueOf(fontMatrix))), new float[] { 0.001F, 0.0F,
        0.0F, 0.001F, 0.0F, 0.0F }, fontMatrix);
  }

  internal virtual void testCharset() {
    global::DripSharp.PdfCarton.Fonts.Cff.CFFCharset charset
      = global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.testCFFType1Font.GetCharset();
    global::DripSharp.Testing.JavaAssertions.NotNull(charset,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", "Charset must not be null"));
    global::DripSharp.Testing.JavaAssertions.False(charset.IsCIDFont(),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", "isCIDFont has to be false"));
    global::DripSharp.Testing.JavaAssertions.Equal("Format1Charset",
      ((object)(charset)).GetType().Name,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Charset is not an instance of Format1Charset"));
    global::DripSharp.Testing.JavaAssertions.Equal(".notdef", charset.GetNameForGID(0),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for gid2name mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal("space", charset.GetNameForGID(1),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for gid2name mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal("F", charset.GetNameForGID(7),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for gid2name mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal("jcircumflex", charset.GetNameForGID(300),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for gid2name mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal("infinity", charset.GetNameForGID(700),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for gid2name mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal(0, charset.GetSIDForGID(0),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for gid2sid mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal(1, charset.GetSIDForGID(1),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for gid2sid mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal(39, charset.GetSIDForGID(7),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for gid2sid mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal(585, charset.GetSIDForGID(300),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for gid2sid mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal(872, charset.GetSIDForGID(700),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for gid2sid mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal(0,
      charset.GetSID(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", ".notdef")),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for name2sid mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal(1,
      charset.GetSID(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", "space")),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for name2sid mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal(39,
      charset.GetSID(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", "F")),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for name2sid mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal(585,
      charset.GetSID(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", "jcircumflex")),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for name2sid mapping"));
    global::DripSharp.Testing.JavaAssertions.Equal(872,
      charset.GetSID(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", "infinity")),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Unexpected value for name2sid mapping"));
  }
  ...
  internal virtual void voidEncoding() {
    global::DripSharp.PdfCarton.Fonts.Cff.CFFEncoding encoding
      = global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.testCFFType1Font.GetEncoding();
    global::DripSharp.Testing.JavaAssertions.NotNull(encoding,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", "Encoding must not be null"));
    global::DripSharp.Testing.JavaAssertions.InstanceOf<global::DripSharp.PdfCarton.Fonts.Cff.CFFStandardEncoding>(encoding,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "Encoding is not an instance of CFFStandardEncoding"));
  }

  internal virtual void testCharStringBytess() {
    global::System.Collections.Generic.IList<sbyte[]> charStringBytes
      = global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.testCFFType1Font.GetCharStringBytes();
    global::DripSharp.Testing.JavaAssertions.False(global::DripSharp.Runtime.JavaCompat.ListIsEmpty(charStringBytes),
      null);
  ...
  internal virtual void testGlobalSubrIndex() {
    global::System.Collections.Generic.IList<sbyte[]> globalSubrIndex
      = global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.testCFFType1Font.GetGlobalSubrIndex();
    global::DripSharp.Testing.JavaAssertions.False(global::DripSharp.Runtime.JavaCompat.ListIsEmpty(globalSubrIndex),
      null);
  ...
  internal virtual void testDeltaLists() {
    global::System.Collections.Generic.IList<global::System.IConvertible> blues
    ...
    global::System.Collections.Generic.IList<global::System.IConvertible> stemSnapH
      ...
      "StemSnapH"));
    this.assertNumberList(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      global::DripSharp.Runtime.JavaCompat.Concat("StemSnapH values are different than expected: ",
      global::DripSharp.Runtime.JavaCompat.StringValueOf(stemSnapH))), new int[] { 115 },
      stemSnapH);
    global::System.Collections.Generic.IList<global::System.IConvertible> stemSnapV
      = global::DripSharp.Runtime.JavaCompat.CastList<global::System.IConvertible>(global::DripSharp.Runtime.JavaCompat.MapGet(global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.testCFFType1Font.GetPrivateDict(),
      "StemSnapV"));
    this.assertNumberList(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      global::DripSharp.Runtime.JavaCompat.Concat("StemSnapV values are different than expected: ",
      global::DripSharp.Runtime.JavaCompat.StringValueOf(stemSnapV))), new int[] { 146, 150 },
      stemSnapV);
  }
  ...
  internal virtual void testMultiThreadParse() {
    ...
    global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.PathRunner pathRunner1
      = new global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.PathRunner(latch, this);
    global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.PathRunner pathRunner2
      = new global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.PathRunner(latch, this);
    global::DripSharp.Runtime.JavaAtomicBoolean wasCalled
      = new global::DripSharp.Runtime.JavaAtomicBoolean(false);
    global::System.Action<global::DripSharp.PdfCarton.Tests.JavaTestThread,
      global::System.Exception> handler = (t, e) => wasCalled.Set(true);
    global::DripSharp.PdfCarton.Tests.JavaTestThread thread1
      = new global::DripSharp.PdfCarton.Tests.JavaTestThread(pathRunner1);
    thread1.SetUncaughtExceptionHandler(handler);
    global::DripSharp.PdfCarton.Tests.JavaTestThread thread2
      = new global::DripSharp.PdfCarton.Tests.JavaTestThread(pathRunner2);
  ...
  internal class PathRunner {
    ...
    internal PathRunner(global::System.Threading.CountdownEvent latch,
      global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest __outer) {
    ...
    public virtual void Run() {
      try {
        for (char i = unchecked((char)(33)); ((int)i < 126); i++) {
          global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.testCFFType1Font.GetPath(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
            global::DripSharp.Runtime.JavaCompat.StringValueOf(i)));
        }
    ...
    public static implicit operator global::System.Action(global::DripSharp.PdfCarton.Fonts.Cff.CFFParserTest.PathRunner value)
      => value.Run;
  }
  ...
  private static global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Fonts.Cff.CFFFont> readFont(string filename) {
    global::DripSharp.PdfCarton.IO.RandomAccessReadBufferedFile randomAccessRead
  ...
  private void assertNumberList(string message, int[] expected,
    global::System.Collections.Generic.IList<global::System.IConvertible> found) {
    global::DripSharp.Testing.JavaAssertions.Equal(expected.Length,
      global::DripSharp.Runtime.JavaCompat.CollectionCount(found),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", message));
    for (int i = 0; (i < expected.Length); i++) {
      global::DripSharp.Testing.JavaAssertions.Equal(expected[i],
        global::DripSharp.Runtime.JavaCompat.NumberIntValue(global::DripSharp.Runtime.JavaCompat.ListGet(found,
        i)), global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", message));
    }
  }

  private void assertNumberList(string message, float[] expected,
    global::System.Collections.Generic.IList<global::System.IConvertible> found) {
    global::DripSharp.Testing.JavaAssertions.Equal(expected.Length,
      global::DripSharp.Runtime.JavaCompat.CollectionCount(found),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", message));
    for (int i = 0; (i < expected.Length); i++) {
      global::DripSharp.Testing.JavaAssertions.Equal(expected[i],
        global::System.Convert.ToSingle(global::DripSharp.Runtime.JavaCompat.ListGet(found, i),
