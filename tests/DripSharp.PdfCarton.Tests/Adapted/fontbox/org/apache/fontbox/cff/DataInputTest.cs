...
public class DataInputTest {
  internal virtual void testReadBytes() {
    ...
    global::DripSharp.PdfCarton.Fonts.Cff.DataInput dataInput
      = new global::DripSharp.PdfCarton.Fonts.Cff.DataInputByteArray(data);
  ...
  internal virtual void testReadShort() {
    sbyte[] data = new sbyte[] { unchecked((sbyte)(0)), unchecked((sbyte)(15)),
      unchecked((sbyte)(170)), unchecked((sbyte)(0)), unchecked((sbyte)(254)),
      unchecked((sbyte)(255)) };
    global::DripSharp.PdfCarton.Fonts.Cff.DataInput dataInput
      = new global::DripSharp.PdfCarton.Fonts.Cff.DataInputByteArray(data);
    global::DripSharp.Testing.JavaAssertions.Equal(unchecked((short)(15)),
      ((global::DripSharp.PdfCarton.Fonts.Cff.DataInput)(dataInput)).ReadShort(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(unchecked((short)(43520)),
      ((global::DripSharp.PdfCarton.Fonts.Cff.DataInput)(dataInput)).ReadShort(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(unchecked((short)(65279)),
      ((global::DripSharp.PdfCarton.Fonts.Cff.DataInput)(dataInput)).ReadShort(), null);
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(()
  ...
  internal virtual void testReadUnsignedShort() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(15,
      ((global::DripSharp.PdfCarton.Fonts.Cff.DataInput)(dataInput)).ReadUnsignedShort(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(43520,
      ((global::DripSharp.PdfCarton.Fonts.Cff.DataInput)(dataInput)).ReadUnsignedShort(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(65279,
      ((global::DripSharp.PdfCarton.Fonts.Cff.DataInput)(dataInput)).ReadUnsignedShort(), null);
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(()
      => { dataInput.ReadUnsignedShort(); }, null);
    sbyte[] data2 = new sbyte[] { unchecked((sbyte)(0)) };
    global::DripSharp.PdfCarton.Fonts.Cff.DataInput dataInput2
      = new global::DripSharp.PdfCarton.Fonts.Cff.DataInputByteArray(data2);
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(()
      => { dataInput2.ReadUnsignedShort(); }, null);
  }

  internal virtual void testReadInt() {
    sbyte[] data = new sbyte[] { unchecked((sbyte)(0)), unchecked((sbyte)(15)),
      unchecked((sbyte)(170)), unchecked((sbyte)(0)), unchecked((sbyte)(254)),
      unchecked((sbyte)(255)), unchecked((sbyte)(48)), unchecked((sbyte)(80)) };
    global::DripSharp.PdfCarton.Fonts.Cff.DataInput dataInput
      = new global::DripSharp.PdfCarton.Fonts.Cff.DataInputByteArray(data);
    global::DripSharp.Testing.JavaAssertions.Equal(1026560,
      ((global::DripSharp.PdfCarton.Fonts.Cff.DataInput)(dataInput)).ReadInt(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(-16830384,
      ((global::DripSharp.PdfCarton.Fonts.Cff.DataInput)(dataInput)).ReadInt(), null);
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(()
      => { dataInput.ReadInt(); }, null);
    sbyte[] data2 = new sbyte[] { unchecked((sbyte)(0)), unchecked((sbyte)(15)),
      unchecked((sbyte)(170)) };
    global::DripSharp.PdfCarton.Fonts.Cff.DataInput dataInput2
      = new global::DripSharp.PdfCarton.Fonts.Cff.DataInputByteArray(data2);
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(()
      => { dataInput2.ReadInt(); }, null);
  }
