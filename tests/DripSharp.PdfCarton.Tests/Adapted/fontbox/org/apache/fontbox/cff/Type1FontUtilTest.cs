...
sbyte[] bytes = global::DripSharp.PdfCarton.Fonts.Cff.Type1FontUtilTest.createRandomByteArray(128, seed);
string encodedBytes = global::DripSharp.PdfCarton.Fonts.Cff.Type1FontUtil.HexEncode(bytes);
sbyte[] decodedBytes = global::DripSharp.PdfCarton.Fonts.Cff.Type1FontUtil.HexDecode(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", encodedBytes));
global::DripSharp.Testing.JavaAssertions.Equal(bytes, decodedBytes, global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", global::DripSharp.Runtime.JavaCompat.Concat("Seed: ", seed)));
}
...
sbyte[] bytes = global::DripSharp.PdfCarton.Fonts.Cff.Type1FontUtilTest.createRandomByteArray(128, seed);
sbyte[] encryptedBytes = global::DripSharp.PdfCarton.Fonts.Cff.Type1FontUtil.EexecEncrypt(bytes);
sbyte[] decryptedBytes = global::DripSharp.PdfCarton.Fonts.Cff.Type1FontUtil.EexecDecrypt(encryptedBytes);
global::DripSharp.Testing.JavaAssertions.Equal(bytes, decryptedBytes, global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", global::DripSharp.Runtime.JavaCompat.Concat("Seed: ", seed)));
}
...
sbyte[] bytes = global::DripSharp.PdfCarton.Fonts.Cff.Type1FontUtilTest.createRandomByteArray(128, seed);
sbyte[] encryptedBytes = global::DripSharp.PdfCarton.Fonts.Cff.Type1FontUtil.CharstringEncrypt(bytes, 4);
sbyte[] decryptedBytes = global::DripSharp.PdfCarton.Fonts.Cff.Type1FontUtil.CharstringDecrypt(encryptedBytes, 4);
global::DripSharp.Testing.JavaAssertions.Equal(bytes, decryptedBytes, global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", global::DripSharp.Runtime.JavaCompat.Concat("Seed: ", seed)));
}

private static sbyte[] createRandomByteArray(int arrayLength, long seed) {
sbyte[] bytes = new sbyte[arrayLength];
global::DripSharp.PdfCarton.Tests.JavaRandom ramdom = new global::DripSharp.PdfCarton.Tests.JavaRandom(seed);
