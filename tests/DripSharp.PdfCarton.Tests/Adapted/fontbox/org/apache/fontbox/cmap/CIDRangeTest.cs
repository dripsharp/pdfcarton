...
public class CIDRangeTest {
  internal virtual void testCIDRangeOneByte() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(unchecked(-1), cidRange.Map(30, 1), null);
    global::DripSharp.Testing.JavaAssertions.Equal(unchecked(-1), cidRange.Map(10, 2), null);
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(unchecked(-1), cidRange.Unmap(100), null);
  }
  ...
  internal virtual void testCIDRangeTwoByte() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(unchecked(-1), cidRange.Map(290, 2), null);
    global::DripSharp.Testing.JavaAssertions.Equal(unchecked(-1), cidRange.Map(256, 1), null);
