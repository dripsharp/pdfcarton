...
global::DripSharp.PdfCarton.Fonts.Cmap.CIDRange cidRange = new global::DripSharp.PdfCarton.Fonts.Cmap.CIDRange(0, 20, 65, 1);
global::DripSharp.Testing.JavaAssertions.Equal(1, cidRange.GetCodeLength(), null);
global::DripSharp.Testing.JavaAssertions.Equal(65, cidRange.Map(new sbyte[] { unchecked((sbyte)(0)) }), null);
global::DripSharp.Testing.JavaAssertions.Equal(75, cidRange.Map(new sbyte[] { unchecked((sbyte)(10)) }), null);
global::DripSharp.Testing.JavaAssertions.Equal(-1, cidRange.Map(new sbyte[] { unchecked((sbyte)(30)) }), null);
global::DripSharp.Testing.JavaAssertions.Equal(-1, cidRange.Map(new sbyte[] { unchecked((sbyte)(0)), unchecked((sbyte)(10)) }), null);
...
global::DripSharp.PdfCarton.Fonts.Cmap.CIDRange cidRange = new global::DripSharp.PdfCarton.Fonts.Cmap.CIDRange(256, 280, 65, 2);
global::DripSharp.Testing.JavaAssertions.Equal(2, cidRange.GetCodeLength(), null);
global::DripSharp.Testing.JavaAssertions.Equal(65, cidRange.Map(new sbyte[] { unchecked((sbyte)(1)), unchecked((sbyte)(0)) }), null);
global::DripSharp.Testing.JavaAssertions.Equal(75, cidRange.Map(new sbyte[] { unchecked((sbyte)(1)), unchecked((sbyte)(10)) }), null);
global::DripSharp.Testing.JavaAssertions.Equal(-1, cidRange.Map(new sbyte[] { unchecked((sbyte)(1)), unchecked((sbyte)(30)) }), null);
global::DripSharp.Testing.JavaAssertions.Equal(-1, cidRange.Map(new sbyte[] { unchecked((sbyte)(10)) }), null);
