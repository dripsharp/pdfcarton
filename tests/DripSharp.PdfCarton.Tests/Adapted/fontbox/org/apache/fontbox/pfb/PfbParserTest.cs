...
public class PfbParserTest {
  internal virtual void testPfb() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal("Digitized data copyright (c) 2010-2011, Google Corporation.",
      font.GetNotice(), null);
    ...
    global::DripSharp.Testing.JavaAssertions.InstanceOf<global::DripSharp.PdfCarton.Fonts.Encoding.BuiltInEncoding>(font.GetEncoding(),
      null);
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(938,
      global::DripSharp.Runtime.JavaCompat.MapCount(font.GetCharStringsDict()), null);
    foreach (string s in global::DripSharp.Runtime.JavaCompat.MapKeySet(font.GetCharStringsDict())) {
      global::DripSharp.Testing.JavaAssertions.NotNull(font.GetPath(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
        s)), null);
      global::DripSharp.Testing.JavaAssertions.True(font.HasGlyph(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
        s)), null);
    }
  }
  ...
  internal virtual void testPfbPDFBox5713() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal("DejaVuSerifCondensed", font.GetFontName(),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal("DejaVu Serif Condensed", font.GetFullName(),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal("DejaVu Serif Condensed", font.GetFamilyName(),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal("Copyright [c] 2003 by Bitstream, Inc. All Rights Reserved.",
      font.GetNotice(), null);
    global::DripSharp.Testing.JavaAssertions.False(font.IsFixedPitch(), null);
    global::DripSharp.Testing.JavaAssertions.False(font.IsForceBold(), null);
    global::DripSharp.Testing.JavaAssertions.Equal((float)(0), font.GetItalicAngle(), null);
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(3399,
      global::DripSharp.Runtime.JavaCompat.MapCount(font.GetCharStringsDict()), null);
  }

  internal virtual void testEmpty() {
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(()
      => global::DripSharp.PdfCarton.Fonts.Type1.Type1Font.CreateWithPFB(new sbyte[0]), null);
  }

  internal virtual void testNegativeRecordSize() {
    sbyte[] crashInput = new sbyte[] { unchecked((sbyte)(128)), unchecked((sbyte)(1)),
      unchecked((sbyte)(1)), unchecked((sbyte)(0)), unchecked((sbyte)(0)), unchecked((sbyte)(255)),
      unchecked((sbyte)(255)), unchecked((sbyte)(255)), unchecked((sbyte)(255)),
      unchecked((sbyte)(255)), unchecked((sbyte)(255)), unchecked((sbyte)(255)),
      unchecked((sbyte)(39)), unchecked((sbyte)(5)), unchecked((sbyte)(248)),
      unchecked((sbyte)(255)), unchecked((sbyte)(210)), unchecked((sbyte)(64)) };
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(()
      => new global::DripSharp.PdfCarton.Fonts.Pfb.PfbParser(crashInput), null);
  }
