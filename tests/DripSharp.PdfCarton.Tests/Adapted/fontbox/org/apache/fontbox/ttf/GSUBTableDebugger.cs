...
public class GSUBTableDebugger {
  ...
  internal virtual void printLohitBengaliTTF() { {
      ...
      global::System.Exception __dripsharpPrimary_42_25_0 = null!;
      try {
        ...
        try {
          ...
          global::DripSharp.Runtime.JavaCompat.CloseResource(is2, __dripsharpPrimary_43_25_0);
        }
      } catch (global::System.Exception __dripsharpCaught_42_25_0) {
        __dripsharpPrimary_42_25_0 = __dripsharpCaught_42_25_0;
        throw;
      } finally {
        global::DripSharp.Runtime.JavaCompat.CloseResource(is1, __dripsharpPrimary_42_25_0);
      }
    }
  }
