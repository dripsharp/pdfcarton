...
global::DripSharp.PdfCarton.Fonts.Ttf.GlyphDescription glyphDescription = aacuteGlyph.GetDescription();
global::DripSharp.Testing.JavaAssertions.True(glyphDescription.IsComposite(), null);
global::DripSharp.PdfCarton.Fonts.Ttf.GlyfCompositeDescript compositeGlyphDescription = (global::DripSharp.PdfCarton.Fonts.Ttf.GlyfCompositeDescript)(glyphDescription!);
global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Fonts.Ttf.GlyfCompositeComp> componentsView = compositeGlyphDescription.GetComponents();
global::DripSharp.Testing.JavaAssertions.Equal(2, global::DripSharp.Runtime.JavaCompat.CollectionCount(componentsView), null);
global::DripSharp.Testing.JavaAssertions.Throws<global::System.NotSupportedException>(() => global::DripSharp.Runtime.JavaCompat.ListRemove(componentsView, 0), null);
}

[Xunit.Fact(DisplayName = "getComponents() method returns read-only list of all glyph components")]
