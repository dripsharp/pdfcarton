...
public class GlyphSubstitutionTableLiberationFontTest {
  ...
  internal virtual void getGsubDataForUnsupportedScriptTag() {
    ...
    global::DripSharp.PdfCarton.Fonts.Ttf.Model.GsubData gsubData
      = gsub.GetGsubData(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "<some_non_existent_script_tag>"));
  ...
  internal virtual void testGetGsubDataForCyrillic() {
    ...
    global::System.Collections.Generic.IList<string> expectedFeatures
      = global::DripSharp.Runtime.JavaCompat.AsList<string>("subs", "sups");
    global::DripSharp.PdfCarton.Fonts.Ttf.Model.GsubData cyrillicGsubData
      = gsub.GetGsubData(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      cyrillicScriptTag));
    global::DripSharp.Testing.JavaAssertions.NotNull(cyrillicGsubData, null);
    global::DripSharp.Testing.JavaAssertions.Equal(cyrillicScriptTag,
      cyrillicGsubData.GetActiveScriptName(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(new global::System.Collections.Generic.HashSet<string>(expectedFeatures),
      cyrillicGsubData.GetSupportedFeatures(), null);
  }

  internal virtual void getSupportedScriptTags() {
    global::DripSharp.PdfCarton.Fonts.Ttf.GlyphSubstitutionTable gsub = this.font.GetGsub();
    global::System.Collections.Generic.IList<string> expectedSet
      = global::DripSharp.Runtime.JavaCompat.AsList<string>("DFLT", "bopo", "copt", "cyrl", "grek",
      "hebr", "latn");
    global::System.Collections.Generic.ISet<string> supportedScriptTags
      = gsub.GetSupportedScriptTags();
    global::DripSharp.Testing.JavaAssertions.Equal(new global::System.Collections.Generic.HashSet<string>(expectedSet),
      supportedScriptTags, null);
  }

  internal virtual void checkGsubDataLoadingForAllSupportedScripts(string scriptTag) {
    global::DripSharp.PdfCarton.Fonts.Ttf.GlyphSubstitutionTable gsub = this.font.GetGsub();
    global::DripSharp.PdfCarton.Fonts.Ttf.Model.GsubData gsubData
      = gsub.GetGsubData(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", scriptTag));
    global::DripSharp.Testing.JavaAssertions.NotNull(gsubData, null);
    global::DripSharp.Testing.JavaAssertions.NotSame(global::DripSharp.PdfCarton.Fonts.Ttf.Model.GsubDataStatics.NoDataFound,
      gsubData, null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Fonts.Ttf.Model.Language.Unspecified,
