...
public class TestCMapSubtable {
  internal virtual void testPDFBox5328() {
    ...
    global::DripSharp.PdfCarton.Fonts.Ttf.OTFParser otfParser
      = new global::DripSharp.PdfCarton.Fonts.Ttf.OTFParser(false);
    global::DripSharp.PdfCarton.Fonts.Ttf.OpenTypeFont otf
      = otfParser.Parse(new global::DripSharp.PdfCarton.IO.RandomAccessReadBufferedFile(fontFile));
    ...
    global::DripSharp.PdfCarton.Fonts.Ttf.CmapSubtable unicodeFullCmapTable
    ...
    global::DripSharp.PdfCarton.Fonts.Ttf.CmapSubtable unicodeBmpCmapTable
      = cmapTable.GetSubtable(global::DripSharp.PdfCarton.Fonts.Ttf.CmapTable.PlatformUnicode,
      global::DripSharp.PdfCarton.Fonts.Ttf.CmapTable.EncodingUnicode20Bmp);
    global::System.Collections.Generic.IList<int> unicodeBmpCharCodes
      = unicodeBmpCmapTable.GetCharCodes(gid);
    global::System.Collections.Generic.IList<int> unicodeFullCharCodes
      = unicodeFullCmapTable.GetCharCodes(gid);
  ...
  internal virtual void testVerticalSubstitution() {
    ...
    global::DripSharp.PdfCarton.Fonts.Ttf.TrueTypeFont ttf
      = new global::DripSharp.PdfCarton.Fonts.Ttf.TTFParser().Parse(new global::DripSharp.PdfCarton.IO.RandomAccessReadBufferedFile(ipaFont));
    global::DripSharp.PdfCarton.Fonts.Ttf.CmapLookup unicodeCmapLookup1
    ...
    global::DripSharp.PdfCarton.Fonts.Ttf.CmapLookup unicodeCmapLookup2
      = ttf.GetUnicodeCmapLookup();
