...
public class TestTTFParser {
  internal virtual void testUTCDate() {
    ...
    global::System.TimeZoneInfo utc
      = global::DripSharp.Runtime.JavaCompat.GetTimeZone(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "UTC"));
    global::DripSharp.PdfCarton.Tests.Support.SetDefaultTimeZone(global::DripSharp.Runtime.JavaCompat.GetTimeZone(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox",
      "America/Los Angeles")));
    ...
    global::DripSharp.PdfCarton.Fonts.Ttf.TrueTypeFont ttf
      = parser.Parse(new global::DripSharp.PdfCarton.IO.RandomAccessReadBufferedFile(testFile));
    global::System.DateTimeOffset? created = ttf.GetHeader().GetCreated();
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.CalendarGetTimeZone(created),
      utc, null);
    global::System.DateTimeOffset? target
      = global::DripSharp.Runtime.JavaCompat.CalendarInstance(utc);
  ...
  internal virtual void testPostTable() {
    ...
    foreach (global::DripSharp.PdfCarton.Fonts.Ttf.CmapSubtable e in cmaps) {
      if (((e.GetPlatformId() == global::DripSharp.PdfCarton.Fonts.Ttf.NameRecord.PlatformWindows)
        && (e.GetPlatformEncodingId()
