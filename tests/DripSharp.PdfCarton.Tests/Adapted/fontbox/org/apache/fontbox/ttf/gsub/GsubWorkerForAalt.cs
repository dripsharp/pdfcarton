...
private static readonly global::System.Collections.Generic.IList<string> FEATURES_IN_ORDER = global::DripSharp.Runtime.JavaCompat.AsList<string>("aalt");
...
if (!(this.gsubData.IsFeatureSupported(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", feature)))) {
global::Microsoft.Extensions.Logging.LoggerExtensions.LogDebug(global::DripSharp.PdfCarton.Fonts.Ttf.Gsub.GsubWorkerForAalt.LOG, global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("the feature ", feature), " was not found")));
continue;
}
global::Microsoft.Extensions.Logging.LoggerExtensions.LogDebug(global::DripSharp.PdfCarton.Fonts.Ttf.Gsub.GsubWorkerForAalt.LOG, global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat("applying the feature ", feature)));
global::DripSharp.PdfCarton.Fonts.Ttf.Model.ScriptFeature scriptFeature = this.gsubData.GetFeature(global::DripSharp.PdfCarton.Tests.Support.TestPath("fontbox", feature));
...
global::Microsoft.Extensions.Logging.LoggerExtensions.LogDebug(global::DripSharp.PdfCarton.Fonts.Ttf.Gsub.GsubWorkerForAalt.LOG, global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("getAllGlyphIdsForSubstitution() for ", scriptFeature.GetName()), " is empty")));
...
int glyphId = global::DripSharp.Runtime.JavaCompat.UnboxObject<int>(scriptFeature.GetReplacementForGlyphs(chunk));
...
global::Microsoft.Extensions.Logging.LoggerExtensions.LogDebug(global::DripSharp.PdfCarton.Fonts.Ttf.Gsub.GsubWorkerForAalt.LOG, global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("originalGlyphs: ", originalGlyphs), ", gsubProcessedGlyphs: "), gsubProcessedGlyphs)));
