...
using (global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream randomAccessSource = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(bais)) {
...
sbyte[] inputValues = new sbyte[] { unchecked((sbyte)(0)), unchecked((sbyte)(1)), unchecked((sbyte)(2)), unchecked((sbyte)(3)), unchecked((sbyte)(4)), unchecked((sbyte)(5)), unchecked((sbyte)(6)), unchecked((sbyte)(7)), unchecked((sbyte)(8)), unchecked((sbyte)(9)), unchecked((sbyte)(10)) };
global::System.IO.MemoryStream bais = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(inputValues);
global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream randomAccessSource = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(bais);
global::DripSharp.Testing.JavaAssertions.Equal((long)(0), randomAccessSource.GetPosition(), null);
...
global::System.IO.MemoryStream bais = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(inputValues);
using (global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream randomAccessSource = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(bais)) {
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => randomAccessSource.Seek((long)(3)), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "seek should have thrown an IOException"));
}
}
...
global::System.IO.MemoryStream bais = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(inputValues);
using (global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream randomAccessSource = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(bais)) {
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => randomAccessSource.CreateView((long)(3), (long)(5)), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "createView should have thrown an IOException"));
}
}

internal virtual void testBufferSwitch() {
sbyte[] original = this.createRandomData();
global::System.IO.MemoryStream byteArrayInputStream = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(original);
using (global::DripSharp.PdfCarton.IO.RandomAccessRead rar = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(byteArrayInputStream)) {
...
global::System.IO.MemoryStream byteArrayInputStream = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(this.createRandomData());
using (global::DripSharp.PdfCarton.IO.RandomAccessRead rar = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(byteArrayInputStream)) {
...
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => ((global::DripSharp.PdfCarton.IO.RandomAccessRead)(rar)).Rewind(4096), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "createView should have thrown an IOException"));
}
}
...
using (global::DripSharp.PdfCarton.IO.RandomAccessRead rar = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(bais)) {
int len = ((global::DripSharp.PdfCarton.IO.RandomAccessRead)((global::DripSharp.PdfCarton.IO.RandomAccessRead)(rar))).Read(new sbyte[(ba.Length - rewSize)]);
global::DripSharp.Testing.JavaAssertions.Equal((ba.Length - rewSize), len, null);
len = ((global::DripSharp.PdfCarton.IO.RandomAccessRead)((global::DripSharp.PdfCarton.IO.RandomAccessRead)(rar))).Read(new sbyte[rewSize]);
...
int len = ((global::DripSharp.PdfCarton.IO.RandomAccessRead)((global::DripSharp.PdfCarton.IO.RandomAccessRead)(rar))).Read(new sbyte[(4096 + 1)]);
global::DripSharp.Testing.JavaAssertions.Equal((long)((4096 * 2)), rar.Length(), null);
...
len = ((global::DripSharp.PdfCarton.IO.RandomAccessRead)((global::DripSharp.PdfCarton.IO.RandomAccessRead)(rar))).Read(buf);
...
global::DripSharp.Testing.JavaAssertions.Equal(-1, rar.Read(), null);
global::DripSharp.Testing.JavaAssertions.Equal(-1, ((global::DripSharp.PdfCarton.IO.RandomAccessRead)((global::DripSharp.PdfCarton.IO.RandomAccessRead)(rar))).Read(new sbyte[1]), null);
}
}
...
global::System.IO.MemoryStream bais = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(ba);
global::DripSharp.PdfCarton.IO.RandomAccessRead rar = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(bais);
global::DripSharp.Testing.JavaAssertions.Equal(1, rar.Read(), null);
global::DripSharp.Testing.JavaAssertions.Equal(-1, rar.Read(), null);
rar.Dispose();
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => { rar.Read(); }, global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "read() should have thrown an IOException"));
}

internal virtual void testClosedStreamMethods() {
global::System.IO.MemoryStream bais = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(new sbyte[] { unchecked((sbyte)(1)), unchecked((sbyte)(2)), unchecked((sbyte)(3)) });
global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream rar = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(bais);
rar.Dispose();
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => { rar.Read(); }, global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "read() on closed stream should throw IOException"));
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => rar.Read(new sbyte[1], 0, 1), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "read(byte[], int, int) on closed stream should throw IOException"));
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => rar.ReadFully(new sbyte[1], 0, 1), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "readFully() on closed stream should throw IOException"));
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => { rar.GetPosition(); }, global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "getPosition() on closed stream should throw IOException"));
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => { rar.Available(); }, global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "available() on closed stream should throw IOException"));
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => { rar.Length(); }, global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "length() on closed stream should throw IOException"));
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => { rar.IsEOF(); }, global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "isEOF() on closed stream should throw IOException"));
}

internal virtual void testReadBytesParameterValidation() {
sbyte[] inputValues = new sbyte[] { unchecked((sbyte)(0)), unchecked((sbyte)(1)), unchecked((sbyte)(2)), unchecked((sbyte)(3)), unchecked((sbyte)(4)) };
global::System.IO.MemoryStream bais = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(inputValues);
using (global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream rar = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(bais)) {
global::DripSharp.Testing.JavaAssertions.Throws<global::System.NullReferenceException>(() => rar.Read((sbyte[])default!, 0, 1), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "null buffer should throw NullPointerException"));
sbyte[] buf = new sbyte[4];
global::DripSharp.Testing.JavaAssertions.Throws<global::System.ArgumentOutOfRangeException>(() => rar.Read(buf, -1, 2), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "negative offset should throw IndexOutOfBoundsException"));
global::DripSharp.Testing.JavaAssertions.Throws<global::System.ArgumentOutOfRangeException>(() => rar.Read(buf, 0, -1), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "negative length should throw IndexOutOfBoundsException"));
global::DripSharp.Testing.JavaAssertions.Throws<global::System.ArgumentOutOfRangeException>(() => rar.Read(buf, 2, 4), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "offset + length > buf.length should throw IndexOutOfBoundsException"));
...
sbyte[] inputValues = new sbyte[] { unchecked((sbyte)(0)), unchecked((sbyte)(1)), unchecked((sbyte)(2)) };
global::System.IO.MemoryStream bais = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(inputValues);
using (global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream rar = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(bais)) {
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.EndOfStreamException>(() => rar.ReadFully(new sbyte[10], 0, 10), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "readFully() should throw EOFException when stream ends before length bytes"));
}
}
...
using (global::DripSharp.PdfCarton.IO.RandomAccessRead rar = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(global::DripSharp.Runtime.JavaCompat.OpenInputStream(path))) {
...
using (global::DripSharp.PdfCarton.IO.RandomAccessRead rar = new global::DripSharp.PdfCarton.IO.NonSeekableRandomAccessReadInputStream(global::DripSharp.Runtime.JavaCompat.NewMemoryStream(new sbyte[4099]))) {
sbyte[] buf = new sbyte[4096];
