...
using (global::DripSharp.PdfCarton.IO.RandomAccessInputStream randomAccessInputStream = new global::DripSharp.PdfCarton.IO.RandomAccessInputStream(new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(bais))) {
...
global::DripSharp.Testing.JavaAssertions.Equal((long)(0), randomAccessInputStream.Skip((long)(-10)), null);
}
}
...
global::System.IO.MemoryStream bais = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(inputValues);
using (global::DripSharp.PdfCarton.IO.RandomAccessInputStream randomAccessInputStream = new global::DripSharp.PdfCarton.IO.RandomAccessInputStream(new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(bais))) {
global::DripSharp.Testing.JavaAssertions.Equal((long)(12), randomAccessInputStream.Skip((long)((inputValues.Length + 1))), null);
global::DripSharp.Testing.JavaAssertions.Equal(0, randomAccessInputStream.Available(), null);
global::DripSharp.Testing.JavaAssertions.Equal(-1, randomAccessInputStream.Read(), null);
global::DripSharp.Testing.JavaAssertions.Equal(-1, randomAccessInputStream.Read(new sbyte[1], 0, 1), null);
}
}
...
using (global::DripSharp.PdfCarton.IO.RandomAccessInputStream randomAccessInputStream = new global::DripSharp.PdfCarton.IO.RandomAccessInputStream(new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(global::DripSharp.Runtime.JavaCompat.ToSignedBytes(new global::DripSharp.Runtime.JavaByteArrayOutputStream())))) {
global::DripSharp.Testing.JavaAssertions.Equal(-1, randomAccessInputStream.Read(), null);
global::DripSharp.Testing.JavaAssertions.Equal(-1, global::DripSharp.Runtime.JavaCompat.InputStreamRead(randomAccessInputStream, new sbyte[6]), null);
global::DripSharp.Testing.JavaAssertions.Equal(0, randomAccessInputStream.Available(), null);
}
}
