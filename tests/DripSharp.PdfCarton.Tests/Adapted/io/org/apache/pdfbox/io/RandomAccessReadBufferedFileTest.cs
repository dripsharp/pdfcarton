...
using (global::DripSharp.PdfCarton.IO.RandomAccessRead randomAccessSource = new global::DripSharp.PdfCarton.IO.RandomAccessReadBufferedFile(global::DripSharp.Runtime.JavaCompat.NewFileInfo(global::DripSharp.PdfCarton.Tests.Support.ResourceUri(((object)(this)).GetType(), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "RandomAccessReadFile1.txt"))))) {
...
using (global::DripSharp.PdfCarton.IO.RandomAccessRead randomAccessSource = new global::DripSharp.PdfCarton.IO.RandomAccessReadBufferedFile(global::DripSharp.Runtime.JavaCompat.PathOfUri(global::DripSharp.PdfCarton.Tests.Support.ResourceUri(((object)(this)).GetType(), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "RandomAccessReadFile1.txt"))))) {
...
using (global::DripSharp.PdfCarton.IO.RandomAccessRead randomAccessSource = new global::DripSharp.PdfCarton.IO.RandomAccessReadBufferedFile(global::DripSharp.Runtime.JavaCompat.NewFileInfo(global::DripSharp.PdfCarton.Tests.Support.ResourceUri(((object)(this)).GetType(), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "RandomAccessReadEmptyFile.txt"))))) {
global::DripSharp.Testing.JavaAssertions.Equal(-1, randomAccessSource.Read(), null);
...
using (global::DripSharp.PdfCarton.IO.RandomAccessRead randomAccessSource = new global::DripSharp.PdfCarton.IO.RandomAccessReadBufferedFile(global::DripSharp.Runtime.JavaCompat.NewFileInfo(global::DripSharp.PdfCarton.Tests.Support.ResourceUri(((object)(this)).GetType(), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "RandomAccessReadFile1.txt"))))) using (global::DripSharp.PdfCarton.IO.RandomAccessReadView view = randomAccessSource.CreateView((long)(3), (long)(10))) {
...
string s = global::DripSharp.Runtime.JavaCompat.NewString(b, global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
...
string s = global::DripSharp.Runtime.JavaCompat.NewString(b, 2, 8, global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
...
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.EndOfStreamException>(() => ((global::DripSharp.PdfCarton.IO.RandomAccessRead)(randomAccessSource)).ReadFully(b), null);
}
}

internal virtual void testReadFullyExact() {
global::DripSharp.Runtime.JavaPath path = global::DripSharp.Runtime.JavaCompat.PathOfUri(global::DripSharp.PdfCarton.Tests.Support.ResourceUri(((object)(this)).GetType(), global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "RandomAccessReadFile1.txt")));
using (global::DripSharp.PdfCarton.IO.RandomAccessRead randomAccessSource = new global::DripSharp.PdfCarton.IO.RandomAccessReadBufferedFile(path)) {
...
int bufferLen;
global::System.IO.FileInfo file = global::DripSharp.PdfCarton.Tests.Support.TestFile(global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "src/test/java/org/apache/pdfbox/io/NonSeekableRandomAccessReadInputStreamTest.java"));
using (global::DripSharp.PdfCarton.IO.RandomAccessRead randomAccessSource__275_31 = new global::DripSharp.PdfCarton.IO.RandomAccessReadBufferedFile(file)) {
int length = (int)(randomAccessSource__275_31.Length());
sbyte[] b__278_20 = new sbyte[length];
bufferLen = ((global::DripSharp.PdfCarton.IO.RandomAccessRead)((global::DripSharp.PdfCarton.IO.RandomAccessRead)(randomAccessSource__275_31))).Read(b__278_20);
global::DripSharp.Testing.JavaAssertions.True(((bufferLen * 2) < length), null);
}
sbyte[] expectedBytes;
using (global::System.IO.Stream @is = global::DripSharp.Runtime.JavaCompat.OpenFileInput(file)) {
long skipped = global::DripSharp.Runtime.JavaCompat.InputStreamSkip(@is, (long)((bufferLen / 2)));
global::DripSharp.Testing.JavaAssertions.Equal(skipped, (long)((bufferLen / 2)), null);
expectedBytes = new sbyte[(bufferLen * 2)];
int actualRead = global::DripSharp.Runtime.JavaCompat.InputStreamRead(@is, expectedBytes, 1, (expectedBytes.Length - 1));
global::DripSharp.Testing.JavaAssertions.Equal((expectedBytes.Length - 1), actualRead, null);
}
using (global::DripSharp.PdfCarton.IO.RandomAccessRead randomAccessSource__293_31 = new global::DripSharp.PdfCarton.IO.RandomAccessReadBufferedFile(file)) {
randomAccessSource__293_31.Seek((long)((bufferLen / 2)));
sbyte[] b__296_20 = new sbyte[(bufferLen * 2)];
((global::DripSharp.PdfCarton.IO.RandomAccessRead)(randomAccessSource__293_31)).ReadFully(b__296_20, 1, (b__296_20.Length - 1));
