...
using (global::DripSharp.PdfCarton.IO.ScratchFile scratchFile = new global::DripSharp.PdfCarton.IO.ScratchFile(global::DripSharp.PdfCarton.IO.MemoryUsageSetting.SetupMainMemoryOnly())) {
...
for (int i = 0; (i < global::DripSharp.PdfCarton.IO.ScratchFileBufferTest.NUM_ITERATIONS); i++) {
long p0 = scratchFileBuffer.GetPosition();
scratchFileBuffer.Write(bytes);
long p1 = scratchFileBuffer.GetPosition();
global::DripSharp.Testing.JavaAssertions.Equal((long)(global::DripSharp.PdfCarton.IO.ScratchFileBufferTest.PAGE_SIZE), (p1 - p0), null);
scratchFileBuffer.Write(bytes);
long p2 = scratchFileBuffer.GetPosition();
global::DripSharp.Testing.JavaAssertions.Equal((long)(global::DripSharp.PdfCarton.IO.ScratchFileBufferTest.PAGE_SIZE), (p2 - p1), null);
scratchFileBuffer.Seek((long)(0));
scratchFileBuffer.Seek((long)(((i * 2) * global::DripSharp.PdfCarton.IO.ScratchFileBufferTest.PAGE_SIZE)));
}
}
}
...
global::DripSharp.Testing.JavaAssertions.Equal((long)(global::DripSharp.PdfCarton.IO.ScratchFileBufferTest.PAGE_SIZE), scratchFileBuffer1.Length(), null);
}
}
...
global::DripSharp.PdfCarton.IO.RandomAccess scratchFileBuffer1 = scratchFile.CreateBuffer();
scratchFileBuffer1.Write(bytes);
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => scratchFileBuffer1.Seek((long)(-1)), null);
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.EndOfStreamException>(() => scratchFileBuffer1.Seek((long)((global::DripSharp.PdfCarton.IO.ScratchFileBufferTest.PAGE_SIZE + 1))), null);
}
}
...
global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(() => scratchFileBuffer.Seek((long)(0)), null);
}
}
...
global::DripSharp.Testing.JavaAssertions.Throws<global::System.NotSupportedException>(() => scratchFileBuffer.CreateView((long)(0), (long)(10)), null);
}
}
