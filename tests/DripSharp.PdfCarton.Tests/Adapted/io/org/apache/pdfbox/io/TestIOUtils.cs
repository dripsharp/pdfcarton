...
public class TestIOUtils {
  internal virtual void testPopulateBuffer() {
    sbyte[] data = global::DripSharp.Runtime.JavaCompat.StringGetBytes("Hello World!",
  ...
  internal virtual void testPopulateBufferEmpty() {
    ...
    global::System.IO.Stream @in
      = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(new sbyte[0]);
  ...
  internal virtual void testToByteArray() {
    sbyte[] data = global::DripSharp.Runtime.JavaCompat.StringGetBytes("Test Data",
      global::System.Text.Encoding.UTF8);
    sbyte[] result
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.NewString(data,
      global::System.Text.Encoding.UTF8), global::DripSharp.Runtime.JavaCompat.NewString(result,
      global::System.Text.Encoding.UTF8), null);
  }

  internal virtual void testToByteArrayEmpty() {
    sbyte[] result
      = global::DripSharp.PdfCarton.IO.IOUtils.ToByteArray(global::DripSharp.Runtime.JavaCompat.NewMemoryStream(new sbyte[0]));
  ...
  internal virtual void testCopy() {
    sbyte[] data = global::DripSharp.Runtime.JavaCompat.StringGetBytes("Copy Test Content",
      global::System.Text.Encoding.UTF8);
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.NewString(data,
      global::System.Text.Encoding.UTF8),
      global::DripSharp.PdfCarton.Tests.Support.OutputText(output), null);
  }
  ...
  internal virtual void testCloseQuietlyNull() {
    global::DripSharp.Testing.JavaAssertions.DoesNotThrow(()
      => global::DripSharp.PdfCarton.Tests.Support.CloseQuietly((global::System.Action)default!),
      null);
  }

  internal virtual void testCloseQuietly() {
    global::System.IO.MemoryStream stream
      = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(new sbyte[10]);
    global::DripSharp.Testing.JavaAssertions.DoesNotThrow(()
      => global::DripSharp.PdfCarton.Tests.Support.CloseQuietly(stream), null);
  }

  internal virtual void testCloseQuietlySuppressesException() {
    global::DripSharp.Testing.JavaAssertions.DoesNotThrow(() => {
        global::System.Action failingCloseable = () => {
          throw new global::System.IO.IOException(global::DripSharp.PdfCarton.Tests.Support.TestPath("io",
          "Test IOException"));
        };
  ...
  internal virtual void testCloseAndLogExceptionSuccess() {
    ...
    global::System.IO.MemoryStream stream
      = global::DripSharp.Runtime.JavaCompat.NewMemoryStream(new sbyte[10]);
    global::System.IO.IOException result
      = global::DripSharp.PdfCarton.Tests.Support.CloseAndLogException(stream, logger,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "testResource"),
      (global::System.IO.IOException)default!);
  ...
  internal virtual void testCloseAndLogExceptionCloseThrows() {
    global::Microsoft.Extensions.Logging.ILogger logger
      = global::Microsoft.Extensions.Logging.Abstractions.NullLogger.Instance;
    global::System.IO.IOException closeException
      = new global::System.IO.IOException(global::DripSharp.PdfCarton.Tests.Support.TestPath("io",
      "Close error"));
    global::System.Action failingCloseable = () => {
      throw closeException;
    };
    global::System.IO.IOException result
      = global::DripSharp.PdfCarton.Tests.Support.CloseAndLogException(failingCloseable, logger,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "testResource"),
      (global::System.IO.IOException)default!);
  ...
  internal virtual void testCloseAndLogExceptionPreservesInitialException() {
    ...
    global::System.IO.IOException result
      = global::DripSharp.PdfCarton.Tests.Support.CloseAndLogException(failingCloseable, logger,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "testResource"), initialException);
    global::DripSharp.Testing.JavaAssertions.Equal(initialException, result, null);
  }

  internal virtual void testUnmapNull() {
    global::DripSharp.Testing.JavaAssertions.DoesNotThrow(()
      => global::DripSharp.PdfCarton.IO.IOUtils.Unmap((global::DripSharp.Runtime.JavaByteBuffer)default!),
      null);
  }

  internal virtual void testUnmapHeapBuffer() {
    global::DripSharp.Runtime.JavaByteBuffer buffer
      = global::DripSharp.Runtime.JavaByteBuffer.allocate(1024);
    global::DripSharp.Testing.JavaAssertions.DoesNotThrow(()
      => global::DripSharp.PdfCarton.IO.IOUtils.Unmap(buffer), null);
  }

  internal virtual void testCreateMemoryOnlyStreamCache() {
    global::DripSharp.PdfCarton.IO.RandomAccessStreamCache.StreamCacheCreateFunction function
  ...
  internal virtual void testCreateProtectedTempDir() {
    global::DripSharp.Runtime.JavaPath tempDir
      = global::DripSharp.PdfCarton.IO.IOUtils.CreateProtectedTempDir();
    try {
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.Exists(tempDir),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io",
        "Temporary directory should exist"));
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.IsDirectory(tempDir),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "Path should be a directory"));
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.StringStartsWith(global::System.IO.Path.GetFileName(tempDir).ToString()!,
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "pdfbox-")),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io",
  ...
  internal virtual void testCreateProtectedTempDirPermissions() {
    global::DripSharp.Runtime.JavaPath tempDir
      = global::DripSharp.PdfCarton.IO.IOUtils.CreateProtectedTempDir();
    try {
      if (global::DripSharp.PdfCarton.Tests.Support.SupportsFileAttributeView(global::DripSharp.PdfCarton.Tests.Support.FileStore(tempDir),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "posix"))) {
        global::System.Collections.Generic.ISet<global::DripSharp.Runtime.JavaUnixFileMode> perms
          = global::DripSharp.PdfCarton.Tests.Support.GetPosixFilePermissions(tempDir);
        global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.CollectionContains(perms,
          global::DripSharp.Runtime.JavaUnixFileMode.UserRead), null);
        global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.CollectionContains(perms,
          global::DripSharp.Runtime.JavaUnixFileMode.UserWrite), null);
        global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.CollectionContains(perms,
          global::DripSharp.Runtime.JavaUnixFileMode.UserExecute), null);
        global::DripSharp.Testing.JavaAssertions.False(global::DripSharp.Runtime.JavaCompat.CollectionContains(perms,
          global::DripSharp.Runtime.JavaUnixFileMode.GroupRead), null);
        global::DripSharp.Testing.JavaAssertions.False(global::DripSharp.Runtime.JavaCompat.CollectionContains(perms,
          global::DripSharp.Runtime.JavaUnixFileMode.GroupWrite), null);
        global::DripSharp.Testing.JavaAssertions.False(global::DripSharp.Runtime.JavaCompat.CollectionContains(perms,
          global::DripSharp.Runtime.JavaUnixFileMode.GroupExecute), null);
        global::DripSharp.Testing.JavaAssertions.False(global::DripSharp.Runtime.JavaCompat.CollectionContains(perms,
          global::DripSharp.Runtime.JavaUnixFileMode.OtherRead), null);
        global::DripSharp.Testing.JavaAssertions.False(global::DripSharp.Runtime.JavaCompat.CollectionContains(perms,
          global::DripSharp.Runtime.JavaUnixFileMode.OtherWrite), null);
        global::DripSharp.Testing.JavaAssertions.False(global::DripSharp.Runtime.JavaCompat.CollectionContains(perms,
          global::DripSharp.Runtime.JavaUnixFileMode.OtherExecute), null);
      }
    } finally {
      if (global::DripSharp.Runtime.JavaCompat.Exists(tempDir)) {
        global::DripSharp.Runtime.JavaCompat.DeleteIfExists(tempDir);
  ...
  internal virtual void testCreateProtectedTempDirMultiple() {
    global::DripSharp.Runtime.JavaPath tempDir1
      = global::DripSharp.PdfCarton.IO.IOUtils.CreateProtectedTempDir();
    global::DripSharp.Runtime.JavaPath tempDir2
      = global::DripSharp.PdfCarton.IO.IOUtils.CreateProtectedTempDir();
    try {
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.Exists(tempDir1),
        null);
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.Exists(tempDir2),
        null);
  ...
  internal virtual void testCreateProtectedTempFileDefaultDir() {
    global::DripSharp.Runtime.JavaPath tempFile
      = global::DripSharp.PdfCarton.IO.IOUtils.CreateProtectedTempFile((global::DripSharp.Runtime.JavaPath)default!,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "test"),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", ".tmp"));
    try {
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.Exists(tempFile),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "Temporary file should exist"));
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.PathIsRegularFile(tempFile),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "Path should be a file"));
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.StringStartsWith(global::System.IO.Path.GetFileName(tempFile).ToString()!,
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "test")),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io",
        "File name should start with 'test'"));
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.StringEndsWith(global::System.IO.Path.GetFileName(tempFile).ToString()!,
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io", ".tmp")),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io",
  ...
  internal virtual void testCreateProtectedTempFileSpecifiedDir() {
    ...
    try {
      global::DripSharp.Runtime.JavaPath tempFile
        = global::DripSharp.PdfCarton.IO.IOUtils.CreateProtectedTempFile(tempDir,
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "myfile"),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io", ".bin"));
      try {
        global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.Exists(tempFile),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "Temporary file should exist"));
        global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.PathIsRegularFile(tempFile),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "Path should be a file"));
        global::DripSharp.Testing.JavaAssertions.Equal(tempDir,
          global::DripSharp.Runtime.JavaCompat.PathParent(tempFile),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("io",
          "File should be in specified directory"));
        global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.StringStartsWith(global::System.IO.Path.GetFileName(tempFile).ToString()!,
          global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "myfile")),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("io",
  ...
  internal virtual void testCreateProtectedTempFilePermissions() {
    global::DripSharp.Runtime.JavaPath tempFile
      = global::DripSharp.PdfCarton.IO.IOUtils.CreateProtectedTempFile((global::DripSharp.Runtime.JavaPath)default!,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "perm"),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", ".test"));
    try {
      if (global::DripSharp.PdfCarton.Tests.Support.SupportsFileAttributeView(global::DripSharp.PdfCarton.Tests.Support.FileStore(tempFile),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "posix"))) {
        global::System.Collections.Generic.ISet<global::DripSharp.Runtime.JavaUnixFileMode> perms
          = global::DripSharp.PdfCarton.Tests.Support.GetPosixFilePermissions(tempFile);
        global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.CollectionContains(perms,
          global::DripSharp.Runtime.JavaUnixFileMode.UserRead), null);
        global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.CollectionContains(perms,
          global::DripSharp.Runtime.JavaUnixFileMode.UserWrite), null);
  ...
  internal virtual void testCreateProtectedTempFileMultiple() {
    global::DripSharp.Runtime.JavaPath tempFile1
      = global::DripSharp.PdfCarton.IO.IOUtils.CreateProtectedTempFile((global::DripSharp.Runtime.JavaPath)default!,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "test1"),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", ".tmp"));
    global::DripSharp.Runtime.JavaPath tempFile2
      = global::DripSharp.PdfCarton.IO.IOUtils.CreateProtectedTempFile((global::DripSharp.Runtime.JavaPath)default!,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "test1"),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", ".tmp"));
    try {
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.Exists(tempFile1),
        null);
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.Exists(tempFile2),
        null);
  ...
  internal virtual void testCreateProtectedTempFileNullSuffix() {
    global::DripSharp.Runtime.JavaPath tempFile
      = global::DripSharp.PdfCarton.IO.IOUtils.CreateProtectedTempFile((global::DripSharp.Runtime.JavaPath)default!,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "test"), (string)default!);
    try {
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.Exists(tempFile),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "Temporary file should exist"));
      global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.PathIsRegularFile(tempFile),
  ...
  internal virtual void testCreateProtectedTempFileWriteable() {
    global::DripSharp.Runtime.JavaPath tempFile
      = global::DripSharp.PdfCarton.IO.IOUtils.CreateProtectedTempFile((global::DripSharp.Runtime.JavaPath)default!,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", "writable"),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("io", ".dat"));
    try {
      sbyte[] testData = global::DripSharp.Runtime.JavaCompat.StringGetBytes("Test content",
        global::System.Text.Encoding.UTF8);
      ...
      global::DripSharp.Testing.JavaAssertions.Equal("Test content",
        global::DripSharp.Runtime.JavaCompat.NewString(readData, global::System.Text.Encoding.UTF8),
        null);
    } finally {
      if (global::DripSharp.Runtime.JavaCompat.Exists(tempFile)) {
        global::DripSharp.Runtime.JavaCompat.DeleteIfExists(tempFile);
