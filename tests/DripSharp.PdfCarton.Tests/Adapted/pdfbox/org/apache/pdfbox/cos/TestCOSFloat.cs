...
public class TestCOSFloat : global::DripSharp.PdfCarton.Cos.TestCOSNumber {
  ...
  private sealed class Anonymous_107_9 : global::DripSharp.PdfCarton.Cos.TestCOSFloat.BaseTester {
    ...
    internal override void runTest(float num) {
      global::DripSharp.PdfCarton.Cos.COSFloat test1
        = new global::DripSharp.PdfCarton.Cos.COSFloat(num);
      global::DripSharp.PdfCarton.Cos.COSFloat test2
        = new global::DripSharp.PdfCarton.Cos.COSFloat(num);
  ...
  internal class FloatValueTester : global::DripSharp.PdfCarton.Cos.TestCOSFloat.BaseTester {
    ...
    internal FloatValueTester(global::DripSharp.PdfCarton.Cos.TestCOSFloat __outer)
    : base(__outer) {
      this.__outer = __outer;
    }
  }
  ...
  internal class AcceptTester : global::DripSharp.PdfCarton.Cos.TestCOSFloat.BaseTester {
    ...
    internal override void runTest(float num) {
      try {
        ...
        global::DripSharp.Testing.JavaAssertions.Equal(this.__outer.floatToString(cosFloat.FloatValue()),
          global::DripSharp.Runtime.JavaCompat.MemoryStreamToString(this.outStream,
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "ISO-8859-1")), null);
        this.__outer.TestByteArrays(global::DripSharp.Runtime.JavaCompat.StringGetBytes(this.__outer.floatToString(num),
          global::DripSharp.Runtime.JavaStandardCharsets.ISO88591),
          global::DripSharp.Runtime.JavaCompat.ToSignedBytes(this.outStream));
    ...
    internal override void runTest(float num) {
      try {
        ...
        global::DripSharp.Testing.JavaAssertions.Equal(expected,
          global::DripSharp.Runtime.JavaCompat.MemoryStreamToString(this.outStream,
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "ISO-8859-1")), null);
        global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("COSFloat{",
          expected), "}"), cosFloat.ToString(), null);
        ...
        global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("COSFloat{",
          expected), "}"), cosFloat.ToString(), null);
        this.__outer.TestByteArrays(global::DripSharp.Runtime.JavaCompat.StringGetBytes(expected,
          global::DripSharp.Runtime.JavaStandardCharsets.ISO88591),
          global::DripSharp.Runtime.JavaCompat.ToSignedBytes(this.outStream));
        global::DripSharp.Runtime.JavaCompat.ResetMemoryStream(this.outStream);
      } catch (global::System.IO.IOException e) {
  ...
  internal virtual void testWritePDF() {
    global::DripSharp.PdfCarton.Cos.TestCOSFloat.WritePDFTester writePDFTester
      = new global::DripSharp.PdfCarton.Cos.TestCOSFloat.WritePDFTester(this);
  ...
  internal virtual void testVerySmallValues() {
    ...
    asString
      = global::DripSharp.Runtime.JavaCompat.JavaBigDecimalToPlainString(global::DripSharp.Runtime.JavaCompat.JavaBigDecimalParse(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      asString)));
    cosFloat
      = new global::DripSharp.PdfCarton.Cos.COSFloat(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      asString));
  ...
  internal virtual void testVeryLargeValues() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(1,
      global::DripSharp.Runtime.JavaCompat.CompareDouble(largeValue, (double)(float.MaxValue)),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
  ...
  internal virtual void testMisplacedNegative() {
    global::DripSharp.PdfCarton.Cos.COSFloat cosFloat
      = new global::DripSharp.PdfCarton.Cos.COSFloat(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "0.00000-33917698"));
    global::DripSharp.Testing.JavaAssertions.Equal(new global::DripSharp.PdfCarton.Cos.COSFloat(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "-0.0000033917698")), cosFloat, null);
    cosFloat
      = new global::DripSharp.PdfCarton.Cos.COSFloat(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "0.-262"));
    global::DripSharp.Testing.JavaAssertions.Equal(new global::DripSharp.PdfCarton.Cos.COSFloat(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
  ...
  internal virtual void testStubOperatorMinMaxValues() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(largeValue,
      new global::DripSharp.PdfCarton.Cos.COSFloat(largeValue).FloatValue(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(largeNegativeValue,
      new global::DripSharp.PdfCarton.Cos.COSFloat(largeNegativeValue).FloatValue(), null);
  }

  private string floatToString(float value) {
    return this.removeTrailingNull(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.JavaBigDecimalToPlainString(global::DripSharp.Runtime.JavaCompat.JavaBigDecimalParse(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.StringValueOf(value))))));
  }
