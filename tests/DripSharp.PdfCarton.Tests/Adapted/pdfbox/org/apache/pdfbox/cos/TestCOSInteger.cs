...
global::DripSharp.PdfCarton.Cos.TestCOSBase.__field_TestCOSBase = global::DripSharp.PdfCarton.Cos.COSNumber.Get(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "0"));
}

internal virtual void testEquals() {
for (int i = -1000; (i < 3000); i += 200) {
global::DripSharp.PdfCarton.Cos.COSInteger test1 = global::DripSharp.PdfCarton.Cos.COSInteger.Get((long)(i));
global::DripSharp.PdfCarton.Cos.COSInteger test2 = global::DripSharp.PdfCarton.Cos.COSInteger.Get((long)(i));
global::DripSharp.PdfCarton.Cos.COSInteger test3 = global::DripSharp.PdfCarton.Cos.COSInteger.Get((long)(i));
...
global::DripSharp.PdfCarton.Cos.COSInteger test4 = global::DripSharp.PdfCarton.Cos.COSInteger.Get((long)((i + 1)));
...
global::DripSharp.PdfCarton.Cos.COSInteger test3 = global::DripSharp.PdfCarton.Cos.COSInteger.Get((long)((i + 1)));
...
for (int i = -1000; (i < 3000); i += 200) {
global::DripSharp.Testing.JavaAssertions.Equal((float)((float)(i)), global::DripSharp.PdfCarton.Cos.COSInteger.Get((long)(i)).FloatValue(), null);
}
}

internal override void testIntValue() {
for (int i = -1000; (i < 3000); i += 200) {
global::DripSharp.Testing.JavaAssertions.Equal(i, global::DripSharp.PdfCarton.Cos.COSInteger.Get((long)(i)).IntValue(), null);
}
}

internal override void testLongValue() {
for (int i = -1000; (i < 3000); i += 200) {
global::DripSharp.Testing.JavaAssertions.Equal((long)((long)(i)), global::DripSharp.PdfCarton.Cos.COSInteger.Get((long)(i)).LongValue(), null);
}
}
...
global::DripSharp.PdfCarton.Cos.COSInteger cosInt = global::DripSharp.PdfCarton.Cos.COSInteger.Get((long)(index));
cosInt.Accept(visitor);
this.TestByteArrays(global::DripSharp.Runtime.JavaCompat.StringGetBytes(global::DripSharp.Runtime.JavaCompat.StringValueOf(index), global::DripSharp.Runtime.JavaStandardCharsets.ISO88591), global::DripSharp.Runtime.JavaCompat.ToSignedBytes(outStream));
global::DripSharp.Runtime.JavaCompat.ResetMemoryStream(outStream);
}, global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", global::DripSharp.Runtime.JavaCompat.Concat("Failed to write ", index)));
}
}
