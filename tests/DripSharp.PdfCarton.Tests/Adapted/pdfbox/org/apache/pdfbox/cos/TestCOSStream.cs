...
public class TestCOSStream {
  internal virtual void testUncompressedStreamEncode() {
    ...
    global::DripSharp.PdfCarton.Cos.COSStream stream = this.createStream(testString,
  ...
  internal virtual void testCompressedStream2Encode() {
    ...
    sbyte[] testStringEncoded = this.encodeData(testString,
      global::DripSharp.PdfCarton.Cos.COSName.FlateDecode);
    testStringEncoded = this.encodeData(testStringEncoded,
      global::DripSharp.PdfCarton.Cos.COSName.Ascii85Decode);
    global::DripSharp.PdfCarton.Cos.COSArray filters
  ...
  private sbyte[] encodeData(sbyte[] original, global::DripSharp.PdfCarton.Cos.COSName filter) {
    global::DripSharp.PdfCarton.Filter.Filter encodingFilter
      = global::DripSharp.PdfCarton.Filter.FilterFactory.Instance.GetFilter(filter);
    global::DripSharp.Runtime.JavaByteArrayOutputStream encoded
      = new global::DripSharp.Runtime.JavaByteArrayOutputStream();
    encodingFilter.Encode(global::DripSharp.Runtime.JavaCompat.NewMemoryStream(original), encoded,
      new global::DripSharp.PdfCarton.Cos.COSDictionary(), 0);
  ...
  private void validateEncoded(global::DripSharp.PdfCarton.Cos.COSStream stream, sbyte[] expected) {
    sbyte[] decoded
      = global::DripSharp.PdfCarton.IO.IOUtils.ToByteArray(stream.CreateRawInputStream());
    stream.Dispose();
    global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.ArrayEquals(expected,
      decoded), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "Encoded data doesn't match input"));
  }

  private void validateDecoded(global::DripSharp.PdfCarton.Cos.COSStream stream, sbyte[] expected) {
    sbyte[] encoded
      = global::DripSharp.PdfCarton.IO.IOUtils.ToByteArray(stream.CreateInputStream());
    stream.Dispose();
    global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.ArrayEquals(expected,
      encoded), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "Decoded data doesn't match input"));
  }
