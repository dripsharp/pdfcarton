...
public class TestCOSString : global::DripSharp.PdfCarton.Cos.TestCOSBase {
  ...
  private const string ESC_CHAR_STRING_PDF_FORMAT
  ...
  internal virtual void testSetForceHexLiteralForm() {
    ...
    string pdfHex
      ...
      this.createHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", inputString))),
      ">");
    global::DripSharp.PdfCarton.Cos.COSString cosStr
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      inputString));
    cosStr.SetForceHexForm(true);
    this.writePDFTests(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", pdfHex),
      cosStr);
    global::DripSharp.PdfCarton.Cos.COSString escStr
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING));
    this.writePDFTests(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("(",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING_PDF_FORMAT), ")")), escStr);
    escStr.SetForceHexForm(true);
    this.writePDFTests(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("<",
      this.createHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING))), ">")), escStr);
  }
  ...
  private void writePDFTests(string expected, global::DripSharp.PdfCarton.Cos.COSString testSubj) {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(expected,
      global::DripSharp.PdfCarton.Tests.Support.OutputText(outStream), null);
  }

  internal virtual void testFromHex() {
    string expected = "Quick and simple test";
    string hexForm = this.createHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      expected));
    global::DripSharp.PdfCarton.Cos.COSString test1
      = global::DripSharp.PdfCarton.Cos.COSString.ParseHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      hexForm));
    this.writePDFTests(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("(",
      expected), ")")), test1);
    global::DripSharp.PdfCarton.Cos.COSString test2
      = global::DripSharp.PdfCarton.Cos.COSString.ParseHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      this.createHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING))));
    this.writePDFTests(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("(",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING_PDF_FORMAT), ")")), test2);
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.IO.IOException>(()
      => global::DripSharp.PdfCarton.Cos.COSString.ParseHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat(hexForm, "xx"))),
  ...
  private string createHex(string str) {
    ...
    foreach (char c in str.ToCharArray()) {
      sb.Append(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        global::DripSharp.Runtime.JavaCompat.ToStringRadix((int)(c), 16)));
    }
  ...
  internal virtual void testGetHex() {
    ...
    global::DripSharp.PdfCarton.Cos.COSString escCS
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING));
    global::DripSharp.Testing.JavaAssertions.Equal(this.createHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING)), escCS.ToHexString(), null);
  }
  ...
  internal virtual void testGetString() {
    ...
    global::DripSharp.PdfCarton.Cos.COSString hexStr
      = global::DripSharp.PdfCarton.Cos.COSString.ParseHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      this.createHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", testStr))));
    global::DripSharp.Testing.JavaAssertions.Equal(testStr, hexStr.GetString(), null);
    global::DripSharp.PdfCarton.Cos.COSString escapedString
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING));
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING,
      escapedString.GetString(), null);
    testStr = "Line1\nLine2\nLine3\n";
    global::DripSharp.PdfCarton.Cos.COSString lineFeedString
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      testStr));
  ...
  internal virtual void testGetBytes() {
    global::DripSharp.PdfCarton.Cos.COSString str
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING));
    this.TestByteArrays(global::DripSharp.Runtime.JavaCompat.StringGetBytes(global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING,
      global::System.Text.Encoding.UTF8), str.GetBytes());
  }

  internal virtual void testWritePDF() {
    global::DripSharp.PdfCarton.Cos.COSString testSubj
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING));
    this.writePDFTests(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("(",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING_PDF_FORMAT), ")")), testSubj);
    string textString = "This is just an arbitrary piece of text for testing";
    global::DripSharp.PdfCarton.Cos.COSString testSubj2
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      textString));
    this.writePDFTests(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("(",
      textString), ")")), testSubj2);
  }
  ...
  internal virtual void testUnicode() {
    ...
    global::DripSharp.PdfCarton.Cos.COSString stringAscii
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      textAscii));
    global::DripSharp.Testing.JavaAssertions.Equal(stringAscii.GetString(), textAscii, null);
    global::DripSharp.PdfCarton.Cos.COSString string8Bit
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      text8Bit));
    global::DripSharp.Testing.JavaAssertions.Equal(string8Bit.GetString(), text8Bit, null);
    global::DripSharp.PdfCarton.Cos.COSString stringHighBits
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      textHighBits));
    global::DripSharp.Testing.JavaAssertions.Equal(stringHighBits.GetString(), textHighBits, null);
    global::DripSharp.Testing.JavaAssertions.Equal(textAscii,
      global::DripSharp.Runtime.JavaCompat.NewString(stringAscii.GetBytes(),
      global::DripSharp.Runtime.JavaStandardCharsets.ISO88591), null);
    global::DripSharp.Testing.JavaAssertions.Equal(text8Bit,
      global::DripSharp.Runtime.JavaCompat.NewString(string8Bit.GetBytes(),
      global::DripSharp.Runtime.JavaStandardCharsets.ISO88591), null);
    global::DripSharp.Testing.JavaAssertions.Equal(textHighBits,
      global::DripSharp.Runtime.JavaCompat.NewString(stringHighBits.GetBytes(),
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("(",
      textAscii), ")"),
      global::DripSharp.Runtime.JavaCompat.NewString(global::DripSharp.Runtime.JavaCompat.ToSignedBytes(@out),
      global::DripSharp.PdfCarton.Tests.Support.EncodingByName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "ASCII"))), null);
    ...
    foreach (char c__229_18 in text8Bit.ToCharArray()) {
      hex.Append(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        global::DripSharp.Runtime.JavaCompat.ToHexString((int)(c__229_18)).ToUpper()));
    }
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("<",
      hex.ToString()), ">"),
      global::DripSharp.Runtime.JavaCompat.NewString(global::DripSharp.Runtime.JavaCompat.ToSignedBytes(@out),
    ...
    foreach (char c__239_18 in textHighBits.ToCharArray()) {
      hex.Append(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        global::DripSharp.Runtime.JavaCompat.ToHexString((int)(c__239_18)).ToUpper()));
    }
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("<",
      hex.ToString()), ">"),
      global::DripSharp.Runtime.JavaCompat.NewString(global::DripSharp.Runtime.JavaCompat.ToSignedBytes(@out),
  ...
  internal override void testAccept() {
    global::DripSharp.Runtime.JavaByteArrayOutputStream outStream
      = new global::DripSharp.Runtime.JavaByteArrayOutputStream();
    global::DripSharp.PdfCarton.Cos.ICOSVisitor visitor
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("(",
      global::DripSharp.PdfCarton.Cos.TestCOSString.ESC_CHAR_STRING_PDF_FORMAT), ")"),
      global::DripSharp.PdfCarton.Tests.Support.OutputText(outStream), null);
  ...
  internal virtual void testEquals() {
    for (int i = 0; (i < 10); i++) {
      ...
      global::DripSharp.PdfCarton.Cos.COSString z1
        = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        "Test"));
      global::DripSharp.Testing.JavaAssertions.Equal(x1, y1, null);
  ...
  internal virtual void testHashCode() {
    global::DripSharp.PdfCarton.Cos.COSString str1
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "Test1"));
    global::DripSharp.PdfCarton.Cos.COSString str2
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "Test2"));
    global::DripSharp.Testing.JavaAssertions.NotEqual(str1.GetHashCode(), str2.GetHashCode(), null);
    global::DripSharp.PdfCarton.Cos.COSString str3
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "Test1"));
  ...
  internal virtual void testCompareFromHexString() {
    ...
    global::DripSharp.Testing.JavaAssertions.NotEqual(test1.ToHexString(), test2.ToHexString(),
      null);
    global::DripSharp.Testing.JavaAssertions.False(global::DripSharp.Runtime.JavaCompat.ArrayEquals(test1.GetBytes(),
      test2.GetBytes()), null);
  ...
  internal virtual void testEmptyStringWithBOM() {
    global::DripSharp.Testing.JavaAssertions.True((global::DripSharp.PdfCarton.Cos.COSString.ParseHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "FEFF")).GetString().Length == 0), null);
    global::DripSharp.Testing.JavaAssertions.True((global::DripSharp.PdfCarton.Cos.COSString.ParseHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "FFFE")).GetString().Length == 0), null);
  }
