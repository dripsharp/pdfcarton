...
public class TestPublicKeyEncryption {
  ...
  internal virtual void setUp() {
    ...
    this.recipient1
      = global::DripSharp.PdfCarton.Encryption.TestPublicKeyEncryption.getRecipient(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "test1.der"), this.permission1);
    this.recipient2
      = global::DripSharp.PdfCarton.Encryption.TestPublicKeyEncryption.getRecipient(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "test2.der"), this.permission2);
  ...
  internal virtual void testProtectionError(int keyLength) {
    global::DripSharp.PdfCarton.Pdmodel.Encryption.PublicKeyProtectionPolicy policy
      = new global::DripSharp.PdfCarton.Pdmodel.Encryption.PublicKeyProtectionPolicy();
    ...
    global::System.IO.IOException ex
      ...
      => this.reload(file, global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      this.password2), this.getKeyStore(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      this.keyStore2))), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "No exception when using an incorrect decryption key"));
    string msg = global::DripSharp.Runtime.JavaCompat.ExceptionMessage(ex);
    global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.StringContains(msg,
      "serial-#: rid 2 vs. cert 3"), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat("not the expected exception: ", msg)));
  }
  ...
  private global::DripSharp.PdfCarton.Pdmodel.PDDocument reload(global::System.IO.FileInfo file,
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(this.producer,
      doc2.GetDocumentInformation().GetProducer(),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "Producer is different"));
    return doc2;
  }
  ...
  private global::System.IO.Stream getKeyStore(string name) {
    return global::DripSharp.PdfCarton.Tests.Support.ResourceStream(typeof(global::DripSharp.PdfCarton.Encryption.TestPublicKeyEncryption),
