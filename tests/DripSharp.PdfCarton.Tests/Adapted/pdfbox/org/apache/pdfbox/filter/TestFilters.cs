...
public class TestFilters {
    ...
    for (int iter = 0; (iter < (COUNT * 2)); iter++) {
      ...
      try {
        ...
        foreach (global::DripSharp.PdfCarton.Filter.Filter filter in global::DripSharp.PdfCarton.Filter.FilterFactory.Instance.getAllFilters()) {
          if (((((filter is global::DripSharp.PdfCarton.Filter.DCTFilter)
            || (filter is global::DripSharp.PdfCarton.Filter.CCITTFaxFilter))
            || (filter is global::DripSharp.PdfCarton.Filter.JPXFilter))
            || (filter is global::DripSharp.PdfCarton.Filter.JBIG2Filter))) {
            continue;
          }
        ...
        if (!success) {
          global::DripSharp.PdfCarton.Tests.Support.ErrorStream.WriteLine(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
            global::DripSharp.Runtime.JavaCompat.Concat("NOTE: test failed with seed=", seed)));
        }
      }
    }
  }
  ...
  internal virtual void testRLE() {
    global::DripSharp.PdfCarton.Filter.Filter rleFilter
      = global::DripSharp.PdfCarton.Filter.FilterFactory.Instance.GetFilter(global::DripSharp.PdfCarton.Cos.COSName.RunLengthDecode);
    sbyte[] input0 = new sbyte[0];
    this.checkEncodeDecode(rleFilter, input0);
    sbyte[] input1 = new sbyte[] { unchecked((sbyte)(1)), unchecked((sbyte)(2)),
      unchecked((sbyte)(3)), unchecked((sbyte)(4)), unchecked((sbyte)(5)), unchecked((sbyte)(128)),
      unchecked((sbyte)(140)), unchecked((sbyte)(180)), unchecked((sbyte)(255)) };
  ...
  internal virtual void testEmptyFilterList() {
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.ArgumentException>(() => {
        global::DripSharp.PdfCarton.Filter.Filter.Decode((global::System.IO.Stream)default!,
        ...
        (global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Filter.DecodeResult>)default!);
      }, null);
  }

  private void checkEncodeDecode(global::DripSharp.PdfCarton.Filter.Filter filter,
    sbyte[] original) {
    global::DripSharp.Runtime.JavaByteArrayOutputStream encoded
      = new global::DripSharp.Runtime.JavaByteArrayOutputStream();
    filter.Encode(global::DripSharp.Runtime.JavaCompat.NewMemoryStream(original), encoded,
      new global::DripSharp.PdfCarton.Cos.COSDictionary());
    global::DripSharp.Runtime.JavaByteArrayOutputStream decoded
      = new global::DripSharp.Runtime.JavaByteArrayOutputStream();
    filter.Decode(global::DripSharp.Runtime.JavaCompat.NewMemoryStream(global::DripSharp.Runtime.JavaCompat.ToSignedBytes(encoded)),
      decoded, new global::DripSharp.PdfCarton.Cos.COSDictionary(), 0);
    global::DripSharp.Testing.JavaAssertions.Equal(original,
      global::DripSharp.Runtime.JavaCompat.ToSignedBytes(decoded),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("Data that is encoded and then decoded through ",
      ((object)(filter)).GetType()), " does not match the original data")));
  }
