...
public class MergeAnnotationsTest {
  ...
  private bool testAnnotationsMatch(global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotation> sourceAnnots,
    global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotation> targetAnnots) {
    global::System.Collections.Generic.IDictionary<string,
      global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotation> targetAnnotsByName
    ...
    foreach (global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotation targetAnnot in targetAnnots) {
      destinationName
        = (global::DripSharp.PdfCarton.Cos.COSName)(targetAnnot.GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.Dest)!);
      global::DripSharp.Runtime.JavaCompat.MapPut(targetAnnotsByName, destinationName.GetName(),
        targetAnnot);
    }
    foreach (global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotation sourceAnnot in sourceAnnots) {
      destinationName
        = (global::DripSharp.PdfCarton.Cos.COSName)(sourceAnnot.GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.Dest)!);
      if ((global::DripSharp.Runtime.JavaCompat.MapGet(targetAnnotsByName,
        global::DripSharp.Runtime.JavaCompat.Concat("annoRef_", destinationName.GetName()))
        == default!)) {
        return false;
      }
    }
