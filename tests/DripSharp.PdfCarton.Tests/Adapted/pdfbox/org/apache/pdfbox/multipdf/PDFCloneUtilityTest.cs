...
public class PDFCloneUtilityTest {
  internal virtual void testClonePDFWithCosArrayStream() {
    using (global::DripSharp.PdfCarton.Pdmodel.PDDocument srcDoc
      = new global::DripSharp.PdfCarton.Pdmodel.PDDocument()) using (global::DripSharp.PdfCarton.Pdmodel.PDDocument dstDoc
      ...
      new global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream(srcDoc, pdPage,
        global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream.AppendMode.Append, true).Dispose();
      new global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream(srcDoc, pdPage,
        global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream.AppendMode.Append, true).Dispose();
  ...
  internal virtual void testClonePDFWithCosArrayStream2() {
    ...
    using (global::DripSharp.PdfCarton.Pdmodel.PDDocument srcDoc
      ...
      global::DripSharp.PdfCarton.Pdmodel.PDPage pdPage
        = new global::DripSharp.PdfCarton.Pdmodel.PDPage();
      srcDoc.AddPage(pdPage);
      using (global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream pdPageContentStream1
        = new global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream(srcDoc, pdPage,
      ...
      using (global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream pdPageContentStream2
        = new global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream(srcDoc, pdPage,
        global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream.AppendMode.Append, false)) {
      ...
      using (global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream pdPageContentStream3
        = new global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream(srcDoc, pdPage,
        global::DripSharp.PdfCarton.Pdmodel.PDPageContentStream.AppendMode.Append, false)) {
