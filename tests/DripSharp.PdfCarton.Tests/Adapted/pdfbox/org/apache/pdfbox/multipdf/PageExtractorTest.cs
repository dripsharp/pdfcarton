...
try {
sourcePdf = global::DripSharp.PdfCarton.Loader.LoadPDF(global::DripSharp.PdfCarton.Tests.Support.TestFile(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "src/test/resources/input/cweb.pdf")));
global::DripSharp.PdfCarton.Multipdf.PageExtractor instance = new global::DripSharp.PdfCarton.Multipdf.PageExtractor(sourcePdf!);
result = instance.Extract();
global::DripSharp.Testing.JavaAssertions.Equal(sourcePdf!.GetNumberOfPages(), result!.GetNumberOfPages(), null);
