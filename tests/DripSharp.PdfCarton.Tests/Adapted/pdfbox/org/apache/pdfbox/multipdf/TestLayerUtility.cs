...
global::System.IO.FileInfo targetFile = new global::System.IO.FileInfo(global::System.IO.Path.Combine((global::DripSharp.PdfCarton.Multipdf.TestLayerUtility.TESTRESULTSDIR).FullName, global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "text-with-form-overlay.pdf")));
using (global::DripSharp.PdfCarton.Pdmodel.PDDocument targetDoc = global::DripSharp.PdfCarton.Loader.LoadPDF(mainPDF)) using (global::DripSharp.PdfCarton.Pdmodel.PDDocument overlay1Doc = global::DripSharp.PdfCarton.Loader.LoadPDF(overlay1)) {
global::DripSharp.Testing.JavaAssertions.Equal(1.4F, targetDoc.GetVersion(), null);
global::DripSharp.PdfCarton.Multipdf.LayerUtility layerUtil = new global::DripSharp.PdfCarton.Multipdf.LayerUtility(targetDoc);
global::DripSharp.PdfCarton.Pdmodel.Graphics.Form.PDFormXObject form = layerUtil.ImportPageAsForm(overlay1Doc, 0);
...
layerUtil.AppendFormAsLayer(targetPage, form, at, global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "overlay"));
global::DripSharp.Testing.JavaAssertions.Equal(1.5F, targetDoc.GetVersion(), null);
targetDoc.Save(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", targetFile.FullName), global::DripSharp.PdfCarton.Pdfwriter.Compress.CompressParameters.NoCompression);
global::DripSharp.Testing.JavaAssertions.Equal(1.5F, targetDoc.GetVersion(), null);
}
using (global::DripSharp.PdfCarton.Pdmodel.PDDocument doc = global::DripSharp.PdfCarton.Loader.LoadPDF(targetFile)) {
...
global::DripSharp.PdfCarton.Pdmodel.Graphics.Optionalcontent.PDOptionalContentGroup ocg = (global::DripSharp.PdfCarton.Pdmodel.Graphics.Optionalcontent.PDOptionalContentGroup)(page.GetResources().GetProperties(global::DripSharp.PdfCarton.Cos.COSName.GetPDFName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "oc1")))!);
...
global::DripSharp.PdfCarton.Pdmodel.Graphics.Optionalcontent.PDOptionalContentGroup overlay = ocgs.GetGroup(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "overlay"));
...
global::System.IO.FileInfo targetFile = new global::System.IO.FileInfo(global::System.IO.Path.Combine((global::DripSharp.PdfCarton.Multipdf.TestLayerUtility.TESTRESULTSDIR).FullName, global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "text-doc.pdf")));
...
contentStream.ShowText(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "Simple test document with text."));
...
contentStream.ShowText(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", line));
}
contentStream.EndText();
}
doc.Save(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", targetFile.FullName), global::DripSharp.PdfCarton.Pdfwriter.Compress.CompressParameters.NoCompression);
}
return targetFile;
}

private global::System.IO.FileInfo createOverlay1() {
global::System.IO.FileInfo targetFile = new global::System.IO.FileInfo(global::System.IO.Path.Combine((global::DripSharp.PdfCarton.Multipdf.TestLayerUtility.TESTRESULTSDIR).FullName, global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "overlay1.pdf")));
using (global::DripSharp.PdfCarton.Pdmodel.PDDocument doc = new global::DripSharp.PdfCarton.Pdmodel.PDDocument()) {
global::DripSharp.PdfCarton.Pdmodel.PDPage page = new global::DripSharp.PdfCarton.Pdmodel.PDPage();
doc.AddPage(page);
global::DripSharp.PdfCarton.Pdmodel.PDResources resources = page.GetResources();
...
global::DripSharp.PdfCarton.Util.Matrix transform = new global::DripSharp.PdfCarton.Util.Matrix();
