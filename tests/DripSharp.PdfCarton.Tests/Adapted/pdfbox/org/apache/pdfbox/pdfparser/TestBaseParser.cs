...
public class TestBaseParser {
  internal virtual void testCheckForEndOfString() {
    sbyte[] inputBytes = new sbyte[] { unchecked((sbyte)(40)), unchecked((sbyte)(84)),
      unchecked((sbyte)(101)), unchecked((sbyte)(115)), unchecked((sbyte)(116)),
      unchecked((sbyte)(41)) };
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.BaseParser baseParser
      = new global::DripSharp.PdfCarton.Pdfparser.COSParser(buffer);
    ...
    string output = "(Test";
    inputBytes = new sbyte[] { unchecked((sbyte)('(')), unchecked((sbyte)('(')),
      unchecked((sbyte)('T')), unchecked((sbyte)('e')), unchecked((sbyte)('s')),
      unchecked((sbyte)('t')), unchecked((sbyte)(')')), unchecked((sbyte)(10)),
      unchecked((sbyte)('/')), unchecked((sbyte)(' ')) };
    ...
    inputBytes = new sbyte[] { unchecked((sbyte)('(')), unchecked((sbyte)('(')),
      unchecked((sbyte)('T')), unchecked((sbyte)('e')), unchecked((sbyte)('s')),
      unchecked((sbyte)('t')), unchecked((sbyte)(')')), unchecked((sbyte)(13)),
      unchecked((sbyte)('/')), unchecked((sbyte)(' ')) };
    buffer = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    baseParser = new global::DripSharp.PdfCarton.Pdfparser.COSParser(buffer);
    cosString = baseParser.ParseCOSString();
    ...
    inputBytes = new sbyte[] { unchecked((sbyte)('(')), unchecked((sbyte)('(')),
      unchecked((sbyte)('T')), unchecked((sbyte)('e')), unchecked((sbyte)('s')),
      unchecked((sbyte)('t')), unchecked((sbyte)(')')), unchecked((sbyte)(13)),
      unchecked((sbyte)(10)), unchecked((sbyte)('/')) };
    buffer = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    baseParser = new global::DripSharp.PdfCarton.Pdfparser.COSParser(buffer);
    cosString = baseParser.ParseCOSString();
    global::DripSharp.Testing.JavaAssertions.Equal(output, cosString.GetString(), null);
  ...
  internal virtual void testBaseParserStackOverflow() {
    try {
      ...
      global::DripSharp.Testing.JavaAssertions.Equal("Missing root object specification in trailer.",
        global::DripSharp.Runtime.JavaCompat.ExceptionMessage(exception), null);
    }
  }

  internal virtual void testTable4Example_Name1() {
    sbyte[] inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/Name1 ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
      = new global::DripSharp.PdfCarton.Pdfparser.COSParser(buffer);
  ...
  internal virtual void testTable4Example_ASomewhatLongerName() {
    sbyte[] inputBytes
      = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/ASomewhatLongerName ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testTable4Example_WithSpecialCharacters() {
    sbyte[] inputBytes
      = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/A;Name_With-Various***Characters? ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
      = new global::DripSharp.PdfCarton.Pdfparser.COSParser(buffer);
    global::DripSharp.PdfCarton.Cos.COSName name = cosParser.ParseCOSName();
    global::DripSharp.Testing.JavaAssertions.Equal("A;Name_With-Various***Characters?",
      name.GetName(), null);
  }

  internal virtual void testTable4Example_Numeric() {
    sbyte[] inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/1.2 ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testTable4Example_DollarSigns() {
    sbyte[] inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/$$ ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testTable4Example_AtPattern() {
    sbyte[] inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/@pattern ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testTable4Example_DotNotdef() {
    sbyte[] inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/#2Enotdef ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testTable4Example_HexEncodedSpace() {
    sbyte[] inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/lime#20Green ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testTable4Example_HexEncodedParentheses() {
    sbyte[] inputBytes
      = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/paired#28#29parentheses ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testTable4Example_HexEncodedNumberSign() {
    sbyte[] inputBytes
      = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/The_Key_of_F#23_Minor ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testTable4Example_HexEncodedLetter() {
    sbyte[] inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/A#42 ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testNullCharacterTermination() {
    sbyte[] inputBytes = new sbyte[] { unchecked((sbyte)('/')), unchecked((sbyte)('N')),
      unchecked((sbyte)('a')), unchecked((sbyte)('m')), unchecked((sbyte)('e')),
      unchecked((sbyte)(0)), unchecked((sbyte)('E')), unchecked((sbyte)('x')),
      unchecked((sbyte)('t')), unchecked((sbyte)('r')), unchecked((sbyte)('a')),
      unchecked((sbyte)(' ')) };
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testInvalidHexSequence() {
    sbyte[] inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/Name#GG ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testHexEscapeLowercase() {
    sbyte[] inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/Name#2fTest ",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testNameTerminationByDelimiters() {
    ...
    global::DripSharp.PdfCarton.Cos.COSName name = cosParser.ParseCOSName();
    global::DripSharp.Testing.JavaAssertions.Equal("Name1", name.GetName(), null);
    inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/Name2<",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    buffer = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    ...
    inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/Name3[",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    buffer = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    cosParser = new global::DripSharp.PdfCarton.Pdfparser.COSParser(buffer);
    name = cosParser.ParseCOSName();
    global::DripSharp.Testing.JavaAssertions.Equal("Name3", name.GetName(), null);
    inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/Name4]",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    buffer = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    cosParser = new global::DripSharp.PdfCarton.Pdfparser.COSParser(buffer);
    name = cosParser.ParseCOSName();
    global::DripSharp.Testing.JavaAssertions.Equal("Name4", name.GetName(), null);
    inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/Name5(",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    buffer = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    cosParser = new global::DripSharp.PdfCarton.Pdfparser.COSParser(buffer);
    name = cosParser.ParseCOSName();
    global::DripSharp.Testing.JavaAssertions.Equal("Name5", name.GetName(), null);
    inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/Name6)",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    buffer = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    cosParser = new global::DripSharp.PdfCarton.Pdfparser.COSParser(buffer);
    name = cosParser.ParseCOSName();
    global::DripSharp.Testing.JavaAssertions.Equal("Name6", name.GetName(), null);
    inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/Name7/",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    buffer = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    cosParser = new global::DripSharp.PdfCarton.Pdfparser.COSParser(buffer);
    name = cosParser.ParseCOSName();
    global::DripSharp.Testing.JavaAssertions.Equal("Name7", name.GetName(), null);
    inputBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/Name8%",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    buffer = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    cosParser = new global::DripSharp.PdfCarton.Pdfparser.COSParser(buffer);
    name = cosParser.ParseCOSName();
  ...
  internal virtual void testASCIIRegularCharacters() {
    sbyte[] inputBytes
      = global::DripSharp.Runtime.JavaCompat.StringGetBytes("/!\"$'*+-._:;=@~^`|\\",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer buffer
      = new global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer(inputBytes);
    global::DripSharp.PdfCarton.Pdfparser.COSParser cosParser
  ...
  internal virtual void testUTF8InNames() {
    ...
    sbyte[] nameBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes(nameStr,
      global::DripSharp.Runtime.JavaStandardCharsets.UTF8);
    global::DripSharp.PdfCarton.Cos.COSName name
      = global::DripSharp.PdfCarton.Cos.COSName.GetPDFName(nameBytes);
    sbyte[] retrievedBytes = name.GetBytes();
    string retrievedStr = global::DripSharp.Runtime.JavaCompat.NewString(retrievedBytes,
      global::DripSharp.Runtime.JavaStandardCharsets.UTF8);
    global::DripSharp.Testing.JavaAssertions.Equal(nameStr, retrievedStr, null);
  }

  internal virtual void testNameCanonicaliation() {
    sbyte[] bytes1 = global::DripSharp.Runtime.JavaCompat.StringGetBytes("TestName",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    sbyte[] bytes2 = global::DripSharp.Runtime.JavaCompat.StringGetBytes("TestName",
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.Cos.COSName name1
      = global::DripSharp.PdfCarton.Cos.COSName.GetPDFName(bytes1);
    global::DripSharp.PdfCarton.Cos.COSName name2
      = global::DripSharp.PdfCarton.Cos.COSName.GetPDFName(bytes2);
