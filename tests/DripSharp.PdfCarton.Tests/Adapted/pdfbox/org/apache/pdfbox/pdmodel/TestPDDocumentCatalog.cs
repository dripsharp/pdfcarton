...
using (global::DripSharp.PdfCarton.Pdmodel.PDDocument doc = global::DripSharp.PdfCarton.Loader.LoadPDF(global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer.CreateBufferFromStream(global::DripSharp.PdfCarton.Tests.Support.ResourceStream(typeof(global::DripSharp.PdfCarton.Pdmodel.TestPDDocumentCatalog), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "badpagelabels.pdf"))))) {
global::DripSharp.PdfCarton.Pdmodel.PDDocumentCatalog cat = doc.GetDocumentCatalog();
global::DripSharp.Testing.JavaAssertions.DoesNotThrow(() => cat.GetPageLabels().GetLabelsByPageIndices(), null);
}
}

internal virtual void retrieveNumberOfPages() {
using (global::DripSharp.PdfCarton.Pdmodel.PDDocument doc = global::DripSharp.PdfCarton.Loader.LoadPDF(global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer.CreateBufferFromStream(global::DripSharp.PdfCarton.Tests.Support.ResourceStream(typeof(global::DripSharp.PdfCarton.Pdmodel.TestPDDocumentCatalog), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "test.unc.pdf"))))) {
global::DripSharp.Testing.JavaAssertions.Equal(4, doc.GetNumberOfPages(), null);
}
}

internal virtual void handleOutputIntents() {
using (global::System.IO.Stream colorProfile = global::DripSharp.PdfCarton.Tests.Support.ResourceStream(typeof(global::DripSharp.PdfCarton.Pdmodel.TestPDDocumentCatalog), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "sRGB.icc"))) using (global::DripSharp.PdfCarton.Pdmodel.PDDocument doc = global::DripSharp.PdfCarton.Loader.LoadPDF(global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer.CreateBufferFromStream(global::DripSharp.PdfCarton.Tests.Support.ResourceStream(typeof(global::DripSharp.PdfCarton.Pdmodel.TestPDDocumentCatalog), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "test.unc.pdf"))))) {
global::DripSharp.PdfCarton.Pdmodel.PDDocumentCatalog catalog = doc.GetDocumentCatalog();
global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDOutputIntent> outputIntents = catalog.GetOutputIntents();
global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.ListIsEmpty(outputIntents), null);
global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDOutputIntent oi = new global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDOutputIntent(doc, colorProfile);
oi.SetInfo(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "sRGB IEC61966-2.1"));
oi.SetOutputCondition(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "sRGB IEC61966-2.1"));
oi.SetOutputConditionIdentifier(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "sRGB IEC61966-2.1"));
oi.SetRegistryName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "http://www.color.org"));
doc.GetDocumentCatalog().AddOutputIntent(oi);
outputIntents = catalog.GetOutputIntents();
global::DripSharp.Testing.JavaAssertions.Equal(1, global::DripSharp.Runtime.JavaCompat.CollectionCount(outputIntents), null);
...
doc.GetDocumentCatalog().GetCOSObject().SetBoolean(global::DripSharp.PdfCarton.Cos.COSName.OpenAction, false);
...
using (global::DripSharp.PdfCarton.Pdmodel.PDDocument doc = new global::DripSharp.PdfCarton.Pdmodel.PDDocument()) {
global::DripSharp.PdfCarton.Pdmodel.PDDocumentCatalog documentCatalog = doc.GetDocumentCatalog();
global::DripSharp.Testing.JavaAssertions.Equal(0, global::DripSharp.Runtime.JavaCompat.CollectionCount(documentCatalog.GetThreads()), null);
