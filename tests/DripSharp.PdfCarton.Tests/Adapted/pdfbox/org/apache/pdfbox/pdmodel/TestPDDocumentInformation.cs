...
public class TestPDDocumentInformation {
  internal virtual void testMetadataExtraction() { {
      ...
      global::System.Exception __dripsharpPrimary_44_25_0 = null!;
      try {
        global::DripSharp.PdfCarton.Pdmodel.PDDocumentInformation info
        ...
        global::DripSharp.Testing.JavaAssertions.Equal("Basis Technology Corp.",
          ...
          "Company")), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "Wrong company"));
      ...
      } catch (global::System.Exception __dripsharpCaught_44_25_0) {
        __dripsharpPrimary_44_25_0 = __dripsharpCaught_44_25_0;
        throw;
      } finally {
        global::DripSharp.Runtime.JavaCompat.CloseResource(doc, __dripsharpPrimary_44_25_0);
      }
    }
  }
  ...
  internal virtual void testPDFBox3068() { {
      ...
      try {
        global::DripSharp.PdfCarton.Pdmodel.PDDocumentInformation documentInformation
          = doc.GetDocumentInformation();
        global::DripSharp.Testing.JavaAssertions.Equal("Title", documentInformation.GetTitle(),
          null);
