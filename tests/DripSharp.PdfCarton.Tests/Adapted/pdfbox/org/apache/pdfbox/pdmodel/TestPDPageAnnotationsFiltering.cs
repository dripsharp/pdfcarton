...
public class TestPDPageAnnotationsFiltering {
  ...
  internal virtual void initMock() {
    global::DripSharp.PdfCarton.Cos.COSDictionary mockedPageWithAnnotations
      = new global::DripSharp.PdfCarton.Cos.COSDictionary();
    global::DripSharp.PdfCarton.Cos.COSArray annotsDictionary
    ...
    mockedPageWithAnnotations.SetItem(global::DripSharp.PdfCarton.Cos.COSName.Annots,
      annotsDictionary);
  ...
  internal virtual void validateNoFiltering() {
    ...
    global::DripSharp.Testing.JavaAssertions.True((global::DripSharp.Runtime.JavaCompat.ListGet(annotations,
      0) is global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationRubberStamp),
      null);
    global::DripSharp.Testing.JavaAssertions.True((global::DripSharp.Runtime.JavaCompat.ListGet(annotations,
      1) is global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationSquare), null);
    global::DripSharp.Testing.JavaAssertions.True((global::DripSharp.Runtime.JavaCompat.ListGet(annotations,
      2) is global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationLink), null);
  }

  internal virtual void validateAllFiltered() {
    global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotation> annotations
      = this.page.GetAnnotations(new global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.__AnnotationFilterFunctionalAdapter((annotation)
      => false));
  ...
  internal virtual void validateSelectedFew() {
    global::System.Collections.Generic.IList<global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotation> annotations
      ...
      || (annotation is global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationSquare))));
    global::DripSharp.Testing.JavaAssertions.Equal(2,
      global::DripSharp.Runtime.JavaCompat.CollectionCount(annotations), null);
    global::DripSharp.Testing.JavaAssertions.True((global::DripSharp.Runtime.JavaCompat.ListGet(annotations,
      0) is global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationSquare), null);
    global::DripSharp.Testing.JavaAssertions.True((global::DripSharp.Runtime.JavaCompat.ListGet(annotations,
      1) is global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationLink), null);
  }
