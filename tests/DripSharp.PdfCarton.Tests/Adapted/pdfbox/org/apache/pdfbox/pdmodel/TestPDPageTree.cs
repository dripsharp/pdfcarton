...
public class TestPDPageTree {
  ...
  internal virtual void indexOfPageFromOutlineDestination() {
    ...
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Outline.PDDocumentOutline outline
      = this.doc.GetDocumentCatalog().GetDocumentOutline();
    foreach (global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Outline.PDOutlineItem current in outline.Children()) {
      if (global::DripSharp.Runtime.JavaCompat.StringContains(current.GetTitle(), "Second")) {
        global::DripSharp.Testing.JavaAssertions.Equal(2,
          this.doc.GetPages().IndexOf(current.FindDestinationPage(this.doc)), null);
      }
    }
  }
  ...
  internal virtual void positiveSingleLevel() {
    ...
    for (int i = 0; (i < this.doc.GetNumberOfPages()); i++) {
      global::DripSharp.Testing.JavaAssertions.Equal(i,
        this.doc.GetPages().IndexOf(this.doc.GetPage(i)), null);
    }
  }
  ...
  internal virtual void testNodeLoop() {
    this.doc
      = global::DripSharp.PdfCarton.Loader.LoadPDF(global::DripSharp.PdfCarton.IO.RandomAccessReadBuffer.CreateBufferFromStream(global::DripSharp.PdfCarton.Tests.Support.ResourceStream(typeof(global::DripSharp.PdfCarton.Pdmodel.TestPDPageTree),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "PDFBOX-6040-nodeloop.pdf"))));
