...
public class PDIntegerNameTreeNode
: global::DripSharp.PdfCarton.Pdmodel.Common.PDNameTreeNode<global::DripSharp.PdfCarton.Cos.COSInteger> {
  ...
  protected internal override global::DripSharp.PdfCarton.Cos.COSInteger ConvertCOSToPD(global::DripSharp.PdfCarton.Cos.COSBase @base) {
    if (((@base != default!) && !((@base is global::DripSharp.PdfCarton.Cos.COSInteger)))) {
      throw new global::System.IO.IOException(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        global::DripSharp.Runtime.JavaCompat.Concat("integer expected here, but got ", @base)));
    }
  ...
  static PDIntegerNameTreeNode() {
    global::System.Runtime.CompilerServices.RuntimeHelpers.RunClassConstructor(typeof(global::DripSharp.PdfCarton.Pdmodel.Common.PDNameTreeNode<global::DripSharp.PdfCarton.Cos.COSInteger>).TypeHandle);
  }
}
