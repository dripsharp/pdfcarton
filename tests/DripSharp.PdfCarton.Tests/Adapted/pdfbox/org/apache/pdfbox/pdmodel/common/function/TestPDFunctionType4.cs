...
private global::DripSharp.PdfCarton.Pdmodel.Common.Function.PDFunctionType4 createFunction(string function, float[] domain, float[] range) {
...
global::DripSharp.PdfCarton.Cos.COSArray domainArray = new global::DripSharp.PdfCarton.Cos.COSArray();
domainArray.SetFloatArray(domain);
stream.SetItem(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "Domain"), domainArray);
global::DripSharp.PdfCarton.Cos.COSArray rangeArray = new global::DripSharp.PdfCarton.Cos.COSArray();
rangeArray.SetFloatArray(range);
stream.SetItem(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "Range"), rangeArray);
using (global::System.IO.Stream @out = stream.CreateOutputStream()) {
sbyte[] data = global::DripSharp.Runtime.JavaCompat.StringGetBytes(function, global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
...
global::DripSharp.PdfCarton.Pdmodel.Common.Function.PDFunctionType4 function = this.createFunction(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", functionText), new float[] { -1.0F, 1.0F, -1.0F, 1.0F }, new float[] { -1.0F, 1.0F });
