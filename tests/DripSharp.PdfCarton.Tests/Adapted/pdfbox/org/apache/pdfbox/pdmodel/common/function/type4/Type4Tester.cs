...
public class Type4Tester {
  private readonly global::DripSharp.PdfCarton.Pdmodel.Common.Function.Type4.ExecutionContext context
    = null!;
  ...
  public static global::DripSharp.PdfCarton.Pdmodel.Common.Function.Type4.Type4Tester Create(string text) {
    global::DripSharp.PdfCarton.Pdmodel.Common.Function.Type4.InstructionSequence instructions
      = global::DripSharp.PdfCarton.Pdmodel.Common.Function.Type4.InstructionSequenceBuilder.Parse(text);
    global::DripSharp.PdfCarton.Pdmodel.Common.Function.Type4.ExecutionContext context
      = new global::DripSharp.PdfCarton.Pdmodel.Common.Function.Type4.ExecutionContext(new global::DripSharp.PdfCarton.Pdmodel.Common.Function.Type4.Operators());
  ...
  public virtual global::DripSharp.PdfCarton.Pdmodel.Common.Function.Type4.Type4Tester PopReal(float expected,
    double delta) {
    float value
      = global::DripSharp.Runtime.JavaCompat.Unbox((float?)(this.context.GetStack().Pop()));
    global::DripSharp.Testing.JavaAssertions.Equal((double)(expected), (double)(value), null,
      delta);
    return this;
  }
  ...
  public virtual global::DripSharp.PdfCarton.Pdmodel.Common.Function.Type4.Type4Tester Pop(float expected,
    ...
    global::DripSharp.Testing.JavaAssertions.Equal((double)(expected),
      global::System.Convert.ToDouble(value,
      global::System.Globalization.CultureInfo.InvariantCulture), null, delta);
    return this;
  }
