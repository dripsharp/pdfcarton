...
public class FDFFieldTest {
  internal virtual void testCOSStringValue() {
    ...
    global::DripSharp.PdfCarton.Cos.COSString testCOSString
      = new global::DripSharp.PdfCarton.Cos.COSString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      testString));
    global::DripSharp.PdfCarton.Pdmodel.Fdf.FDFField field
  ...
  internal virtual void testTextAsCOSStreamValue() {
    string testString = "Test value";
    sbyte[] testBytes = global::DripSharp.Runtime.JavaCompat.StringGetBytes(testString,
      global::DripSharp.Runtime.JavaStandardCharsets.USASCII);
    global::DripSharp.PdfCarton.Cos.COSStream stream = this.createStream(testBytes,
  ...
  internal virtual void testCOSNameValue() {
    ...
    global::DripSharp.PdfCarton.Cos.COSName testCOSSName
  ...
  internal virtual void testCOSArrayValue() {
    global::System.Collections.Generic.IList<string> testList
      = new global::System.Collections.Generic.List<string>();
    global::DripSharp.Runtime.JavaCompat.Add(testList, "A");
    global::DripSharp.Runtime.JavaCompat.Add(testList, "B");
    global::DripSharp.PdfCarton.Cos.COSArray testCOSArray
      = global::DripSharp.PdfCarton.Cos.COSArray.OfCOSStrings(testList);
    global::DripSharp.PdfCarton.Pdmodel.Fdf.FDFField field
      = new global::DripSharp.PdfCarton.Pdmodel.Fdf.FDFField();
