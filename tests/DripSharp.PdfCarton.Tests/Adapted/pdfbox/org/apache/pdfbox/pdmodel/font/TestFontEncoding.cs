...
public class TestFontEncoding {
  internal virtual void testAdd() {
    int codeForSpace
      = global::DripSharp.Runtime.JavaCompat.UnboxObject<int>(global::DripSharp.Runtime.JavaCompat.MapGetNullable(global::DripSharp.PdfCarton.Pdmodel.Font.Encoding.WinAnsiEncoding.Instance.GetNameToCodeMap(),
      "space"));
    global::DripSharp.Testing.JavaAssertions.Equal(32, codeForSpace, null);
    codeForSpace
      = global::DripSharp.Runtime.JavaCompat.UnboxObject<int>(global::DripSharp.Runtime.JavaCompat.MapGetNullable(global::DripSharp.PdfCarton.Pdmodel.Font.Encoding.MacRomanEncoding.Instance.GetNameToCodeMap(),
      "space"));
    global::DripSharp.Testing.JavaAssertions.Equal(32, codeForSpace, null);
  }

  internal virtual void testOverwrite() {
    global::DripSharp.PdfCarton.Cos.COSDictionary dictEncodingDict
      = new global::DripSharp.PdfCarton.Cos.COSDictionary();
    dictEncodingDict.SetItem(global::DripSharp.PdfCarton.Cos.COSName.Type,
      global::DripSharp.PdfCarton.Cos.COSName.Encoding);
    dictEncodingDict.SetItem(global::DripSharp.PdfCarton.Cos.COSName.BaseEncoding,
      global::DripSharp.PdfCarton.Cos.COSName.WinAnsiEncoding);
    ...
    differences.Add(global::DripSharp.PdfCarton.Cos.COSName.GetPDFName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "a")));
    dictEncodingDict.SetItem(global::DripSharp.PdfCarton.Cos.COSName.Differences, differences);
    global::DripSharp.PdfCarton.Pdmodel.Font.Encoding.DictionaryEncoding dictEncoding
      = new global::DripSharp.PdfCarton.Pdmodel.Font.Encoding.DictionaryEncoding(dictEncodingDict,
      false, (global::DripSharp.PdfCarton.Pdmodel.Font.Encoding.Encoding)default!);
    global::DripSharp.Testing.JavaAssertions.Null(global::DripSharp.Runtime.JavaCompat.MapGetNullable(dictEncoding.GetNameToCodeMap(),
      "space"), null);
    global::DripSharp.Testing.JavaAssertions.Equal(32,
      global::DripSharp.Runtime.JavaCompat.Unbox(global::DripSharp.Runtime.JavaCompat.MapGetNullable(dictEncoding.GetNameToCodeMap(),
      "a")), null);
  }
  ...
  internal virtual void testPDFBox3884() {
    ...
    cs.SetFont(new global::DripSharp.PdfCarton.Pdmodel.Font.PDType1Font(global::DripSharp.PdfCarton.Pdmodel.Font.Standard14Fonts.FontName.Helvetica),
      (float)(20));
    cs.BeginText();
