...
public class PDIndexedTest {
  internal virtual void testFactory() {
    ...
    int hival = 5;
    string stringLookupData
      = global::DripSharp.Runtime.JavaCompat.ReplaceOrdinal("AA1166 112233 000000 FEDC01 4561FE DC34DA",
      " ", "");
    string outputString
      = global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("/Indexed /DeviceRGB 5 <",
      stringLookupData), ">");
    sbyte[] lookupData
      = global::DripSharp.PdfCarton.Cos.COSString.ParseHex(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      stringLookupData)).GetBytes();
    global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDIndexed pdIndexed
      = global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDIndexed.Create(baseColorspace, hival,
      lookupData);
    global::DripSharp.PdfCarton.Cos.COSArray indexedCOSArray
      = (global::DripSharp.PdfCarton.Cos.COSArray)(pdIndexed.GetCOSObject()!);
    global::DripSharp.Testing.JavaAssertions.Equal(hival,
      ((global::DripSharp.PdfCarton.Cos.COSNumber)(indexedCOSArray.GetObject(2)!)).IntValue(),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "unexpected value for hival"));
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Indexed.GetName(),
      pdIndexed.GetName(), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "unexpected value for name"));
    global::DripSharp.Testing.JavaAssertions.Equal(baseColorspace, pdIndexed.GetBaseColorSpace(),
  ...
  internal virtual void testFactoryParameterChecks() {
    ...
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.ArgumentException>(()
      => global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDIndexed.Create(baseColorspace, 0,
      (sbyte[])default!), null);
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.ArgumentException>(()
