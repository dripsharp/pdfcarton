...
global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDLab pdLab = new global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDLab();
global::DripSharp.PdfCarton.Cos.COSArray cosArray = (global::DripSharp.PdfCarton.Cos.COSArray)(pdLab.GetCOSObject()!);
global::DripSharp.PdfCarton.Cos.COSDictionary dict = (global::DripSharp.PdfCarton.Cos.COSDictionary)(cosArray.GetObject(1)!);
...
global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.ArrayEquals(new float[] { 0, 0, 0 }, pdLab.GetInitialColor().GetComponents()), null);
...
global::DripSharp.Testing.JavaAssertions.Equal(0, dict.Size(), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "read operations should not change the size of /Lab objects"));
dict.ToString();
global::DripSharp.PdfCarton.Pdmodel.Common.PDRange pdRange = new global::DripSharp.PdfCarton.Pdmodel.Common.PDRange();
...
global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDTristimulus pdTristimulus = new global::DripSharp.PdfCarton.Pdmodel.Graphics.Color.PDTristimulus();
...
global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.ArrayEquals(new float[] { 0, 0, 3 }, pdLab.GetInitialColor().GetComponents()), null);
}
