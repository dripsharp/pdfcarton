...
public class ValidateXImage {
  public static void Validate(global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.PDImageXObject ximage,
    int bpc, int width, int height, string format, string colorSpaceName) {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Xobject,
      cosStream.GetItem(global::DripSharp.PdfCarton.Cos.COSName.Type), null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Image,
      cosStream.GetItem(global::DripSharp.PdfCarton.Cos.COSName.Subtype), null);
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(colorSpaceName, ximage.GetColorSpace().GetName(),
      null);
    global::DripSharp.Testing.JavaAssertions.NotNull(ximage.GetImage(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(ximage.GetWidth(), ximage.GetImage().Width,
      null);
    global::DripSharp.Testing.JavaAssertions.Equal(ximage.GetHeight(), ximage.GetImage().Height,
      null);
    ...
    bool canEncode = true;
    bool writeOk;
    if ((global::DripSharp.Runtime.JavaCompat.Equals("jpg", format)
      && (global::DripSharp.Runtime.PdfCartonFontCompat.GetImageType(ximage.GetImage())
      == global::DripSharp.Runtime.PdfCartonFontCompat.TYPE_INT_ARGB))) {
      global::DripSharp.Runtime.JavaImageWriter writer
        = (global::DripSharp.Runtime.PdfCartonImageIO.GetImageWritersBySuffix(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        format))).Next()!;
      global::DripSharp.Runtime.JavaImageWriter originatingProvider = writer;
      canEncode = true;
    }
    if (canEncode) {
      writeOk = global::DripSharp.PdfCarton.Tests.Support.WriteImage(ximage.GetImage(),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", format),
        new global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.ValidateXImage.NullOutputStream());
      global::DripSharp.Testing.JavaAssertions.True(writeOk, null);
    }
    writeOk
      = global::DripSharp.PdfCarton.Tests.Support.WriteImage(ximage.GetOpaqueImage((global::SkiaSharp.SKRectI)default!,
      1), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", format),
      new global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.ValidateXImage.NullOutputStream());
    global::DripSharp.Testing.JavaAssertions.True(writeOk, null);
  }
  ...
  public static int ColorCount(global::SkiaSharp.SKBitmap bim) {
    global::System.Collections.Generic.ISet<int> colors
  ...
  public static void CheckIdent(global::SkiaSharp.SKBitmap expectedImage,
    global::SkiaSharp.SKBitmap actualImage) {
    string errMsg = "";
    expectedImage
      = global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.ValidateXImage.ConvertToSRGB(expectedImage);
    actualImage
      = global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.ValidateXImage.ConvertToSRGB(actualImage);
      ...
      for (int x = 0; (x < w); ++x) {
        if ((global::DripSharp.Runtime.PdfCartonFontCompat.GetRgb(expectedImage, x, y)
          ...
          errMsg
            ...
            "(%d,%d) expected: <%08X> but was: <%08X>; "), x, y,
  ...
  public static global::SkiaSharp.SKBitmap ConvertToSRGB(global::SkiaSharp.SKBitmap image) {
    ...
    if ((global::DripSharp.Runtime.PdfCartonFontCompat.GetRaster(image).GetDataBuffer().DataType
      ...
      global::DripSharp.PdfCarton.Tests.JavaDirectColorModel colorModel
        = new global::DripSharp.PdfCarton.Tests.JavaDirectColorModel(global::DripSharp.Runtime.PdfCartonFontCompat.GetColorModel(image).ColorSpace,
        32, 255, 65280, 16711680, -16777216, false,
        global::DripSharp.Runtime.PdfCartonFontCompat.DATA_BUFFER_TYPE_INT);
      global::DripSharp.Runtime.JavaRaster targetRaster
        = global::DripSharp.PdfCarton.Tests.Support.CreatePackedRaster(global::DripSharp.Runtime.PdfCartonFontCompat.DATA_BUFFER_TYPE_INT,
        image.Width, image.Height, colorModel.GetMasks(), new global::DripSharp.Runtime.JavaPoint(0,
        0));
      global::SkiaSharp.SKBitmap image8Bit
      ...
      for (int y = 0; (y < image.Height); y++) {
        ...
        for (int x = 0; (x < width); x++) {
          ...
          int r8bit
            = global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.ValidateXImage.convert16To8Bit(r);
          int g8bit
            = global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.ValidateXImage.convert16To8Bit(g);
          int b8bit
            = global::DripSharp.PdfCarton.Pdmodel.Graphics.Image.ValidateXImage.convert16To8Bit(b);
          int v = (((r8bit | (g8bit << unchecked((int)(8)))) | (b8bit << unchecked((int)(16)))) |
            -16777216);
          pixelInt[x] = v;
        }
        global::DripSharp.PdfCarton.Tests.Support.SetDataElements(targetRaster, 0, y, width, 1,
          pixelInt);
      }
      image = image8Bit;
    }
    global::SkiaSharp.SKBitmap destination
    ...
    global::DripSharp.Runtime.JavaColorConvertOp op
      = new global::DripSharp.Runtime.JavaColorConvertOp(global::DripSharp.Runtime.PdfCartonFontCompat.GetColorSpace(global::DripSharp.Runtime.JavaColorSpace.CS_sRGB));
