...
public class RenderingIntentTest {
  internal virtual void fromStringInputNotNullOutputNotNull() {
    ...
    global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent retval
      = global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent.FromString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      value));
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent.AbsoluteColorimetric,
      retval, null);
  }
  ...
  internal virtual void fromStringInputNotNullOutputNotNull2() {
    ...
    global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent retval
      = global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent.FromString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      value));
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent.RelativeColorimetric,
      retval, null);
  }
  ...
  internal virtual void fromStringInputNotNullOutputNotNull3() {
    ...
    global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent retval
      = global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent.FromString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      value));
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent.Perceptual,
      retval, null);
  }
  ...
  internal virtual void fromStringInputNotNullOutputNotNull4() {
    ...
    global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent retval
      = global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent.FromString(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      value));
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent.Saturation,
      retval, null);
  }
  ...
  internal virtual void stringValueOutputNotNull() {
    global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent objectUnderTest
      = global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingIntent.AbsoluteColorimetric;
  ...
  internal virtual void testIsFill() {
    global::DripSharp.PdfCarton.Pdmodel.Graphics.State.RenderingMode objectUnderTest
