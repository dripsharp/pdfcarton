...
public class PDOutlineItemTest {
  private global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Outline.PDOutlineItem root
    = null!;

  private global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Outline.PDOutlineItem first
    = null!;

  private global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Outline.PDOutlineItem second
    = null!;

  private global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Outline.PDOutlineItem newSibling
    = null!;
  ...
  internal virtual void insertSiblingTop() {
    ...
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Outline.PDOutlineItem newSibling
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Outline.PDOutlineItem();
    this.first.InsertSiblingBefore(newSibling);
    global::DripSharp.Testing.JavaAssertions.Equal(this.first.GetPreviousSibling(), newSibling,
      null);
  ...
  internal virtual void insertSiblingTopNoParent() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(this.root.GetPreviousSibling(), newSibling,
      null);
  }
  ...
  internal virtual void cannotInsertSiblingBeforeAList() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Outline.PDOutlineItem child
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Outline.PDOutlineItem();
    ...
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.ArgumentException>(()
      => this.root.InsertSiblingBefore(child), null);
  }
  ...
  internal virtual void cannotInsertSiblingAfterAList() {
    ...
    child.InsertSiblingAfter(new global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Outline.PDOutlineItem());
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.ArgumentException>(()
      => this.root.InsertSiblingAfter(child), null);
  }
