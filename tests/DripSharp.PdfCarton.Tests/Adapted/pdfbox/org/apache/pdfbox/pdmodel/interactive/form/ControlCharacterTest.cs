...
public class ControlCharacterTest {
  ...
  internal virtual void setUp() {
    this.document
      ...
      new object[] { (global::DripSharp.Runtime.JavaFile)global::DripSharp.Runtime.JavaCompat.NewJavaFile(global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.ControlCharacterTest.IN_DIR,
  ...
  internal virtual void characterTAB() {
    ...
    global::System.Collections.Generic.IList<string> pdfboxValues
      = global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.TestUtils.GetStringsFromStream(field);
    global::DripSharp.Runtime.JavaCompat.ForEach(pdfboxValues, (token)
      => global::DripSharp.Testing.JavaAssertions.Equal("TAB", token, null));
  }

  private static global::System.Collections.Generic.IEnumerable<object[]> provideParameters() {
    return global::DripSharp.Runtime.JavaCompat.StreamOf(new object[] { "space", "SPACE SPACE" },
      new object[] { "cr", "CR\rCR" }, new object[] { "lf", "LF\nLF" }, new object[] { "crlf",
      "CRLF\r\nCRLF" }, new object[] { "lfcr", "LFCR\n\rLFCR" }, new object[] { "linebreak",
      "linebreak\u2028linebreak" }, new object[] { "paragraphbreak",
  ...
  internal virtual void testCharacter(string nameSuffix, string value) {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDField field
      = this.acroForm.GetField(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat("pdfbox-", nameSuffix)));
    field.SetValue(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", value));
    global::System.Collections.Generic.IList<string> pdfboxValues
      = global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.TestUtils.GetStringsFromStream(field);
    global::System.Collections.Generic.IList<string> acrobatValues
      = global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.TestUtils.GetStringsFromStream(this.acroForm.GetField(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat("acrobat-", nameSuffix))));
