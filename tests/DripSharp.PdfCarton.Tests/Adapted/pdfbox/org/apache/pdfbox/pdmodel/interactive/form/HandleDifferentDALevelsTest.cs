  ...
  internal virtual void checkSingleAnnotation() {
    ...
    foreach (global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationWidget widget in widgets) {
      string contentAsString
        = global::DripSharp.Runtime.JavaCompat.NewString(widget.GetNormalAppearanceStream().GetContentStream().ToByteArray(),
        global::System.Text.Encoding.UTF8);
      global::DripSharp.Testing.JavaAssertions.True((contentAsString.IndexOf(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        fieldFontSetting), global::System.StringComparison.Ordinal) > 0), null);
    }
  }
  ...
  internal virtual void checkSameLayout() {
    ...
    foreach (global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationWidget widget in widgets) {
      string contentAsString
        ...
        global::System.Text.Encoding.UTF8);
      global::DripSharp.Testing.JavaAssertions.True((contentAsString.IndexOf(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        fieldFontSetting), global::System.StringComparison.Ordinal) > 0),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        global::DripSharp.Runtime.JavaCompat.Concat("font setting in content stream shall be ",
        fieldFontSetting)));
    }
  }
  ...
  internal virtual void checkDifferentLayout() {
    ...
    foreach (global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationWidget widget in widgets) {
      ...
      string contentAsString
        ...
        global::System.Text.Encoding.UTF8);
      global::DripSharp.Testing.JavaAssertions.True((contentAsString.IndexOf(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        fontSetting), global::System.StringComparison.Ordinal) > 0),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        global::DripSharp.Runtime.JavaCompat.Concat("font setting in content stream shall be ",
        fontSetting)));
    }
