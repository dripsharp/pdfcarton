...
public class PDButtonTest {
  ...
  internal virtual void setUp() {
    ...
    this.acrobatDocument
      ...
      new object[] { (global::DripSharp.Runtime.JavaFile)global::DripSharp.Runtime.JavaCompat.NewJavaFile(global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDButtonTest.IN_DIR,
  ...
  internal virtual void createCheckBox() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDButton buttonField
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDCheckBox(this.acroForm);
    global::DripSharp.Testing.JavaAssertions.Equal(buttonField.GetFieldType(),
      buttonField.GetCOSObject().GetNameAsString(global::DripSharp.PdfCarton.Cos.COSName.Ft), null);
  ...
  internal virtual void createPushButton() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDButton buttonField
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDPushButton(this.acroForm);
    global::DripSharp.Testing.JavaAssertions.Equal(buttonField.GetFieldType(),
      buttonField.GetCOSObject().GetNameAsString(global::DripSharp.PdfCarton.Cos.COSName.Ft), null);
    global::DripSharp.Testing.JavaAssertions.Equal("Btn", buttonField.GetFieldType(), null);
  ...
  internal virtual void createRadioButton() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDButton buttonField
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDRadioButton(this.acroForm);
    global::DripSharp.Testing.JavaAssertions.Equal(buttonField.GetFieldType(),
      buttonField.GetCOSObject().GetNameAsString(global::DripSharp.PdfCarton.Cos.COSName.Ft), null);
    global::DripSharp.Testing.JavaAssertions.Equal("Btn", buttonField.GetFieldType(), null);
  ...
  internal virtual void testRadioButtonWithOptions() {
    global::DripSharp.Runtime.JavaFile file
      ...
      global::System.Exception __dripsharpPrimary_112_25_0 = null!;
      try {
        ...
        global::DripSharp.Runtime.JavaCompat.ForEach(radioButton.GetWidgets(), (widget)
          => global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Off,
          widget.GetCOSObject().GetItem(global::DripSharp.PdfCarton.Cos.COSName.As),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "The widget should be set to Off")));
      } catch (global::System.Exception __dripsharpCaught_112_25_0) {
        __dripsharpPrimary_112_25_0 = __dripsharpCaught_112_25_0;
        throw;
      } finally {
        global::DripSharp.Runtime.JavaCompat.CloseResource(pdfDocument,
          __dripsharpPrimary_112_25_0);
      }
    }
  }
    ...
    global::DripSharp.Runtime.JavaFile file
      ...
      try {
        pdfDocument.GetDocumentCatalog().GetAcroForm().GetField(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "RadioButton")).SetValue(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "c"));
        global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDRadioButton radioButton
          = (global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDRadioButton)(pdfDocument.GetDocumentCatalog().GetAcroForm().GetField(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "RadioButton"))!);
        radioButton.SetValue(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "c"));
        global::DripSharp.Testing.JavaAssertions.NotEqual("2", radioButton.GetValueAsString(),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "This shall no longer be 2"));
        global::DripSharp.Testing.JavaAssertions.NotEqual("2",
          global::DripSharp.Runtime.JavaCompat.ListGet(radioButton.GetWidgets(),
          2).GetCOSObject().GetNameAsString(global::DripSharp.PdfCarton.Cos.COSName.As),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "This shall no longer be 2"));
        global::DripSharp.Testing.JavaAssertions.Equal("c", radioButton.GetValueAsString(),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "This shall be c"));
  ...
  internal virtual void retrieveAcrobatCheckBoxProperties() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDCheckBox checkbox
      = (global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDCheckBox)(this.acrobatAcroForm.GetField(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "Checkbox"))!);
    ...
    global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.CollectionContains(checkbox.GetOnValues(),
      "Yes"), null);
  }
  ...
  internal virtual void testAcrobatCheckBoxProperties() {
    ...
    checkbox.Check();
    global::DripSharp.Testing.JavaAssertions.Equal(checkbox.GetValue(), checkbox.GetOnValue(),
      null);
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(checkbox.GetValue(), checkbox.GetOnValue(),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal(true, checkbox.IsChecked(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Yes,
      checkbox.GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.As),
      null);
    checkbox.SetValue(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "Off"));
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Off.GetName(),
      checkbox.GetValue(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(false, checkbox.IsChecked(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Off,
      checkbox.GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.As),
      null);
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(checkbox.GetDefaultValue(),
      checkbox.GetOnValue(), null);
    checkbox.SetDefaultValue(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "Off"));
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Off.GetName(),
      checkbox.GetDefaultValue(), null);
  }

  internal virtual void setValueForAbstractedAcrobatCheckBox() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDField checkbox
      = this.acrobatAcroForm.GetField(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "Checkbox"));
    checkbox.SetValue(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "Yes"));
    global::DripSharp.Testing.JavaAssertions.Equal(checkbox.GetValueAsString(),
      ((global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDCheckBox)(checkbox!)).GetOnValue(),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal(true,
      ((global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDCheckBox)(checkbox!)).IsChecked(),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Yes,
      checkbox.GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.As),
      null);
    checkbox.SetValue(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "Off"));
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Off.GetName(),
      checkbox.GetValueAsString(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(false,
      ((global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDCheckBox)(checkbox!)).IsChecked(),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Off,
      checkbox.GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.As),
  ...
  internal virtual void testAcrobatCheckBoxGroupProperties() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal("Option1",
      global::DripSharp.Runtime.JavaCompat.ListGet(checkbox.GetWidgets(),
      0).GetAppearanceState().GetName(), null);
    global::DripSharp.Testing.JavaAssertions.Equal("Off",
      global::DripSharp.Runtime.JavaCompat.ListGet(checkbox.GetWidgets(),
      1).GetAppearanceState().GetName(), null);
    global::DripSharp.Testing.JavaAssertions.Equal("Off",
      global::DripSharp.Runtime.JavaCompat.ListGet(checkbox.GetWidgets(),
      2).GetAppearanceState().GetName(), null);
    global::DripSharp.Testing.JavaAssertions.Equal("Off",
      global::DripSharp.Runtime.JavaCompat.ListGet(checkbox.GetWidgets(),
      3).GetAppearanceState().GetName(), null);
    ...
    global::DripSharp.Testing.JavaAssertions.Equal("Off",
      global::DripSharp.Runtime.JavaCompat.ListGet(checkbox.GetWidgets(),
      1).GetAppearanceState().GetName(), null);
    global::DripSharp.Testing.JavaAssertions.Equal("Option3",
      global::DripSharp.Runtime.JavaCompat.ListGet(checkbox.GetWidgets(),
      2).GetAppearanceState().GetName(), null);
    global::DripSharp.Testing.JavaAssertions.Equal("Option3",
      global::DripSharp.Runtime.JavaCompat.ListGet(checkbox.GetWidgets(),
  ...
  internal virtual void setCheckboxInvalidValue() {
    ...
    global::DripSharp.Testing.JavaAssertions.Throws<global::System.ArgumentException>(()
      => checkbox.SetValue(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "InvalidValue")), null);
  }
  ...
  internal virtual void retrieveAcrobatRadioButtonProperties() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDRadioButton radioButton
      = (global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDRadioButton)(this.acrobatAcroForm.GetField(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "RadioButtonGroup"))!);
    ...
    global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.CollectionContains(radioButton.GetOnValues(),
      "RadioButton01"), null);
    global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.CollectionContains(radioButton.GetOnValues(),
      "RadioButton02"), null);
  }
  ...
  internal virtual void testAcrobatRadioButtonProperties() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.GetPDFName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "RadioButton01")), global::DripSharp.Runtime.JavaCompat.ListGet(radioButton.GetWidgets(),
      0).GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.As), null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Off,
      global::DripSharp.Runtime.JavaCompat.ListGet(radioButton.GetWidgets(),
      1).GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.As), null);
    radioButton.SetValue(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "RadioButton02"));
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Off,
      ...
      0).GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.As), null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.GetPDFName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "RadioButton02")), global::DripSharp.Runtime.JavaCompat.ListGet(radioButton.GetWidgets(),
      1).GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.As), null);
  }

  internal virtual void setValueForAbstractedAcrobatRadioButton() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDField radioButton
      = this.acrobatAcroForm.GetField(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "RadioButtonGroup"));
    radioButton.SetValue(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "RadioButton01"));
    global::DripSharp.Testing.JavaAssertions.Equal("RadioButton01", radioButton.GetValueAsString(),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.GetPDFName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "RadioButton01")), global::DripSharp.Runtime.JavaCompat.ListGet(radioButton.GetWidgets(),
      0).GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.As), null);
    ...
    radioButton.SetValue(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "RadioButton02"));
    global::DripSharp.Testing.JavaAssertions.Equal("RadioButton02", radioButton.GetValueAsString(),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Off,
      global::DripSharp.Runtime.JavaCompat.ListGet(radioButton.GetWidgets(),
      0).GetCOSObject().GetDictionaryObject(global::DripSharp.PdfCarton.Cos.COSName.As), null);
