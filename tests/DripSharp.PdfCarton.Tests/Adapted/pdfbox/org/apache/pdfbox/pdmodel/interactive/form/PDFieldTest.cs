...
public class PDFieldTest {
  ...
  internal virtual void setUp() {
    ...
    this.textField
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField(this.acroForm);
  }
  ...
  internal virtual void testPartialName() {
    ...
    this.textField.SetPartialName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      testName));
  ...
  internal virtual void testSetPartialNameNull() {
    global::DripSharp.Testing.JavaAssertions.DoesNotThrow(()
      => this.textField.SetPartialName((string)default!),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "Setting partial name to null should not throw an exception"));
  }

  internal virtual void testPartialNameWithPeriodThrows() {
    string nameWithPeriod = "test.field";
    global::System.ArgumentException exception
      = global::DripSharp.Testing.JavaAssertions.Throws<global::System.ArgumentException>(()
      => this.textField.SetPartialName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      nameWithPeriod)), null);
    global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.StringContains(global::DripSharp.Runtime.JavaCompat.ExceptionMessage(exception),
      "period character"), null);
  }
  ...
  internal virtual void testFullyQualifiedNameWithParent() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDNonTerminalField parentField
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDNonTerminalField(this.acroForm);
    parentField.SetPartialName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "parentField"));
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField childField
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField(this.acroForm,
      new global::DripSharp.PdfCarton.Cos.COSDictionary(), parentField);
    childField.SetPartialName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "childField"));
    string fullyQualifiedName = childField.GetFullyQualifiedName();
    global::DripSharp.Testing.JavaAssertions.Equal("parentField.childField", fullyQualifiedName,
      null);
  }
  ...
  internal virtual void testAlternateFieldName() {
    ...
    this.textField.SetAlternateFieldName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      alternateName));
    global::DripSharp.Testing.JavaAssertions.Equal(alternateName,
      this.textField.GetAlternateFieldName(), null);
    string newAlternateName = "New Alternate Name";
    this.textField.SetAlternateFieldName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      newAlternateName));
    global::DripSharp.Testing.JavaAssertions.Equal(newAlternateName,
      this.textField.GetAlternateFieldName(), null);
  }
  ...
  internal virtual void testMappingName() {
    ...
    this.textField.SetMappingName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      mappingName));
    global::DripSharp.Testing.JavaAssertions.Equal(mappingName, this.textField.GetMappingName(),
      null);
    string newMappingName = "newMappingName";
    this.textField.SetMappingName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      newMappingName));
    global::DripSharp.Testing.JavaAssertions.Equal(newMappingName, this.textField.GetMappingName(),
      null);
  }
  ...
  internal virtual void testGetWidgets() {
    ...
    global::DripSharp.Testing.JavaAssertions.True((global::DripSharp.Runtime.JavaCompat.CollectionCount(this.textField.GetWidgets())
      >= 0), null);
  }
  ...
  internal virtual void testToStringWithValue() {
    ...
    global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.StringContains(stringRepresentation,
      "PDTextField"), null);
    global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Runtime.JavaCompat.StringContains(stringRepresentation,
      "fieldWithValue"), null);
  }
  ...
  internal virtual void testGetAcroForm() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(this.acroForm, this.textField.GetAcroForm(),
      null);
  }

  internal virtual void testGetParent() {
    global::DripSharp.Testing.JavaAssertions.Null(this.textField.GetParent(), null);
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDNonTerminalField parent
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDNonTerminalField(this.acroForm);
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField childField
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField(this.acroForm,
      new global::DripSharp.PdfCarton.Cos.COSDictionary(), parent);
  ...
  internal virtual void testGetCOSObject() {
    ...
    global::DripSharp.Testing.JavaAssertions.True((this.textField.GetCOSObject() is global::DripSharp.PdfCarton.Cos.COSDictionary),
      null);
  }

  internal virtual void testEquals() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField field1
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField(this.acroForm);
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField field2
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField(this.acroForm);
    field1.SetPartialName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "testField"));
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField field3
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField(this.acroForm,
      field1.GetCOSObject(),
    ...
    field2.SetPartialName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "differentField"));
  ...
  internal virtual void testHashCode() {
    ...
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField field2
      ...
      field1.GetCOSObject(),
      (global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDNonTerminalField)default!);
    global::DripSharp.Testing.JavaAssertions.Equal(field1.GetHashCode(), field2.GetHashCode(),
      null);
  ...
  internal virtual void testMultiplePropertiesTogether() {
    ...
    this.textField.SetReadOnly(true);
    this.textField.SetRequired(true);
    global::DripSharp.Testing.JavaAssertions.Equal("complexField", this.textField.GetPartialName(),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal("Complex Field",
      this.textField.GetAlternateFieldName(), null);
    global::DripSharp.Testing.JavaAssertions.Equal("complex_field", this.textField.GetMappingName(),
      null);
    global::DripSharp.Testing.JavaAssertions.True(this.textField.IsReadOnly(), null);
    global::DripSharp.Testing.JavaAssertions.True(this.textField.IsRequired(), null);
  }
