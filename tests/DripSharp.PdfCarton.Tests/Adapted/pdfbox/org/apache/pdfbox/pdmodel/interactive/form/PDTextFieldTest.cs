...
public class PDTextFieldTest {
  ...
  internal virtual void createDefaultTextField() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDField textField
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField(this.acroForm);
    global::DripSharp.Testing.JavaAssertions.Equal(textField.GetFieldType(),
      textField.GetCOSObject().GetNameAsString(global::DripSharp.PdfCarton.Cos.COSName.Ft), null);
  ...
  internal virtual void createWidgetForGet() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField textField
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDTextField(this.acroForm);
    global::DripSharp.Testing.JavaAssertions.Null(textField.GetCOSObject().GetItem(global::DripSharp.PdfCarton.Cos.COSName.Type),
      null);
    global::DripSharp.Testing.JavaAssertions.Null(textField.GetCOSObject().GetNameAsString(global::DripSharp.PdfCarton.Cos.COSName.Subtype),
      null);
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSName.Annot,
      textField.GetCOSObject().GetItem(global::DripSharp.PdfCarton.Cos.COSName.Type), null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationWidget.SubType,
      textField.GetCOSObject().GetNameAsString(global::DripSharp.PdfCarton.Cos.COSName.Subtype),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal(widget.GetCOSObject(), textField.GetCOSObject(),
      null);
  }
