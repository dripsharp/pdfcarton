...
public class TestListBox {
  ...
  internal virtual void setUp() {
    ...
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDAcroForm form
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDAcroForm(this.doc);
    ...
    form.SetDefaultAppearance(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      defaultAppearanceString));
    this.choice = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Form.PDListBox(form);
    this.choice.SetDefaultAppearance(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      "/Helv 12 Tf 0g"));
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Annotation.PDAnnotationWidget widget
      = global::DripSharp.Runtime.JavaCompat.ListGet(this.choice.GetWidgets(), 0);
  ...
  internal virtual void testExportValuesGetterSetter() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.ListGet(this.exportValues,
      2), global::DripSharp.Runtime.JavaCompat.ListGet(this.choice.GetValue(), 0), null);
    this.choice.SetTopIndex((int?)default!);
    global::DripSharp.PdfCarton.Cos.COSArray optItem
      = (global::DripSharp.PdfCarton.Cos.COSArray)(this.choice.GetCOSObject().GetItem(global::DripSharp.PdfCarton.Cos.COSName.Opt)!);
    global::DripSharp.Testing.JavaAssertions.NotNull(this.choice.GetCOSObject().GetItem(global::DripSharp.PdfCarton.Cos.COSName.Opt),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal(optItem.Size(),
      global::DripSharp.Runtime.JavaCompat.CollectionCount(this.exportValues), null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.ListGet(this.exportValues,
      0), optItem.GetString(0), null);
    global::System.Collections.Generic.IList<string> retrievedOptions = this.choice.GetOptions();
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.CollectionCount(retrievedOptions),
      global::DripSharp.Runtime.JavaCompat.CollectionCount(this.exportValues), null);
  ...
  internal virtual void testFieldValueSetterGetter() {
    ...
    global::DripSharp.PdfCarton.Cos.COSArray valueItems
      = (global::DripSharp.PdfCarton.Cos.COSArray)(this.choice.GetCOSObject().GetItem(global::DripSharp.PdfCarton.Cos.COSName.V)!);
    global::DripSharp.Testing.JavaAssertions.NotNull(valueItems, null);
    global::DripSharp.Testing.JavaAssertions.Equal(valueItems.Size(),
      global::DripSharp.Runtime.JavaCompat.CollectionCount(this.exportValues), null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.ListGet(this.exportValues,
      0), valueItems.GetString(0), null);
    global::DripSharp.PdfCarton.Cos.COSArray indexItems
      = (global::DripSharp.PdfCarton.Cos.COSArray)(this.choice.GetCOSObject().GetItem(global::DripSharp.PdfCarton.Cos.COSName.I)!);
    global::DripSharp.Testing.JavaAssertions.NotNull(indexItems, null);
    global::DripSharp.Testing.JavaAssertions.Equal(indexItems.Size(),
      global::DripSharp.Runtime.JavaCompat.CollectionCount(this.exportValues), null);
  ...
  internal virtual void testMultiselect() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal("The list box does not allow multiple selections.",
  ...
  internal virtual void testOptIsRemovedForNull() {
    ...
    global::DripSharp.Testing.JavaAssertions.Null(this.choice.GetCOSObject().GetItem(global::DripSharp.PdfCarton.Cos.COSName.Opt),
      null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::System.Array.Empty<object>(),
      this.choice.GetOptions(), null);
  }

  internal virtual void testSetExportAndDisplay() {
    this.choice.SetOptions(this.exportValues, this.displayValues);
    global::DripSharp.Testing.JavaAssertions.Equal(this.displayValues,
      this.choice.GetOptionsDisplayValues(), null);
    global::DripSharp.Testing.JavaAssertions.Equal(this.exportValues,
      this.choice.GetOptionsExportValues(), null);
  }
  ...
  internal virtual void testSortOption() {
    this.choice.SetOptions(this.exportValues, this.displayValues);
    global::DripSharp.Testing.JavaAssertions.Equal("display02",
      global::DripSharp.Runtime.JavaCompat.ListGet(this.choice.GetOptionsDisplayValues(), 0), null);
    this.choice.SetSort(true);
    this.choice.SetOptions(this.exportValues, this.displayValues);
    global::DripSharp.Testing.JavaAssertions.Equal("display01",
      global::DripSharp.Runtime.JavaCompat.ListGet(this.choice.GetOptionsDisplayValues(), 0), null);
    global::DripSharp.Testing.JavaAssertions.Equal("display02",
      global::DripSharp.Runtime.JavaCompat.ListGet(this.choice.GetOptionsDisplayValues(), 1), null);
    global::DripSharp.Testing.JavaAssertions.Equal("display03",
      global::DripSharp.Runtime.JavaCompat.ListGet(this.choice.GetOptionsDisplayValues(), 2), null);
  }
  ...
  internal virtual void testExceptionForDifferentNumberOfEntries() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal("The number of entries for exportValue and displayValue shall be the same.",
      global::DripSharp.Runtime.JavaCompat.ExceptionMessage(exception), null);
  }
