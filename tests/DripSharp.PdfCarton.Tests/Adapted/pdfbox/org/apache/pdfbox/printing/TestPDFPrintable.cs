...
public class TestPDFPrintable {
  ...
  private void assertPrinterGraphicsStateUnchanged(float dpi) { {
      ...
      global::System.Exception __dripsharpPrimary_102_25_0 = null!;
      try {
        doc.AddPage(new global::DripSharp.PdfCarton.Pdmodel.PDPage(new global::DripSharp.PdfCarton.Pdmodel.Common.PDRectangle((float)(global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_WIDTH),
          (float)(global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_HEIGHT))));
        global::DripSharp.PdfCarton.Printing.PDFPrintable printable
          = new global::DripSharp.PdfCarton.Printing.PDFPrintable(doc,
          global::DripSharp.PdfCarton.Printing.Scaling.ActualSize, true, dpi);
        global::SkiaSharp.SKBitmap output
          = global::DripSharp.Runtime.PdfCartonFontCompat.CreateBitmap(global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_WIDTH,
          global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_HEIGHT,
          global::DripSharp.Runtime.PdfCartonFontCompat.TYPE_INT_ARGB);
        global::DripSharp.Runtime.PdfCartonGraphics2D g2d
          = global::DripSharp.Runtime.PdfCartonFontCompat.CreateGraphics(output);
        g2d.Translate(7.0D, 11.0D);
        g2d.Scale(1.3D, 1.3D);
        global::DripSharp.Runtime.JavaColor originalColor
          = (global::DripSharp.Runtime.JavaColor)global::SkiaSharp.SKColors.Red;
        global::DripSharp.Runtime.JavaColor originalBackground
          = (global::DripSharp.Runtime.JavaColor)global::SkiaSharp.SKColors.Blue;
        global::DripSharp.Runtime.JavaStroke originalStroke
          = new global::DripSharp.Runtime.JavaBasicStroke(3.7F);
        g2d.SetColor(originalColor);
        g2d.SetBackground(originalBackground);
        g2d.SetStroke(originalStroke);
        global::SkiaSharp.SKMatrix originalTransform = g2d.GetTransform();
        global::SkiaSharp.SKRect originalClipDeviceBounds
          = global::DripSharp.PdfCarton.Printing.TestPDFPrintable.deviceClipBounds(g2d);
        global::DripSharp.Runtime.JavaPageFormat pf
          = global::DripSharp.PdfCarton.Printing.TestPDFPrintable.createPageFormat((double)(global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_WIDTH),
          (double)(global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_HEIGHT));
        int result = printable.Print(g2d, pf, 0);
        global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaPrintConstants.PAGE_EXISTS,
          result, null);
        global::DripSharp.Testing.JavaAssertions.Equal(originalColor, g2d.GetColor(),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "color should be unchanged after print()"));
        global::DripSharp.Testing.JavaAssertions.Equal(originalBackground, g2d.GetBackground(),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "background should be unchanged after print()"));
        global::DripSharp.Testing.JavaAssertions.Equal(originalStroke, g2d.GetStroke(),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "stroke should be unchanged after print()"));
        global::DripSharp.Testing.JavaAssertions.Equal(originalTransform, g2d.GetTransform(),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "transform should be unchanged after print() (translate/scale inside print() must not leak)"));
        global::DripSharp.Testing.JavaAssertions.Equal(originalClipDeviceBounds,
          global::DripSharp.PdfCarton.Printing.TestPDFPrintable.deviceClipBounds(g2d),
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          "clip should be unchanged after print()"));
        g2d.Dispose();
      } catch (global::System.Exception __dripsharpCaught_102_25_0) {
        __dripsharpPrimary_102_25_0 = __dripsharpCaught_102_25_0;
        throw;
      } finally {
        global::DripSharp.Runtime.JavaCompat.CloseResource(doc, __dripsharpPrimary_102_25_0);
      }
    }
  }
  ...
  private static global::SkiaSharp.SKRect deviceClipBounds(global::DripSharp.Runtime.PdfCartonGraphics2D g2d) {
    ...
    return global::DripSharp.Runtime.PdfCartonFontCompat.ShapeBounds(global::DripSharp.Runtime.PdfCartonFontCompat.CreateTransformedShape(g2d.GetTransform(),
      clip));
  }
  ...
  internal virtual void testPrintReturnsNoSuchPageForInvalidIndex() { {
      ...
      try {
        ...
        global::DripSharp.Runtime.JavaPageFormat pf
          = global::DripSharp.PdfCarton.Printing.TestPDFPrintable.createPageFormat((double)(global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_WIDTH),
          (double)(global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_HEIGHT));
        global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaPrintConstants.NO_SUCH_PAGE,
          printable.Print(g2d, pf, unchecked(-1)), null);
        global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaPrintConstants.NO_SUCH_PAGE,
          printable.Print(g2d, pf, 1), null);
        global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaPrintConstants.PAGE_EXISTS,
          printable.Print(g2d, pf, 0), null);
        g2d.Dispose();
  ...
  private void testShowPageBorderIsGray(float dpi) { {
      ...
      try {
        global::DripSharp.PdfCarton.Pdmodel.PDPage page
          = new global::DripSharp.PdfCarton.Pdmodel.PDPage(new global::DripSharp.PdfCarton.Pdmodel.Common.PDRectangle((float)(global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_WIDTH),
          (float)(global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_HEIGHT)));
        doc.AddPage(page);
        global::DripSharp.PdfCarton.Printing.PDFPrintable printable
          = new global::DripSharp.PdfCarton.Printing.PDFPrintable(doc,
        ...
        g2d.FillRect(0, 0, global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_WIDTH,
          global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_HEIGHT);
        global::DripSharp.Runtime.JavaPageFormat pf
          = global::DripSharp.PdfCarton.Printing.TestPDFPrintable.createPageFormat((double)(global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_WIDTH),
          (double)(global::DripSharp.PdfCarton.Printing.TestPDFPrintable.IMAGE_HEIGHT));
        ...
        global::DripSharp.Runtime.JavaCompat.CloseResource(doc, __dripsharpPrimary_182_25_0);
      }
    }
  }
  ...
  private static void assertBorderPixelIsGray(global::SkiaSharp.SKBitmap image) {
    ...
    for (int x = 0; (x < width); x++) {
      if (global::DripSharp.PdfCarton.Printing.TestPDFPrintable.isGray(global::DripSharp.Runtime.PdfCartonFontCompat.GetRgb(image,
        x, 0))) {
        foundGray = true;
        break;
      }
    ...
    global::DripSharp.Testing.JavaAssertions.True(foundGray,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
      global::DripSharp.Runtime.JavaCompat.Concat("Expected a gray border pixel in the top-left corner. ",
  ...
  private static global::DripSharp.Runtime.JavaPageFormat createPageFormat(double width,
    double height) {
