...
public class TestPDFToImage {
  ...
  private static global::SkiaSharp.SKBitmap createEmptyDiffImage(int minWidth, int minHeight,
    int maxWidth, int maxHeight) {
    global::SkiaSharp.SKBitmap bim3
      = global::DripSharp.Runtime.PdfCartonFontCompat.CreateBitmap(maxWidth, maxHeight,
      global::DripSharp.Runtime.PdfCartonFontCompat.TYPE_INT_RGB);
    global::DripSharp.Runtime.PdfCartonGraphics2D graphics
      = global::DripSharp.Runtime.PdfCartonFontCompat.CreateGraphics(bim3);
  ...
  private static global::SkiaSharp.SKBitmap diffImages(global::SkiaSharp.SKBitmap bim1,
    ...
    if (((minWidth != maxWidth) || (minHeight != maxHeight))) {
      bim3 = global::DripSharp.PdfCarton.Rendering.TestPDFToImage.createEmptyDiffImage(minWidth,
    ...
    for (int x = 0; (x < minWidth); ++x) {
      for (int y = 0; (y < minHeight); ++y) {
        ...
        if (((rgb1 != rgb2) && (((global::System.Math.Abs(unchecked(((rgb1 & 255)
          - (rgb2 & 255)))) > 3)
          || (global::System.Math.Abs(unchecked((((rgb1 >> unchecked((int)(8))) & 255)
          - ((rgb2 >> unchecked((int)(8))) & 255)))) > 3))
          || (global::System.Math.Abs(unchecked((((rgb1 >> unchecked((int)(16))) & 255)
          - ((rgb2 >> unchecked((int)(16))) & 255)))) > 3)))) {
          if ((bim3! == default!)) {
            bim3
              = global::DripSharp.PdfCarton.Rendering.TestPDFToImage.createEmptyDiffImage(minWidth,
              minHeight, maxWidth, maxHeight);
          }
          int r = global::System.Math.Abs(unchecked(((rgb1 & 255) - (rgb2 & 255))));
          int g = global::System.Math.Abs(unchecked(((rgb1 & 65280) - (rgb2 & 65280))));
          int b = global::System.Math.Abs(unchecked(((rgb1 & 16711680) - (rgb2 & 16711680))));
          global::DripSharp.Runtime.PdfCartonFontCompat.SetRgb(bim3!, x, y, unchecked((16777215
            - ((r | g) | b))));
        } else {
          if ((bim3! != default!)) {
            global::DripSharp.Runtime.PdfCartonFontCompat.SetRgb(bim3!, x, y,
              global::DripSharp.PdfCarton.Tests.Support.ColorRgb(global::DripSharp.Runtime.JavaColor.White));
          }
        }
      }
    }
  ...
  internal static bool __JavaFile_DoTestFile(global::DripSharp.Runtime.JavaFile file, string inDir,
    ...
    try { {
        ...
        try {
          ...
          if ((numPages < 1)) {
            failed = true;
            global::Microsoft.Extensions.Logging.LoggerExtensions.LogError(global::DripSharp.PdfCarton.Rendering.TestPDFToImage.LOG,
          ...
          global::Microsoft.Extensions.Logging.LoggerExtensions.LogInformation(global::DripSharp.PdfCarton.Rendering.TestPDFToImage.LOG,
            global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat("Rendering: ",
            file.Name)));
          ...
          global::DripSharp.Runtime.JavaFileBridge.Call(document, "Save",
            ...
            new object[] { (global::DripSharp.Runtime.JavaFile)tmpFile });
          global::DripSharp.Runtime.JavaCompat.FileDelete(global::DripSharp.Runtime.JavaCompat.NewJavaFile(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
            outDir), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          ...
          global::DripSharp.Runtime.JavaFileBridge.Call<global::DripSharp.PdfCarton.Pdmodel.PDDocument>(typeof(global::DripSharp.PdfCarton.Loader),
            "LoadPDF", new global::System.Type[] { typeof(global::System.IO.FileInfo) },
            new object[] { (global::DripSharp.Runtime.JavaFile)tmpFile }).Dispose();
          global::DripSharp.Runtime.JavaCompat.FileDelete(global::DripSharp.Runtime.JavaCompat.NewJavaFile(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
            outDir), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          ...
          global::DripSharp.Runtime.JavaCompat.CloseResource(document, __dripsharpPrimary_171_25_0);
        }
      }
    } catch (global::System.IO.IOException) {
      failed = true;
      global::Microsoft.Extensions.Logging.LoggerExtensions.LogError(global::DripSharp.PdfCarton.Rendering.TestPDFToImage.LOG,
        global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat("Error converting file ",
        file.Name)));
      throw;
    }
    global::Microsoft.Extensions.Logging.LoggerExtensions.LogInformation(global::DripSharp.PdfCarton.Rendering.TestPDFToImage.LOG,
    ...
    try {
      ...
      global::DripSharp.Runtime.JavaFile[] outFiles
        ...
        outDir)), (dir, name) => {
          ...
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", ".png"))
          && global::DripSharp.Runtime.JavaCompat.StringStartsWith(name,
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", file.Name), 0))
          && !global::DripSharp.Runtime.JavaCompat.StringEndsWith(name,
          global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", ".png-diff.png")));
        });
      if ((outFiles.Length == 0)) {
        failed = true;
        global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Rendering.TestPDFToImage.LOG,
      ...
      foreach (global::DripSharp.Runtime.JavaFile outFile in outFiles) {
        ...
        if (!global::System.IO.File.Exists(inFile.FullName)) {
          failed = true;
          global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Rendering.TestPDFToImage.LOG,
            global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat("*** TEST FAILURE *** Input missing for file: ",
            inFile.Name)));
        } else {
          if (!(global::DripSharp.PdfCarton.Rendering.TestPDFToImage.filesAreIdentical(outFile,
            inFile))) {
            global::SkiaSharp.SKBitmap bim3
              = global::DripSharp.PdfCarton.Rendering.TestPDFToImage.diffImages(global::DripSharp.Runtime.PdfCartonFontCompat.ReadImage(inFile),
              global::DripSharp.Runtime.PdfCartonFontCompat.ReadImage(outFile));
            if ((bim3 != default!)) {
              failed = true;
              global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Rendering.TestPDFToImage.LOG,
                global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat("*** TEST FAILURE *** Input and output not identical for file: ",
                inFile.Name)));
              ...
              global::Microsoft.Extensions.Logging.LoggerExtensions.LogInformation(global::DripSharp.PdfCarton.Rendering.TestPDFToImage.LOG,
                ...
                inFile.Name)));
              global::Microsoft.Extensions.Logging.LoggerExtensions.LogInformation(global::DripSharp.PdfCarton.Rendering.TestPDFToImage.LOG,
                global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat("Deleting: ",
                outFile.Name)));
      ...
      global::Microsoft.Extensions.Logging.LoggerExtensions.LogError(global::DripSharp.PdfCarton.Rendering.TestPDFToImage.LOG,
        ...
        global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat("Error comparing file output for ",
        file.Name)));
    }
    return !failed;
  }
  ...
  private static bool filesAreIdentical(global::DripSharp.Runtime.JavaFile left,
    ...
    if (((((left != default!) && (right != default!))
      ...
      try {
        ...
        int lcount;
        while (((lcount = global::DripSharp.Runtime.JavaCompat.InputStreamRead(lin,
          lbuffer)) > 0)) {
          int bytesRead = 0;
          int rcount;
          while (((rcount = global::DripSharp.Runtime.JavaCompat.InputStreamRead(rin, rbuffer,
            bytesRead, unchecked((lcount - bytesRead)))) > 0)) {
            bytesRead += rcount;
          }
