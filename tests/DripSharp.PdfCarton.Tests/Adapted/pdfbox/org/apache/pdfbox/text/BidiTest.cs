...
private static readonly global::System.IO.FileInfo IN_DIR = global::DripSharp.PdfCarton.Tests.Support.TestFile(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "src/test/resources/org/apache/pdfbox/text/"));
...
this.document = global::DripSharp.PdfCarton.Loader.LoadPDF(new global::System.IO.FileInfo(global::System.IO.Path.Combine((global::DripSharp.PdfCarton.Text.BidiTest.IN_DIR).FullName, global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", global::DripSharp.PdfCarton.Text.BidiTest.NAME_OF_PDF))));
...
global::System.IO.FileInfo testFile = new global::System.IO.FileInfo(global::System.IO.Path.Combine((global::DripSharp.PdfCarton.Text.BidiTest.IN_DIR).FullName, global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", global::DripSharp.PdfCarton.Text.BidiTest.NAME_OF_PDF)));
...
if (bSort) {
global::Microsoft.Extensions.Logging.LoggerExtensions.LogInformation(global::DripSharp.PdfCarton.Text.BidiTest.LOG, global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("Preparing to parse ", inFile.Name), " for sorted test")));
} else {
global::Microsoft.Extensions.Logging.LoggerExtensions.LogInformation(global::DripSharp.PdfCarton.Text.BidiTest.LOG, global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("Preparing to parse ", inFile.Name), " for standard test")));
}
...
using (global::System.IO.Stream os = global::DripSharp.Runtime.JavaCompat.OpenFileOutput(outFile)) using (global::System.IO.TextWriter writer = new global::System.IO.StreamWriter(os, global::DripSharp.PdfCarton.Tests.Support.EncodingByName(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", global::DripSharp.PdfCarton.Text.BidiTest.ENCODING)), 1024, false)) {
this.stripper.SetSortByPosition(bSort);
this.stripper.WriteText(this.document, writer);
}
if (bLogResult) {
global::Microsoft.Extensions.Logging.LoggerExtensions.LogInformation(global::DripSharp.PdfCarton.Text.BidiTest.LOG, global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("Text for ", inFile.Name), ":")));
global::Microsoft.Extensions.Logging.LoggerExtensions.LogInformation(global::DripSharp.PdfCarton.Text.BidiTest.LOG, global::DripSharp.Runtime.JavaCompat.StringValueOf(this.stripper.GetText(this.document)));
}
if (!global::System.IO.File.Exists(expectedFile.FullName)) {
global::DripSharp.Testing.JavaAssertions.Fail("Assertion failed.");
return;
}
using (global::DripSharp.Runtime.JavaLineNumberReader expectedReader = new global::DripSharp.Runtime.JavaLineNumberReader(global::DripSharp.PdfCarton.Tests.Support.NewInputStreamReader(global::DripSharp.Runtime.JavaCompat.OpenFileInput(expectedFile), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", global::DripSharp.PdfCarton.Text.BidiTest.ENCODING)))) using (global::DripSharp.Runtime.JavaLineNumberReader actualReader = new global::DripSharp.Runtime.JavaLineNumberReader(global::DripSharp.PdfCarton.Tests.Support.NewInputStreamReader(global::DripSharp.Runtime.JavaCompat.OpenFileInput(outFile), global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", global::DripSharp.PdfCarton.Text.BidiTest.ENCODING)))) {
while (true) {
...
equals = false;
global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Text.BidiTest.LOG, global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("Lines differ at index", " expected:"), expectedIndex), "-"), (int)(expectedArray[expectedIndex])), " actual:"), actualIndex), "-"), (int)(actualArray[actualIndex]))));
break;
}
...
equals = false;
global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Text.BidiTest.LOG, global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat("Expected line is longer at:", expectedIndex)));
}
if ((actualIndex != actualArray.Length)) {
equals = false;
global::Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(global::DripSharp.PdfCarton.Text.BidiTest.LOG, global::DripSharp.Runtime.JavaCompat.StringValueOf(global::DripSharp.Runtime.JavaCompat.Concat("Actual line is longer at:", actualIndex)));
}
}
} else {
