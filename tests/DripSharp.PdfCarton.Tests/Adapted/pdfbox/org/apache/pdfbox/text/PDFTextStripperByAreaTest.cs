  ...
  internal virtual void testSomeMethod() {
    global::DripSharp.Runtime.JavaFile pdfFile
      ...
      try {
        ...
        global::SkiaSharp.SKRect rect
          = global::DripSharp.Runtime.PdfCartonFontCompat.Rectangle((double)(65), (double)(227),
          (double)(472), (double)(34));
        textAreaStripper.AddRegion(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          regionName), rect);
        ...
        string textForRegion
          = textAreaStripper.GetTextForRegion(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          regionName));
        textForRegion = global::DripSharp.Runtime.JavaCompat.StringTrim(textForRegion);
        global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat("In the following tables you will find the 91 E-PRTR ",
          "pollutants and their thresholds broken down by the 7 groups used in all "),
          "the searches of the E-PRTR website."), textForRegion, null);
        textAreaStripper.RemoveRegion(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          regionName));
        rect = global::DripSharp.Runtime.PdfCartonFontCompat.Rectangle((double)(230), (double)(370),
          (double)(369), (double)(10));
        textAreaStripper.AddRegion(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
          regionName), rect);
        ...
        global::DripSharp.Testing.JavaAssertions.Equal(1,
          global::DripSharp.Runtime.JavaCompat.CollectionCount(textAreaStripper.GetRegions()),
          null);
      } catch (global::System.Exception __dripsharpCaught_38_25_0) {
        __dripsharpPrimary_38_25_0 = __dripsharpCaught_38_25_0;
        throw;
      } finally {
        global::DripSharp.Runtime.JavaCompat.CloseResource(doc, __dripsharpPrimary_38_25_0);
      }
    }
  }
