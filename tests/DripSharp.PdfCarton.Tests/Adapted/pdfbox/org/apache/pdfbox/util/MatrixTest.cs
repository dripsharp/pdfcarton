...
public class MatrixTest {
  ...
  internal virtual void testGetScalingFactor() {
    global::DripSharp.PdfCarton.Util.Matrix m1 = new global::DripSharp.PdfCarton.Util.Matrix();
    global::DripSharp.Testing.JavaAssertions.Equal((float)(1), m1.GetScalingFactorX(), null,
      (float)(0));
    global::DripSharp.Testing.JavaAssertions.Equal((float)(1), m1.GetScalingFactorY(), null,
      (float)(0));
    global::DripSharp.PdfCarton.Util.Matrix m2
      = new global::DripSharp.PdfCarton.Util.Matrix((float)(2), (float)(4), (float)(4), (float)(2),
      (float)(0), (float)(0));
    global::DripSharp.Testing.JavaAssertions.Equal((float)((float)(global::System.Math.Sqrt((double)(20)))),
      m2.GetScalingFactorX(), null, (float)(0));
    global::DripSharp.Testing.JavaAssertions.Equal((float)((float)(global::System.Math.Sqrt((double)(20)))),
      m2.GetScalingFactorY(), null, (float)(0));
  }

  internal virtual void testCreateMatrixUsingInvalidInput() {
    global::DripSharp.PdfCarton.Util.Matrix createMatrix
      = global::DripSharp.PdfCarton.Util.Matrix.CreateMatrix(global::DripSharp.PdfCarton.Cos.COSName.A);
  ...
  internal virtual void testOldMultiplication() {
    global::DripSharp.PdfCarton.Util.Matrix testMatrix
  ...
  internal virtual void testPdfbox2872() {
    global::DripSharp.PdfCarton.Util.Matrix m
      = new global::DripSharp.PdfCarton.Util.Matrix((float)(2), (float)(4), (float)(5), (float)(8),
      (float)(2), (float)(0));
    global::DripSharp.PdfCarton.Cos.COSArray toCOSArray = m.ToCOSArray();
    global::DripSharp.Testing.JavaAssertions.Equal(new global::DripSharp.PdfCarton.Cos.COSFloat((float)(2)),
      toCOSArray.Get(0), null);
    global::DripSharp.Testing.JavaAssertions.Equal(new global::DripSharp.PdfCarton.Cos.COSFloat((float)(4)),
      toCOSArray.Get(1), null);
    global::DripSharp.Testing.JavaAssertions.Equal(new global::DripSharp.PdfCarton.Cos.COSFloat((float)(5)),
      toCOSArray.Get(2), null);
    global::DripSharp.Testing.JavaAssertions.Equal(new global::DripSharp.PdfCarton.Cos.COSFloat((float)(8)),
      toCOSArray.Get(3), null);
    global::DripSharp.Testing.JavaAssertions.Equal(new global::DripSharp.PdfCarton.Cos.COSFloat((float)(2)),
      toCOSArray.Get(4), null);
    global::DripSharp.Testing.JavaAssertions.Equal(global::DripSharp.PdfCarton.Cos.COSFloat.Zero,
      toCOSArray.Get(5), null);
  }
  ...
  private void assertMatrixValuesEqualTo(float[] values,
    global::DripSharp.PdfCarton.Util.Matrix m) {
    float delta = 1.0E-5F;
    for (int i = 0; (i < values.Length); i++) {
      ...
      failureMsg.Append(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        ...
        ",")).Append(column).Append(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox",
        "]"));
      global::DripSharp.Testing.JavaAssertions.Equal(values[i], m.GetValue(row, column),
        global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", failureMsg.ToString()), delta);
    }
  }
  ...
  internal virtual void testMultiplicationPerformance() {
    ...
    for (int i = 0; (i < 100000000); i++) {
      c = new global::DripSharp.PdfCarton.Util.Matrix((float)(15), (float)(3), (float)(235),
        (float)(55), (float)(422), (float)(1));
      d = new global::DripSharp.PdfCarton.Util.Matrix((float)(45), (float)(345), (float)(23),
        (float)(551), (float)(66), (float)(832));
      c.Multiply(d);
      c.Concatenate(d);
    }
