...
string[] result = global::DripSharp.PdfCarton.Util.StringUtil.SplitOnSpace(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "a b c"));
...
string[] result = global::DripSharp.PdfCarton.Util.StringUtil.SplitOnSpace(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", ""));
...
string[] result = global::DripSharp.PdfCarton.Util.StringUtil.TokenizeOnSpace(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "a b c"));
global::DripSharp.Testing.JavaAssertions.Equal(new string[] { "a", " ", "b", " ", "c" }, result, null);
}

internal virtual void testTokenizeOnSpace_emptyString() {
string[] result = global::DripSharp.PdfCarton.Util.StringUtil.TokenizeOnSpace(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", ""));
global::DripSharp.Testing.JavaAssertions.Equal(new string[] { "" }, result, null);
}
...
string[] result = global::DripSharp.PdfCarton.Util.StringUtil.TokenizeOnSpace(global::DripSharp.PdfCarton.Tests.Support.TestPath("pdfbox", "  a  "));
global::DripSharp.Testing.JavaAssertions.Equal(new string[] { " ", " ", "a", " ", " " }, result, null);
}
