...
global::System.Collections.Generic.IList<T> list = global::DripSharp.Runtime.JavaCompat.AsList<T>(input);
global::DripSharp.PdfCarton.Util.IterativeMergeSort.Sort(list, global::System.Collections.Generic.Comparer<T>.Create((value0, value1) => value0.CompareTo(value1)));
global::DripSharp.Testing.JavaAssertions.True(global::DripSharp.Testing.JavaAssertions.DeepEqual(global::DripSharp.Runtime.JavaCompat.CollectionToArray(list, new object[input.Length]), expected), null);
}
...
global::DripSharp.PdfCarton.Tests.JavaRandom rnd = new global::DripSharp.PdfCarton.Tests.JavaRandom((long)(12345));
