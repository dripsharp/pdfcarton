...
public class TestIsartorBavaria {
  ...
  public static global::System.Collections.Generic.ICollection<object[]> InitializeParameters() {
    string filter
      ...
      global::DripSharp.PdfCarton.Preflight.TestIsartorBavaria.FILTER_FILE));
    string skipBavaria
      = global::DripSharp.Runtime.JavaCompat.GetProperty(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
    ...
    if (global::DripSharp.Runtime.JavaCompat.FileIsDirectory(isartor)) {
      global::System.Collections.Generic.ICollection<object> pdfFiles__74_27
      ...
      foreach (object pdfFile__75_25 in pdfFiles__74_27) {
        ...
        if (((filter == default!) || global::DripSharp.Runtime.JavaCompat.StringContains(fn__77_24,
          filter))) {
          string path__80_28
            = props.GetProperty(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
            fn__77_24));
          string error__81_28
            ...
            path__80_28), global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
            "//")).nextToken());
          string[] errTab = global::DripSharp.Runtime.JavaCompat.StringSplit(error__81_28,
            global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight", ","), 0);
          global::System.Collections.Generic.ISet<string> errorSet__83_33
            = new global::System.Collections.Generic.HashSet<string>(global::DripSharp.Runtime.JavaCompat.AsList<string>(errTab));
          global::DripSharp.Runtime.JavaCompat.Add(data, new object[] { pdfFile__75_25,
              errorSet__83_33 });
        }
      }
    } else {
    ...
    if (global::DripSharp.Runtime.JavaCompat.Equals("false", skipBavaria)) {
      ...
      if (global::DripSharp.Runtime.JavaCompat.FileIsDirectory(bavaria)) {
        global::System.Collections.Generic.ICollection<object> pdfFiles__98_31
        ...
        foreach (object pdfFile__99_29 in pdfFiles__98_31) {
          ...
          if (((filter == default!)
            ...
            string path__104_32
              = props.GetProperty(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
              fn__101_28));
            global::System.Collections.Generic.ISet<string> errorSet__105_37
              = new global::System.Collections.Generic.HashSet<string>();
            if (!((path__104_32.Length == 0))) {
              string error__108_36
                = global::DripSharp.Runtime.JavaCompat.StringTrim(new global::DripSharp.Runtime.JavaStringTokenizer(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
                path__104_32), global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
                "//")).nextToken());
              global::DripSharp.Runtime.JavaCompat.AddAll(errorSet__105_37,
                global::DripSharp.Runtime.JavaCompat.AsList<string>(global::DripSharp.Runtime.JavaCompat.StringSplit(error__108_36,
                global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight", ","), 0)));
            }
            global::DripSharp.Runtime.JavaCompat.Add(data, new object[] { pdfFile__99_29,
                errorSet__105_37 });
          }
        }
      } else {
      ...
      global::DripSharp.Runtime.JavaCompat.@out.WriteLine(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
        "Bavaria tests are skipped. You can enable them in Maven with -Dskip-bavaria=false"));
      global::DripSharp.Runtime.JavaCompat.@out.WriteLine(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
        "About the tests: http://www.pdflib.com/knowledge-base/pdfa/validation-report/"));
    }
    return data;
  }
  ...
  internal static void beforeClass() {
    ...
    if ((irp != default!)) {
      ...
      if ((global::System.IO.File.Exists(f.FullName)
        && global::DripSharp.Runtime.JavaCompat.FileIsFile(f))) {
        global::DripSharp.Runtime.JavaCompat.FileDelete(f);
        global::DripSharp.PdfCarton.Preflight.TestIsartorBavaria.isartorResultFile
          = global::DripSharp.Runtime.JavaCompat.OpenFileOutput(f);
      } else {
        if (!global::System.IO.File.Exists(f.FullName)) {
          global::DripSharp.PdfCarton.Preflight.TestIsartorBavaria.isartorResultFile
            = global::DripSharp.Runtime.JavaCompat.OpenFileOutput(f);
        } else {
          throw new global::System.ArgumentException(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
            global::DripSharp.Runtime.JavaCompat.Concat("Invalid result file : ", irp)));
        }
      }
    }
  }
  ...
  internal virtual void validate(global::System.IO.FileInfo file,
    ...
    if ((result != default!)) {
      if (global::DripSharp.Runtime.JavaCompat.CollectionIsEmpty(expectedErrorSet)) {
        ...
        message__174_31.Append(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
          file.Name));
        message__174_31.Append(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
          " : PDF/A file should be valid, but has error"));
        ...
        foreach (string expectedError in expectedErrorSet) {
          ...
          foreach (global::DripSharp.PdfCarton.Preflight.ValidationResult.ValidationError error__203_42 in result.GetErrorsList()) {
            if (global::DripSharp.Runtime.JavaCompat.Equals(error__203_42.GetErrorCode(),
              expectedError)) {
              oneFound = true;
            }
            if (((global::DripSharp.PdfCarton.Preflight.TestIsartorBavaria.isartorResultFile
              != default!) && !logged)) {
              string log
                = global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.Concat(global::DripSharp.Runtime.JavaCompat.ReplaceOrdinal(file.Name,
                ".pdf", ""), "#"), error__203_42.GetErrorCode()), "#"), error__203_42.GetDetails()),
                "\n");
              global::DripSharp.Runtime.JavaCompat.OutputStreamWrite(global::DripSharp.PdfCarton.Preflight.TestIsartorBavaria.isartorResultFile,
        ...
        if (!allFound) {
          global::System.Collections.Generic.ISet<string> errorSet__227_33
            = new global::System.Collections.Generic.HashSet<string>();
          ...
          global::System.Text.StringBuilder message__232_35
