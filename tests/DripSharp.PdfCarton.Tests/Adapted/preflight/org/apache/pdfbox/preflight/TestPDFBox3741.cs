...
public class TestPDFBox3741 {
  internal virtual void testPDFBox3741() {
    ...
    global::DripSharp.Testing.JavaAssertions.Equal(1,
      global::DripSharp.Runtime.JavaCompat.CollectionCount(result.GetErrorsList()),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
      "List should contain one result"));
    global::DripSharp.Testing.JavaAssertions.Equal("2.4.3",
      global::DripSharp.Runtime.JavaCompat.ListGet(result.GetErrorsList(), 0).GetErrorCode(), null);
  }
