...
global::DripSharp.Testing.JavaAssertions.True(result.IsValid(), global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight", global::DripSharp.Runtime.JavaCompat.Concat("Validation of ", target)));
}
}
...
string pdfPath = global::DripSharp.Runtime.JavaCompat.GetProperty(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight", "pdfa.valid"), (string)default!);
...
global::DripSharp.PdfCarton.Tests.Support.ErrorStream.WriteLine(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight", "System property 'pdfa.valid' not defined, will not run TestValidaDirectory"));
}
