...
: global::DripSharp.PdfCarton.Preflight.Action.Pdfa1b.AbstractTestAction {
  internal virtual void testGoto_OK() {
    global::DripSharp.PdfCarton.Pdmodel.Interactive.Action.PDActionGoTo gotoAction
      = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Action.PDActionGoTo();
  ...
  internal virtual void testGoto_KO_invalidContent() {
    ...
    this.Valid(gotoAction, false, global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight",
      global::DripSharp.PdfCarton.Preflight.PreflightConstants.ErrorSyntaxDictInvalid));
  }

  private sealed class Anonymous_54_35
  : global::DripSharp.PdfCarton.Pdmodel.Interactive.Documentnavigation.Destination.PDDestination {
