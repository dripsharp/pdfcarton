...
public class TestGotoRemoteAction : global::DripSharp.PdfCarton.Preflight.Action.Pdfa1b.AbstractTestAction {
internal virtual void testGoto_OK() {
global::DripSharp.PdfCarton.Pdmodel.Interactive.Action.PDActionRemoteGoTo gotoAction = new global::DripSharp.PdfCarton.Pdmodel.Interactive.Action.PDActionRemoteGoTo();
gotoAction.SetD(global::DripSharp.PdfCarton.Cos.COSName.GetPDFName(global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight", "ADest")));
gotoAction.SetFile(new Anonymous_39_28());
this.Valid(gotoAction, true);
}

private sealed class Anonymous_39_28 : global::DripSharp.PdfCarton.Pdmodel.Common.Filespecification.PDFileSpecification {
...
this.Valid(gotoAction, false, global::DripSharp.PdfCarton.Tests.Support.TestPath("preflight", global::DripSharp.PdfCarton.Preflight.PreflightConstants.ErrorActionInvalidType));
}

private sealed class Anonymous_66_28 : global::DripSharp.PdfCarton.Pdmodel.Common.Filespecification.PDFileSpecification {
...
private sealed class Anonymous_92_28 : global::DripSharp.PdfCarton.Pdmodel.Common.Filespecification.PDFileSpecification {
