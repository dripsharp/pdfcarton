...
public class TestValidatePermitedMetadata {
  internal static global::System.Collections.Generic.ICollection<object[]> initializeParameters() {
    ...
    global::System.IO.Stream @is
      = global::DripSharp.PdfCarton.Tests.Support.ResourceStream(typeof(global::DripSharp.PdfCarton.Xmp.TestValidatePermitedMetadata),
      global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox", "/permited_metadata.txt"));
    global::System.IO.TextReader reader
      = global::DripSharp.PdfCarton.Tests.Support.NewInputStreamReader(@is,
  ...
  internal virtual void checkExistence(string @namespace, string preferred, string fieldname) {
    global::DripSharp.PdfCarton.Xmp.XMPMetadata xmpmd
      = new global::DripSharp.PdfCarton.Xmp.XMPMetadata();
    global::DripSharp.PdfCarton.Xmp.Type.TypeMapping mapping
      = new global::DripSharp.PdfCarton.Xmp.Type.TypeMapping(xmpmd);
    global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaFactory factory
      = mapping.GetSchemaFactory(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
      @namespace));
    global::DripSharp.Testing.JavaAssertions.NotNull(factory,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
      global::DripSharp.Runtime.JavaCompat.Concat("Schema not existing: ", @namespace)));
    global::DripSharp.PdfCarton.Xmp.Schema.XMPSchema schema = factory.CreateXMPSchema(xmpmd,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox", "aa"));
    ...
    foreach (global::System.Reflection.FieldInfo dfield in clz.GetFields(global::System.Reflection.BindingFlags.Instance | global::System.Reflection.BindingFlags.Static | global::System.Reflection.BindingFlags.Public | global::System.Reflection.BindingFlags.NonPublic | global::System.Reflection.BindingFlags.DeclaredOnly)) {
      global::DripSharp.PdfCarton.Xmp.Type.PropertyType ptype
        = global::DripSharp.Runtime.JavaCompat.FieldGetAnnotation<global::DripSharp.PdfCarton.Xmp.Type.PropertyType>(dfield,
      ...
      if ((ptype != default!)) {
        if (global::DripSharp.Runtime.JavaCompat.Equals(typeof(string), dfield.FieldType)) {
          ...
          throw new global::System.ArgumentException(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
            global::DripSharp.Runtime.JavaCompat.Concat("Should be a string : ", dfield.Name)));
        }
      }
    }
    string msg
      = global::DripSharp.Runtime.JavaCompat.JavaStringFormat(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
      "Did not find field definition for '%s' in %s (%s)"), fieldname, clz.Name, @namespace);
    global::DripSharp.Testing.JavaAssertions.True(found,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox", msg));
  }
  ...
  public void __Upstream_2608205338_b66d1360c0f4a5ea(string @namespace, string preferred,
    string fieldname) {
    try {
