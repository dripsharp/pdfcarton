...
global::DripSharp.PdfCarton.Xmp.Schema.AdobePDFSchema schem = this.metadata.CreateAndAddAdobePDFSchema();
...
schem = new global::DripSharp.PdfCarton.Xmp.Xml.DomXmpParser().Parse(global::DripSharp.Runtime.JavaCompat.ToSignedBytes(bos)).GetAdobePDFSchema();
global::DripSharp.Testing.JavaAssertions.Equal("Keywords", schem.GetKeywordsProperty().GetPropertyName(), null);
global::DripSharp.Testing.JavaAssertions.Equal(keywords, schem.GetKeywords(), null);
global::DripSharp.Testing.JavaAssertions.Equal("PDFVersion", schem.GetPDFVersionProperty().GetPropertyName(), null);
global::DripSharp.Testing.JavaAssertions.Equal(pdfVersion, schem.GetPDFVersion(), null);
...
global::DripSharp.PdfCarton.Xmp.Schema.PDFAIdentificationSchema pdfaid = this.metadata.CreateAndAddPDFAIdentificationSchema();
...
pdfaid.SetPartValueWithString(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox", "ojoj"));
}, null);
}
