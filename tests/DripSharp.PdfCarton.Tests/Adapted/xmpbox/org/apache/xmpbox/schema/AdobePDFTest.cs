...
internal virtual void testElementValue(string property, global::DripSharp.PdfCarton.Xmp.Type.PropertyType type, string value) {
...
internal virtual void testElementProperty(string property, global::DripSharp.PdfCarton.Xmp.Type.PropertyType type, string value) {
global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester xmpSchemaTester = new global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester(this.metadata, this.schema, this.schemaClass, global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox", property), type, value);
...
return global::DripSharp.Runtime.JavaCompat.StreamOf(new object[] { "Keywords", global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Text), "kw1 kw2 kw3" }, new object[] { "PDFVersion", global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Text), "1.4" }, new object[] { "Producer", global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Text), "testcase" });
}

internal virtual void testPDFAIdentification() {
global::DripSharp.PdfCarton.Xmp.XMPMetadata metadata2 = global::DripSharp.PdfCarton.Xmp.XMPMetadata.CreateXMPMetadata();
global::DripSharp.PdfCarton.Xmp.Schema.AdobePDFSchema schem = metadata2.CreateAndAddAdobePDFSchema();
...
global::DripSharp.Testing.JavaAssertions.Equal("pdf", schem.GetKeywordsProperty().GetPrefix(), null);
global::DripSharp.Testing.JavaAssertions.Equal("Keywords", schem.GetKeywordsProperty().GetPropertyName(), null);
global::DripSharp.Testing.JavaAssertions.Equal(keywords, schem.GetKeywords(), null);
global::DripSharp.Testing.JavaAssertions.Equal("pdf", schem.GetPDFVersionProperty().GetPrefix(), null);
global::DripSharp.Testing.JavaAssertions.Equal("PDFVersion", schem.GetPDFVersionProperty().GetPropertyName(), null);
global::DripSharp.Testing.JavaAssertions.Equal(pdfVersion, schem.GetPDFVersion(), null);
global::DripSharp.Testing.JavaAssertions.Equal("pdf", schem.GetProducerProperty().GetPrefix(), null);
global::DripSharp.Testing.JavaAssertions.Equal("Producer", schem.GetProducerProperty().GetPropertyName(), null);
...
global::DripSharp.PdfCarton.Xmp.XMPMetadata metadata2 = global::DripSharp.PdfCarton.Xmp.XMPMetadata.CreateXMPMetadata();
global::DripSharp.PdfCarton.Xmp.Schema.PDFAIdentificationSchema pdfaid = metadata2.CreateAndAddPDFAIdentificationSchema();
...
pdfaid.SetConformance(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox", conformance));
}, null);
}
...
public static global::System.Collections.Generic.IEnumerable<object[]> __Data_72360d4ff6f4ddb2()
{
    foreach (var value in initializeParameters())
    {
        ...
        yield return new object[] { global::DripSharp.PdfCarton.Tests.Support.TheoryArgument<string>(row[0]), global::DripSharp.PdfCarton.Tests.Support.TheoryArgument<global::DripSharp.PdfCarton.Xmp.Type.PropertyType>(row[1]), global::DripSharp.PdfCarton.Tests.Support.TheoryArgument<string>(row[2]) };
    }
}
...
public void __Upstream_1084695039_d73afb776a94e59c(string property, global::DripSharp.PdfCarton.Xmp.Type.PropertyType type, string value)
{
        this.initMetadata();
        try
        {
...
public void __Upstream_2596523399_347caddb44c68241(string property, global::DripSharp.PdfCarton.Xmp.Type.PropertyType type, string value)
{
        this.initMetadata();
        try
        {
