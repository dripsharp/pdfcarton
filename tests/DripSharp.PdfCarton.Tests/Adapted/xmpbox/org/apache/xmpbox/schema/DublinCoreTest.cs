...
public class DublinCoreTest {
  ...
  private static global::System.Collections.Generic.IEnumerable<object[]> initializeParameters() {
    return global::DripSharp.Runtime.JavaCompat.StreamOf(new object[] { "contributor",
        ...
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Bag }, new object[] { "coverage",
        global::DripSharp.PdfCarton.Xmp.Type.Types.Text,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Simple }, new object[] { "creator",
        global::DripSharp.PdfCarton.Xmp.Type.Types.ProperName,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Seq }, new object[] { "date",
        global::DripSharp.PdfCarton.Xmp.Type.Types.Date,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Seq }, new object[] { "format",
        global::DripSharp.PdfCarton.Xmp.Type.Types.MIMEType,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Simple }, new object[] { "identifier",
        global::DripSharp.PdfCarton.Xmp.Type.Types.Text,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Simple }, new object[] { "language",
        global::DripSharp.PdfCarton.Xmp.Type.Types.Locale,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Bag }, new object[] { "publisher",
        global::DripSharp.PdfCarton.Xmp.Type.Types.ProperName,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Bag }, new object[] { "relation",
        global::DripSharp.PdfCarton.Xmp.Type.Types.Text,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Bag }, new object[] { "source",
        global::DripSharp.PdfCarton.Xmp.Type.Types.Text,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Simple }, new object[] { "subject",
        global::DripSharp.PdfCarton.Xmp.Type.Types.Text,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Bag }, new object[] { "type",
        global::DripSharp.PdfCarton.Xmp.Type.Types.Text,
  ...
  public void __Upstream_3540789284_daea56c35d5632bd(string fieldName,
    global::DripSharp.PdfCarton.Xmp.Type.Types type,
    global::DripSharp.PdfCarton.Xmp.Type.Cardinality card) {
    this.initMetadata();
    try {
  ...
  public void __Upstream_0974183790_bdb3937a5bc7c8ba(string fieldName,
    global::DripSharp.PdfCarton.Xmp.Type.Types type,
    global::DripSharp.PdfCarton.Xmp.Type.Cardinality card) {
    this.initMetadata();
    try {
  ...
  public void __Upstream_3916638520_c6c36ef31e05b9b5(string fieldName,
    global::DripSharp.PdfCarton.Xmp.Type.Types type,
    global::DripSharp.PdfCarton.Xmp.Type.Cardinality card) {
    this.initMetadata();
    try {
  ...
  public void __Upstream_3372502507_80f3519a373e93c2(string fieldName,
    global::DripSharp.PdfCarton.Xmp.Type.Types type,
    global::DripSharp.PdfCarton.Xmp.Type.Cardinality card) {
    this.initMetadata();
    try {
  ...
  public void __Upstream_3024172315_c5c2d7db7c057bd3(string fieldName,
    global::DripSharp.PdfCarton.Xmp.Type.Types type,
    global::DripSharp.PdfCarton.Xmp.Type.Cardinality card) {
    this.initMetadata();
    try {
  ...
  public void __Upstream_3730436502_b0c678e5e4229a7b(string fieldName,
    global::DripSharp.PdfCarton.Xmp.Type.Types type,
    global::DripSharp.PdfCarton.Xmp.Type.Cardinality card) {
    this.initMetadata();
    try {
  ...
  public void __Upstream_2849682878_ce49da0e24eb50e6(string fieldName,
    global::DripSharp.PdfCarton.Xmp.Type.Types type,
    global::DripSharp.PdfCarton.Xmp.Type.Cardinality card) {
    this.initMetadata();
    try {
  ...
  public void __Upstream_3686552243_3128b46ef0ef5411(string fieldName,
    global::DripSharp.PdfCarton.Xmp.Type.Types type,
    global::DripSharp.PdfCarton.Xmp.Type.Cardinality card) {
    this.initMetadata();
    try {
  ...
  public void __Upstream_1354451457_2fe6d3fb732620f5(string fieldName,
    global::DripSharp.PdfCarton.Xmp.Type.Types type,
    global::DripSharp.PdfCarton.Xmp.Type.Cardinality card) {
    this.initMetadata();
    try {
