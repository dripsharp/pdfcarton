...
public class PDFAIdentificationTest {
  ...
  internal static global::System.Collections.Generic.IEnumerable<object[]> initializeParameters() {
    return global::DripSharp.Runtime.JavaCompat.StreamOf(new object[] { "part",
  ...
  public void __Upstream_1084695039_c7c7cc4fea5085c9(string property,
    global::DripSharp.PdfCarton.Xmp.Type.PropertyType type, object value) {
    this.initMetadata();
    try {
  ...
  public void __Upstream_2596523399_8b5a599a52211643(string property,
    global::DripSharp.PdfCarton.Xmp.Type.PropertyType type, object value) {
    this.initMetadata();
    try {
