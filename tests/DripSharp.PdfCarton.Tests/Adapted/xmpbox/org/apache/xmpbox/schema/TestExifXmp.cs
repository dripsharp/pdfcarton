...
public class TestExifXmp {
  ...
  internal virtual void testGenerate() {
    ...
    global::DripSharp.PdfCarton.Xmp.Schema.ExifSchema exif
      = new global::DripSharp.PdfCarton.Xmp.Schema.ExifSchema(metadata);
    metadata.AddSchema(exif);
    global::DripSharp.PdfCarton.Xmp.Type.OECFType oecf
      = new global::DripSharp.PdfCarton.Xmp.Type.OECFType(metadata);
    oecf.AddProperty(tmapping.CreateInteger(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
      oecf.GetNamespace()), global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
      oecf.GetPrefix()), global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
      global::DripSharp.PdfCarton.Xmp.Type.OECFType.Columns), 14));
    oecf.SetPropertyName(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
      global::DripSharp.PdfCarton.Xmp.Schema.ExifSchema.Oecf));
    ...
    serializer.Serialize(metadata, new global::DripSharp.Runtime.JavaByteArrayOutputStream(),
      false);
  }
