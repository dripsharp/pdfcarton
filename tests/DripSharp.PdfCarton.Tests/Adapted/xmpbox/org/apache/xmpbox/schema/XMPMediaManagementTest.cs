...
public class XMPMediaManagementTest {
  ...
  internal static global::System.Collections.Generic.IEnumerable<object[]> initializeParameters() {
    return global::DripSharp.Runtime.JavaCompat.StreamOf(new object[] { "DocumentID",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Uri),
      "uuid:FB031973-5E75-11B2-8F06-E7F5C101C07A" }, new object[] { "Manager",
      ...
      "Raoul" }, new object[] { "ManageTo",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Uri),
      "uuid:36" }, new object[] { "ManageUI",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Uri),
      "uuid:3635" }, new object[] { "InstanceID",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Uri),
      "uuid:42" }, new object[] { "OriginalDocumentID",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Text),
      "uuid:142" }, new object[] { "RenditionParams",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Text),
      "my params" }, new object[] { "VersionID",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Text),
      "14" }, new object[] { "Versions",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Version,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Seq), new string[] { "1", "2", "3" } },
      new object[] { "History",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Text,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Seq), new string[] { "action 1", "action 2",
        "action 3" } }, new object[] { "Ingredients",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Text,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Bag), new string[] { "resource1",
        "resource2" } });
  }
  ...
  public void __Upstream_1084695039_225f973950c0db28(string property,
    global::DripSharp.PdfCarton.Xmp.Type.PropertyType type, object value) {
    this.initMetadata();
    try {
  ...
  public void __Upstream_2596523399_7d62dc706603f88a(string property,
    global::DripSharp.PdfCarton.Xmp.Type.PropertyType type, object value) {
    this.initMetadata();
    try {
