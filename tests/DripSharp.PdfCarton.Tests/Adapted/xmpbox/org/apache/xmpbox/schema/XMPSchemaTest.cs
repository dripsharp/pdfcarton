...
global::DripSharp.Testing.JavaAssertions.Equal(boolVal, this.schem.GetBooleanProperty(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox", global::DripSharp.Runtime.JavaCompat.Concat(prefSchem, @bool))).GetValue(), null);
global::DripSharp.Testing.JavaAssertions.Equal(dateVal, this.schem.GetDateProperty(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox", global::DripSharp.Runtime.JavaCompat.Concat(prefSchem, date))).GetValue(), null);
