...
public class XmpRightsSchemaTest {
  ...
  internal static global::System.Collections.Generic.IEnumerable<object[]> initializeParameters() {
    global::System.Collections.Generic.IDictionary<string, string> desc
      = global::DripSharp.Runtime.JavaCompat.NewJavaDictionary<string, string>(2);
    ...
    return global::DripSharp.Runtime.JavaCompat.StreamOf(new object[] { "Certificate",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Url),
      "http://une.url.vers.un.certificat/moncert.cer" }, new object[] { "Marked",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Boolean),
        true }, new object[] { "Owner",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.ProperName,
        global::DripSharp.PdfCarton.Xmp.Type.Cardinality.Bag), new string[] { "OwnerName" } },
      new object[] { "UsageTerms",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.LangAlt),
        desc }, new object[] { "WebStatement",
        global::DripSharp.PdfCarton.Xmp.Schema.XMPSchemaTester.CreatePropertyType(global::DripSharp.PdfCarton.Xmp.Type.Types.Url),
  ...
  public void __Upstream_1084695039_77550cf2d1113370(string property,
    global::DripSharp.PdfCarton.Xmp.Type.PropertyType type, object value) {
    this.initMetadata();
    try {
  ...
  public void __Upstream_2596523399_b3337c5388fb2449(string property,
    global::DripSharp.PdfCarton.Xmp.Type.PropertyType type, object value) {
    this.initMetadata();
    try {
