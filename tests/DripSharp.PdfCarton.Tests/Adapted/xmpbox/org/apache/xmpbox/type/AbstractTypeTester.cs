...
public abstract class AbstractTypeTester {
  ...
  private global::DripSharp.PdfCarton.Tests.JavaRandom counterRandom
    = new global::DripSharp.PdfCarton.Tests.JavaRandom(global::DripSharp.PdfCarton.Xmp.Type.AbstractTypeTester.COUNTER_SEED);
  ...
  public virtual string CalculateArrayGetter(string name) {
    ...
    string fn
      ...
      name));
    sb.Append(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
      "get")).Append(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox", fn));
    if (!global::DripSharp.Runtime.JavaCompat.StringEndsWith(fn,
      global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox", "s"))) {
  ...
  public virtual string CalculateFieldNameForMethod(string name) {
    ...
    sb.Append(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
      global::DripSharp.Runtime.JavaCompat.StringSubstring(name, 0,
      1).ToUpper())).Append(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
      name.Substring(1)));
    return sb.ToString();
  }
        ...
        if ((type.GetImplementingClass()
          ...
          if (typeof(global::DripSharp.PdfCarton.Xmp.Type.TextType).IsAssignableFrom(type.GetImplementingClass())) {
            ...
            throw new global::System.ArgumentException(global::DripSharp.PdfCarton.Tests.Support.TestPath("xmpbox",
              global::DripSharp.Runtime.JavaCompat.Concat("Type not expected in test : ",
  ...
  public virtual global::System.Collections.Generic.IList<global::System.Reflection.FieldInfo> GetXmpFields(global::System.Type clz) {
    ...
    global::System.Collections.Generic.IList<global::System.Reflection.FieldInfo> result
      = new global::System.Collections.Generic.List<global::System.Reflection.FieldInfo>(fields.Length);
    foreach (global::System.Reflection.FieldInfo field in fields) {
      if ((global::DripSharp.Runtime.JavaCompat.FieldGetAnnotation<global::DripSharp.PdfCarton.Xmp.Type.PropertyType>(field,
        typeof(global::DripSharp.PdfCarton.Xmp.Type.PropertyType))! != default!)) {
